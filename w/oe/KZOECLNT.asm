...
; 128  :       SysGetDateTime( szDateTime );
	...
	lea	edx, DWORD PTR _szDateTime$57367[ebp]
	push	edx
	call	_SysGetDateTime@4

; 129  :       TRACE( nThreadNumber, szDateTime );

	lea	eax, DWORD PTR _szDateTime$57367[ebp]
	push	eax
	mov	cx, WORD PTR _nThreadNumber$[ebp]
	push	ecx
	call	_fnTrace
...
; 229  :       SysGetDateTime( szDateTime );
	...
	lea	edx, DWORD PTR _szDateTime$57417[ebp]
	push	edx
	call	_SysGetDateTime@4

; 230  :       TRACE( 0, szDateTime );

	lea	eax, DWORD PTR _szDateTime$57417[ebp]
	push	eax
	push	0
	call	_fnTrace
	add	esp, 8
...
; 334  :                for ( k = 1; k <= NUM_THREADS; k++ )
	...
	mov	DWORD PTR _k$57461[ebp], 1
	jmp	SHORT $L57462
$L57463:
	mov	edx, DWORD PTR _k$57461[ebp]
	add	edx, 1
	mov	DWORD PTR _k$57461[ebp], edx
$L57462:
	cmp	DWORD PTR _k$57461[ebp], 1
	jg	SHORT $L57464
...
; 337  :                                                   (void *) k, 0, &g_dwTestThreadID );
	...
	push	0
	mov	eax, DWORD PTR _k$57461[ebp]
	push	eax
...
; 487  :       zLONG  h = SysAllocMemory( &psz, 100, 0, zCOREMEM_ALLOC, 0 );
	...
	push	0
	push	100					; 00000064H
	lea	edx, DWORD PTR _psz$57503[ebp]
	push	edx
	call	_SysAllocMemory@20
	mov	DWORD PTR _h$57504[ebp], eax

; 488  :       HANDLE ph = GetProcessHeap( );

	call	DWORD PTR __imp__GetProcessHeap@0
	mov	DWORD PTR _ph$57505[ebp], eax
...
; 493  :       pv = HeapAlloc( ph, 0, 100 );
	...
	push	100					; 00000064H
	push	0
	mov	eax, DWORD PTR _ph$57505[ebp]
	push	eax
	call	DWORD PTR __imp__HeapAlloc@12
	mov	DWORD PTR _pv$57506[ebp], eax

; 494  :       dw = GetLastError( );

	call	DWORD PTR __imp__GetLastError@0
	mov	DWORD PTR _dw$57508[ebp], eax

; 495  :       pv2 = HeapAlloc( ph, 0, 100 );

	push	100					; 00000064H
	push	0
	mov	ecx, DWORD PTR _ph$57505[ebp]
	push	ecx
	call	DWORD PTR __imp__HeapAlloc@12
	mov	DWORD PTR _pv2$57507[ebp], eax
...
; 498  :       HeapFree( ph, 0, pv );
	...
	mov	edx, DWORD PTR _pv$57506[ebp]
	push	edx
	push	0
	mov	eax, DWORD PTR _ph$57505[ebp]
	push	eax
...
; 500  :       HeapFree( ph, 0, pv2 );
	...
	mov	ecx, DWORD PTR _pv2$57507[ebp]
	push	ecx
	push	0
	mov	edx, DWORD PTR _ph$57505[ebp]
	push	edx
	call	DWORD PTR __imp__HeapFree@12
...
; 503  :       zstrcpy( psz, "laskjdflkasjdflkjasdlfkjasdlkfj" );
	...
	mov	eax, DWORD PTR _psz$57503[ebp]
	push	eax
	call	_strcpy
	add	esp, 8
...
; 504  :       SysFreeMemory( h );
	...
	mov	ecx, DWORD PTR _h$57504[ebp]
	push	ecx
