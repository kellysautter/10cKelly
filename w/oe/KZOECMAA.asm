...
; 332  :    {
	...
	xor	edx, edx
	mov	dl, BYTE PTR $L9826[eax]
	jmp	DWORD PTR $L9827[edx*4]
$L7605:
...
; 392  :          lpExternalP = (zCOREMEM) (lpRecord + 1);
	...
	mov	edx, DWORD PTR _lpRecord$[ebp]
	add	edx, 1
	mov	DWORD PTR _lpExternalP$7629[ebp], edx

; 393  :          lpRecord = zGETPTR( *lpExternalP );

	mov	eax, DWORD PTR _lpExternalP$7629[ebp]
...
_lpSearchRecord$ = -12
_szWorkString$ = -268
_lpViewEntityCsrDA$7674 = -272
_lpExternalP$7684 = -276
_lpExternalP$7689 = -280
_lpuSrcBlobLth$7720 = -284
_lpuSearchBlobLth$7721 = -288
_lpExternalP$7722 = -292
_ulTossOut$7737 = -300
_lpViewEntityCsrForDomain$7738 = -296
_szContext$7741 = -344
_lpDomain$7742 = -308
_lpViewCsr$7744 = -304
...
; 465  :                                                        lpSrcEntityInstance );
	...
	mov	DWORD PTR _lpViewEntityCsrDA$7674[ebp], eax
...
; 471  :                                          lpCurrentTask, zDERIVED_GET );
	...
	mov	ecx, DWORD PTR _lpSrcViewAttrib$[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpViewEntityCsrDA$7674[ebp]
...
; 479  :       {
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR $L9834[edx]
	jmp	DWORD PTR $L9835[ecx*4]
$L7681:
...
; 485  :                lpExternalP = (zCOREMEM) ( lpSrcRecord + 1 );
	...
	add	edx, 1
	mov	DWORD PTR _lpExternalP$7684[ebp], edx

; 486  :                lpSrcRecord = zGETPTR( *lpExternalP );

	mov	eax, DWORD PTR _lpExternalP$7684[ebp]
	mov	ecx, DWORD PTR [eax]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcRecord$[ebp], eax
...
; 493  :                lpExternalP = (zCOREMEM) ( lpSearchRecord + 1 );
	...
	add	ecx, 1
	mov	DWORD PTR _lpExternalP$7689[ebp], ecx

; 494  :                lpSearchRecord = zGETPTR( *lpExternalP );

	mov	edx, DWORD PTR _lpExternalP$7689[ebp]
...
; 538  :                lpExternalP = (zCOREMEM) (lpSrcRecord + 1);
	...
	mov	ecx, DWORD PTR _lpSrcRecord$[ebp]
	add	ecx, 1
	mov	DWORD PTR _lpExternalP$7722[ebp], ecx

; 539  :                lpuSrcBlobLth  = (zPULONG) (lpExternalP + 1);

	mov	edx, DWORD PTR _lpExternalP$7722[ebp]
	add	edx, 4
	mov	DWORD PTR _lpuSrcBlobLth$7720[ebp], edx

; 540  :                lpSrcRecord = zGETPTR( *lpExternalP );

	mov	eax, DWORD PTR _lpExternalP$7722[ebp]
	mov	ecx, DWORD PTR [eax]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcRecord$[ebp], eax
...
; 541  :                lpExternalP = (zCOREMEM) (lpSearchRecord + 1);
	...
	mov	edx, DWORD PTR _lpSearchRecord$[ebp]
	add	edx, 1
	mov	DWORD PTR _lpExternalP$7722[ebp], edx

; 542  :                lpuSearchBlobLth  = (zPULONG) (lpExternalP + 1);

	mov	eax, DWORD PTR _lpExternalP$7722[ebp]
	add	eax, 4
	mov	DWORD PTR _lpuSearchBlobLth$7721[ebp], eax

; 543  :                lpSearchRecord = zGETPTR( *lpExternalP );

	mov	ecx, DWORD PTR _lpExternalP$7722[ebp]
...
; 545  :                if ( *lpuSrcBlobLth != *lpuSearchBlobLth )
	...
	mov	eax, DWORD PTR _lpuSrcBlobLth$7720[ebp]
	mov	ecx, DWORD PTR _lpuSearchBlobLth$7721[ebp]
...
; 574  :                                                        lpSrcEntityInstance );
	...
	call	_fnEstablishViewForInstance
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _lpViewEntityCsrForDomain$7738[ebp], eax
...
; 583  :                                         0, lpCurrentTask, 0 );
	...
	mov	edx, DWORD PTR _lpSrcViewAttrib$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewEntityCsrForDomain$7738[ebp]
	push	eax
	mov	ecx, DWORD PTR _vAttrView$[ebp]
	push	ecx
	push	255					; 000000ffH
	push	83					; 00000053H
	lea	edx, DWORD PTR _ulTossOut$7737[ebp]
	push	edx
...
; 587  :          LPDOMAIN  lpDomain = zGETPTR( lpSrcViewAttrib->hDomain );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpDomain$7742[ebp], eax
...
; 588  :          LPVIEWCSR lpViewCsr = zGETPTR( lpSearchViewEntityCsr->hViewCsr );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$7744[ebp], eax

; 589  : 
; 590  :          if ( lpDomain )

	cmp	DWORD PTR _lpDomain$7742[ebp], 0
	je	SHORT $L7746

; 591  :             zstrcpy( szContext, lpDomain->szName );

	mov	eax, DWORD PTR _lpDomain$7742[ebp]
	add	eax, 6
	push	eax
	lea	ecx, DWORD PTR _szContext$7741[ebp]
	push	ecx
	call	_strcpy
	add	esp, 8
...
; 593  :             szContext[ 0 ] = 0;
	...
	mov	BYTE PTR _szContext$7741[ebp], 0
$L7747:
...
; 602  :                                              lpCurrentTask, 0 );
	...
	mov	edx, DWORD PTR _lpCurrentTask$[ebp]
	push	edx
	lea	eax, DWORD PTR _szContext$7741[ebp]
	push	eax
	push	0
	push	83					; 00000053H
	...
	push	eax
	mov	ecx, DWORD PTR _lpViewCsr$7744[ebp]
...
; 681  :             zstrcpy( sz, "(S->DT), " );
	...
	lea	eax, DWORD PTR _sz$7779[ebp]
	push	eax
	call	_strcpy
	add	esp, 8
...
; 682  :             zstrcat( sz, lpViewEntity->szName );
	...
	push	ecx
	lea	edx, DWORD PTR _sz$7779[ebp]
	push	edx
	call	_strcat
	add	esp, 8
...
; 683  :             fnIssueCoreError( lpCurrentTask, lpView, 8, 263, 0, sz, lpViewAttrib->szName );
	...
	push	eax
	lea	ecx, DWORD PTR _sz$7779[ebp]
	push	ecx
	push	0
	push	263					; 00000107H
	push	8
...
$L9838:
	...
	call	_fnSetEntityCursor
	add	esp, 48					; 00000030H
	mov	WORD PTR _nRC2$7787[ebp], ax

; 717  :       if ( nRC2 >= zCURSOR_SET )

	movsx	ecx, WORD PTR _nRC2$7787[ebp]
	test	ecx, ecx
	jl	$L7789
...
; 720  :          LPVIEWOD lpViewOD = zGETPTR( lpView->hViewOD );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOD$7791[ebp], eax
...
; 724  :                       "Probable User Error." );
	...
	lea	ecx, DWORD PTR _sz$7790[ebp]
	push	ecx
	call	_strcpy
	add	esp, 8
...
; 725  :          zstrcat( sz, "\nObject Def: " );
	...
	lea	edx, DWORD PTR _sz$7790[ebp]
	push	edx
	call	_strcat
	add	esp, 8
...
; 726  :          zstrcat( sz, lpViewOD->szName );
	...
	mov	eax, DWORD PTR _lpViewOD$7791[ebp]
	add	eax, 10					; 0000000aH
	push	eax
	lea	ecx, DWORD PTR _sz$7790[ebp]
	push	ecx
...
; 811  :             zstrcpy( sz, "(S->DT), " );
	...
	push	OFFSET FLAT:??_C@_09PDHB@?$CIS?9?$DODT?$CJ?0?5?$AA@ ; `string'
	lea	eax, DWORD PTR _sz$7827[ebp]
	push	eax
	call	_strcpy
	add	esp, 8
...
; 812  :             zstrcat( sz, lpViewEntity->szName );
	...
	add	ecx, 14					; 0000000eH
	push	ecx
	lea	edx, DWORD PTR _sz$7827[ebp]
	push	edx
	call	_strcat
	add	esp, 8
...
; 813  :             fnIssueCoreError( lpCurrentTask, lpView, 8, 263, 0, sz, lpViewAttrib->szName );
	...
	add	eax, 10					; 0000000aH
	push	eax
	lea	ecx, DWORD PTR _sz$7827[ebp]
	push	ecx
	push	0
	push	263					; 00000107H
	push	8
...
$L9841:
	...
	call	_fnSetEntityCursor
	add	esp, 48					; 00000030H
	mov	WORD PTR _nRC2$7834[ebp], ax

; 847  :       if ( nRC2 >= zCURSOR_SET )

	movsx	ecx, WORD PTR _nRC2$7834[ebp]
	test	ecx, ecx
	jl	$L7836
...
; 850  :          LPVIEWOD lpViewOD = zGETPTR( lpView->hViewOD );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOD$7838[ebp], eax
...
; 854  :                       "Probable User Error." );
	...
	push	OFFSET FLAT:??_C@_0HD@GMPL@Failure?5during?5standard?5call?0?5bu@ ; `string'
	lea	ecx, DWORD PTR _sz$7837[ebp]
	push	ecx
	call	_strcpy
	add	esp, 8
...
; 855  :          zstrcat( sz, "\nObject Def: " );
	...
	push	OFFSET FLAT:??_C@_0O@LMDE@?6Object?5Def?3?5?$AA@ ; `string'
	lea	edx, DWORD PTR _sz$7837[ebp]
	push	edx
	call	_strcat
	add	esp, 8
...
; 856  :          zstrcat( sz, lpViewOD->szName );
	...
	mov	eax, DWORD PTR _lpViewOD$7838[ebp]
	add	eax, 10					; 0000000aH
	push	eax
	lea	ecx, DWORD PTR _sz$7837[ebp]
	push	ecx
...
_lpViewOI$ = -16
_nRC$ = -8
_lpViewEntity$8092 = -28
_lpSearchViewEntity$8111 = -32
...
; 1538 :       LPVIEWENTITY lpViewEntity = zGETPTR( lpSearchEntityInstance->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$8092[ebp], eax
...
; 1574 :          zstrcpy( pchReturnEntityName, lpViewEntity->szName );
	...
	mov	eax, DWORD PTR _lpViewEntity$8092[ebp]
	add	eax, 14					; 0000000eH
	push	eax
...
; 1582 :               SetViewToSubobject( lpView, lpViewEntity->szName ) == 0 )
	...
	mov	ecx, DWORD PTR _lpViewEntity$8092[ebp]
...
; 1589 :                   lpSearchViewEntity = zGETPTR( lpSearchViewEntity->hParent ) )
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSearchViewEntity$8111[ebp], eax
	jmp	SHORT $L8114
$L8115:
	mov	edx, DWORD PTR _lpSearchViewEntity$8111[ebp]
	mov	eax, DWORD PTR [edx+10]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSearchViewEntity$8111[ebp], eax
$L8114:
	mov	ecx, DWORD PTR _lpSearchViewEntity$8111[ebp]
	mov	edx, DWORD PTR [ecx+235]
...
; 1594 :             zstrcpy( pchReturnEntityName, lpSearchViewEntity->szName );
	...
	mov	eax, DWORD PTR _lpSearchViewEntity$8111[ebp]
	add	eax, 14					; 0000000eH
	push	eax
	mov	ecx, DWORD PTR _pchReturnEntityName$[ebp]
	push	ecx
...
; 1599 :             zstrcpy( pchReturnEntityName, lpViewEntity->szName );
	...
	mov	edx, DWORD PTR _lpViewEntity$8092[ebp]
...
_nStartLevel$ = -16
_nRC$ = -8
_lpHierRootEntityInstance$8343 = -28
_lpViewEntity$8364 = -32
...
; 2277 :                               zGETPTR( lpViewCsr->hHierRootEntityInstance );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpHierRootEntityInstance$8343[ebp], eax
...
; 2284 :                 lpEntityInstance->nLevel <= lpHierRootEntityInstance->nLevel ) )
	...
	je	SHORT $L8346
	mov	edx, DWORD PTR _lpHierRootEntityInstance$8343[ebp]
	movsx	eax, WORD PTR [edx+58]
	cmp	eax, 1
	jle	SHORT $L8345
	mov	ecx, DWORD PTR _lpEntityInstance$[ebp]
	movsx	edx, WORD PTR [ecx+58]
	mov	eax, DWORD PTR _lpHierRootEntityInstance$8343[ebp]
	movsx	ecx, WORD PTR [eax+58]
	cmp	edx, ecx
	jg	SHORT $L8345
$L8346:
...
; 2328 :       LPVIEWENTITY lpViewEntity = zGETPTR( lpEntityInstance->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$8364[ebp], eax
...
; 2337 :       zstrcpy( pchReturnEntityName, lpViewEntity->szName );
	...
	mov	eax, DWORD PTR _lpViewEntity$8364[ebp]
	add	eax, 14					; 0000000eH
	push	eax
	mov	ecx, DWORD PTR _pchReturnEntityName$[ebp]
	push	ecx
...
; 2340 :       if ( lpViewEntity->bRecursive )
	...
	mov	ecx, DWORD PTR _lpViewEntity$8364[ebp]
	mov	edx, DWORD PTR [ecx+235]
	shr	edx, 11					; 0000000bH
	and	edx, 1
	test	edx, edx
...
; 2404 :       LPVIEWENTITY lpViewEntity = zGETPTR( lpEntityInstance->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$8392[ebp], eax

; 2405 : 
; 2406 :       zstrcpy( pchReturnEntityName, lpViewEntity->szName );

	mov	eax, DWORD PTR _lpViewEntity$8392[ebp]
	add	eax, 14					; 0000000eH
	push	eax
	mov	ecx, DWORD PTR _pchReturnEntityName$[ebp]
	push	ecx
...
; 2478 :       LPVIEWENTITY lpViewEntity = zGETPTR( lpEntityInstance->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$8420[ebp], eax

; 2479 : 
; 2480 :       zstrcpy( pchReturnEntityName, lpViewEntity->szName );

	mov	eax, DWORD PTR _lpViewEntity$8420[ebp]
	add	eax, 14					; 0000000eH
	push	eax
	mov	ecx, DWORD PTR _pchReturnEntityName$[ebp]
	push	ecx
...
_lpSearchEntityInstance$ = -12
_nRC$ = -8
_hSelectedInstance$8538 = -52
_hSelectedInstancePrev$8539 = -56
_lpSelectedInstancePrev$8540 = -44
_lpSelectedInstance$8541 = -48
_lpSearchViewEntity$8553 = -60
_lpSearchViewEntity$8569 = -64
_nStopLevel$8584 = -68
_lpSearchViewEntity$8589 = -72
...
; 2890 :       LPSELECTEDINSTANCE hSelectedInstance = lpViewCsr->hFirstSelectedInstance;
	...
	mov	DWORD PTR _hSelectedInstance$8538[ebp], edx

; 2891 :       LPSELECTEDINSTANCE hSelectedInstancePrev = 0;

	mov	DWORD PTR _hSelectedInstancePrev$8539[ebp], 0
$L8543:
...
; 2895 :       while ( hSelectedInstance )
	...
	cmp	DWORD PTR _hSelectedInstance$8538[ebp], 0
	je	$L8544

; 2897 :          lpSelectedInstance = zGETPTR( hSelectedInstance );

	mov	eax, DWORD PTR _hSelectedInstance$8538[ebp]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSelectedInstance$8541[ebp], eax
...
; 2903 :          lpSelectedInstance->nSelectSet &= ~(lpViewCsr->nCurrentSelectSet);
	...
	not	edx
	mov	eax, DWORD PTR _lpSelectedInstance$8541[ebp]
	mov	cx, WORD PTR [eax+6]
	and	cx, dx
	mov	edx, DWORD PTR _lpSelectedInstance$8541[ebp]
...
; 2906 :             if ( hSelectedInstancePrev )
	...
	cmp	DWORD PTR _hSelectedInstancePrev$8539[ebp], 0
	je	SHORT $L8547

; 2908 :                lpSelectedInstancePrev = zGETPTR( hSelectedInstancePrev );

	mov	edx, DWORD PTR _hSelectedInstancePrev$8539[ebp]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSelectedInstancePrev$8540[ebp], eax

; 2909 :                hSelectedInstance = lpSelectedInstance->hNextSelectedInstance;

	mov	eax, DWORD PTR _lpSelectedInstance$8541[ebp]
	mov	ecx, DWORD PTR [eax+2]
	mov	DWORD PTR _hSelectedInstance$8538[ebp], ecx

; 2910 :                lpSelectedInstancePrev->hNextSelectedInstance = hSelectedInstance;

	mov	edx, DWORD PTR _lpSelectedInstancePrev$8540[ebp]
	mov	eax, DWORD PTR _hSelectedInstance$8538[ebp]
...
; 2914 :                hSelectedInstance = lpSelectedInstance->hNextSelectedInstance;
	...
	mov	ecx, DWORD PTR _lpSelectedInstance$8541[ebp]
	mov	edx, DWORD PTR [ecx+2]
	mov	DWORD PTR _hSelectedInstance$8538[ebp], edx
...
; 2915 :                lpViewCsr->hFirstSelectedInstance = hSelectedInstance;
	...
	mov	eax, DWORD PTR _lpViewCsr$[ebp]
	mov	ecx, DWORD PTR _hSelectedInstance$8538[ebp]
...
; 2922 :             hSelectedInstancePrev = hSelectedInstance;
	...
	mov	eax, DWORD PTR _hSelectedInstance$8538[ebp]
	mov	DWORD PTR _hSelectedInstancePrev$8539[ebp], eax
...
; 2950 :          lpSearchViewEntity = zGETPTR( lpSearchEntityInstance->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSearchViewEntity$8553[ebp], eax

; 2951 :          if ( lpSearchViewEntity == lpViewEntity )

	mov	ecx, DWORD PTR _lpSearchViewEntity$8553[ebp]
...
; 2959 :                                        (zSHORT) (nState > 0 ? 2 : 3 ) );
	...
	call	DWORD PTR _g_pfnGetHndl
	push	eax
	mov	edx, DWORD PTR _lpSearchViewEntity$8553[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewCsr$[ebp]
	push	eax
	call	_fnSelectedInstanceFarbler
...
; 2975 :       LPVIEWENTITY lpSearchViewEntity = zGETPTR( lpViewEntityCsr->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSearchViewEntity$8569[ebp], eax
...
; 2991 :                                        (zSHORT) (nState > 0 ? 2 : 3 ) );
	...
	call	DWORD PTR _g_pfnGetHndl
	push	eax
	mov	eax, DWORD PTR _lpSearchViewEntity$8569[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpViewCsr$[ebp]
	push	ecx
	call	_fnSelectedInstanceFarbler
...
; 2999 :       int nStopLevel = lpScopingViewEntityCsr->nLevel;
	...
	mov	ecx, DWORD PTR _lpScopingViewEntityCsr$[ebp]
	movsx	edx, WORD PTR [ecx+22]
	mov	DWORD PTR _nStopLevel$8584[ebp], edx
...
; 3003 :               lpSearchEntityInstance->nLevel > nStopLevel )
	...
	mov	edx, DWORD PTR _lpSearchEntityInstance$[ebp]
	movsx	eax, WORD PTR [edx+58]
	cmp	eax, DWORD PTR _nStopLevel$8584[ebp]
	jle	SHORT $L8588
...
; 3015 :                                        (zSHORT) (nState > 0 ? 2 : 3 ) );
	...
	call	DWORD PTR _g_pfnGetHndl
	push	eax
	mov	edx, DWORD PTR _lpSearchViewEntity$8589[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewCsr$[ebp]
	push	eax
	call	_fnSelectedInstanceFarbler
...
_bScopeOI$ = -28
_nRC$ = -4
_lpSearchEntityInstance$8686 = -52
_lAttribControl$8692 = -56
_lAttribControl$8700 = -60
_lpTempViewEntityCsr$8712 = -88
_lpTempEntityInstance$8713 = -68
_lpNextHier$8714 = -64
_lpTempViewEntity$8715 = -76
_lpTempViewCsr$8716 = -92
_hTempViewEntityCsr$8717 = -72
_hTempEntityInstance$8718 = -80
_hTempViewEntity$8719 = -84
...
; 3412 :                              zGETPTR( lpScopingViewEntityCsr->hEntityInstance );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSearchEntityInstance$8686[ebp], eax

; 3413 :          if ( lpSearchEntityInstance == 0 || lpSearchEntityInstance->hNextHier == 0 )

	cmp	DWORD PTR _lpSearchEntityInstance$8686[ebp], 0
	je	SHORT $L8689
	mov	ecx, DWORD PTR _lpSearchEntityInstance$8686[ebp]
...
; 3428 :       zLONG lAttribControl = 0;
	...
	mov	DWORD PTR _lAttribControl$8692[ebp], 0
...
; 3432 :          lAttribControl = zALLOW_HIDDEN;
	...
	mov	DWORD PTR _lAttribControl$8692[ebp], 1
$L8693:
...
; 3436 :                                cpcAttributeName, lAttribControl )) == 0 )
	...
	mov	ecx, DWORD PTR _lAttribControl$8692[ebp]
	push	ecx
...
; 3464 :          zLONG lAttribControl = 0;
	...
	mov	DWORD PTR _lAttribControl$8700[ebp], 0
...
; 3468 :             lAttribControl = zALLOW_HIDDEN;
	...
	mov	DWORD PTR _lAttribControl$8700[ebp], 1
$L8701:
...
; 3472 :                                       cpcSrcAttributeName, lAttribControl );
	...
	mov	ecx, DWORD PTR _lAttribControl$8700[ebp]
	push	ecx
	mov	edx, DWORD PTR _cpcSrcAttributeName$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpSrcViewEntity$[ebp]
...
; 3524 :                                               1, 0, iViewEntityCsr );
	...
	add	esp, 20					; 00000014H
	mov	DWORD PTR _hTempViewEntityCsr$8717[ebp], eax
...
; 3527 :                                               1, 0, iEntityInstance );
	...
	call	_fnAllocDataspace
	add	esp, 20					; 00000014H
	mov	DWORD PTR _hTempEntityInstance$8718[ebp], eax
...
; 3530 :                                               1, 0, iViewEntity );
	...
	call	_fnAllocDataspace
	add	esp, 20					; 00000014H
	mov	DWORD PTR _hTempViewEntity$8719[ebp], eax

; 3531 : 
; 3532 :       lpTempViewEntityCsr  = zGETPTR( hTempViewEntityCsr );

	mov	edx, DWORD PTR _hTempViewEntityCsr$8717[ebp]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempViewEntityCsr$8712[ebp], eax

; 3533 :       lpTempEntityInstance = zGETPTR( hTempEntityInstance );

	mov	eax, DWORD PTR _hTempEntityInstance$8718[ebp]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempEntityInstance$8713[ebp], eax

; 3534 :       lpTempViewEntity     = zGETPTR( hTempViewEntity );

	mov	ecx, DWORD PTR _hTempViewEntity$8719[ebp]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempViewEntity$8715[ebp], eax

; 3535 : 
; 3536 :       lpScopingViewEntityCsr = lpTempViewEntityCsr;

	mov	edx, DWORD PTR _lpTempViewEntityCsr$8712[ebp]
	mov	DWORD PTR _lpScopingViewEntityCsr$[ebp], edx

; 3537 :       lpScopingViewEntity    = lpTempViewEntity;

	mov	eax, DWORD PTR _lpTempViewEntity$8715[ebp]
	mov	DWORD PTR _lpScopingViewEntity$[ebp], eax

; 3538 : 
; 3539 :       lpTempViewEntityCsr->hViewEntity     = hTempViewEntity;

	mov	ecx, DWORD PTR _lpTempViewEntityCsr$8712[ebp]
	mov	edx, DWORD PTR _hTempViewEntity$8719[ebp]
	mov	DWORD PTR [ecx+14], edx

; 3540 :       lpTempViewEntityCsr->hEntityInstance = hTempEntityInstance;

	mov	eax, DWORD PTR _lpTempViewEntityCsr$8712[ebp]
	mov	ecx, DWORD PTR _hTempEntityInstance$8718[ebp]
...
; 3546 :       lpTempViewCsr = zGETPTR( lpViewEntityCsr->hViewCsr );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempViewCsr$8716[ebp], eax

; 3547 :       lpTempViewEntityCsr->hNextHier = lpTempViewCsr->hRootViewEntityCsr; // ???

	mov	ecx, DWORD PTR _lpTempViewEntityCsr$8712[ebp]
	mov	edx, DWORD PTR _lpTempViewCsr$8716[ebp]
	mov	eax, DWORD PTR [edx+18]
...
; 3550 :       lpTempEntityInstance->hViewEntity = lpTempViewEntityCsr->hViewEntity;
	...
	mov	ecx, DWORD PTR _lpTempEntityInstance$8713[ebp]
	mov	edx, DWORD PTR _lpTempViewEntityCsr$8712[ebp]
	mov	eax, DWORD PTR [edx+14]
	mov	DWORD PTR [ecx+2], eax
...
; 3554 :       lpNextHier = zGETPTR( lpTempViewEntityCsr->hNextHier );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpNextHier$8714[ebp], eax

; 3555 :       lpTempViewEntity->hNextHier = lpNextHier->hViewEntity;

	mov	eax, DWORD PTR _lpTempViewEntity$8715[ebp]
	mov	ecx, DWORD PTR _lpNextHier$8714[ebp]
	mov	edx, DWORD PTR [ecx+14]
...
; 3559 :       lpTempEntityInstance->hNextHier = lpNextHier->hEntityInstance;
	...
	mov	eax, DWORD PTR _lpTempEntityInstance$8713[ebp]
	mov	ecx, DWORD PTR _lpNextHier$8714[ebp]
	mov	edx, DWORD PTR [ecx+26]
...
; 3572 :       fnFreeDataspace( lpTempViewEntity );
	...
	mov	edx, DWORD PTR _lpTempViewEntity$8715[ebp]
	push	edx
	call	_fnFreeDataspace
	add	esp, 4
...
_ulTossout$8811 = -328
_szContext$8816 = -368
_lpTaskDomain$8817 = -372
_lpDomain$8818 = -332
_szMsg$8831 = -872
_lpTaskDomain$8850 = -876
_bSkipDomain$8851 = -880
_lpDomain$8873 = -884
_szMsg$8876 = -1384
_lpDomain$8889 = -1388
_sz$8921 = -1644
...
; 3698 :       {
	...
	xor	edx, edx
	mov	dl, BYTE PTR $L9880[eax]
	jmp	DWORD PTR $L9881[edx*4]
$L8793:
...
; 3757 :                                               0, lpCurrentTask, 0 );
	...
	push	256					; 00000100H
	push	83					; 00000053H
	lea	edx, DWORD PTR _ulTossout$8811[ebp]
	push	edx
...
; 3764 :                szContext[ 0 ] = 0;
	...
	mov	BYTE PTR _szContext$8816[ebp], 0
...
; 3766 :                   zstrcpy( szContext, cpcContextName );
	...
	push	edx
	lea	eax, DWORD PTR _szContext$8816[ebp]
	push	eax
	call	_strcpy
	add	esp, 8
...
; 3770 :                   lpDomain = zGETPTR( lpSrcViewEntityAttrib->hDomain );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpDomain$8818[ebp], eax

; 3771 :                   zstrcpy( szContext, lpDomain->szName );

	mov	ecx, DWORD PTR _lpDomain$8818[ebp]
	add	ecx, 6
	push	ecx
	lea	edx, DWORD PTR _szContext$8816[ebp]
	push	edx
	call	_strcpy
	add	esp, 8
$L8821:
...
; 3778 :                                              zGETPTR( lpViewEntityAttrib->hDomain ) );
	...
	mov	eax, DWORD PTR _lpView$[ebp]
	push	eax
	lea	ecx, DWORD PTR _lpTaskDomain$8817[ebp]
	push	ecx
...
; 3803 :                                              sizeof( unTemp ) );
	...
	mov	eax, DWORD PTR _lpView$[ebp]
	push	eax
	lea	ecx, DWORD PTR _szContext$8816[ebp]
	push	ecx
	lea	edx, DWORD PTR _unTemp$[ebp]
	push	edx
	push	83					; 00000053H
	push	9
	mov	eax, DWORD PTR _lpTaskDomain$8817[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpCurrentTask$[ebp]
	push	ecx
...
; 3810 :                                   zDME_GET_COMPARE_VALUE, lpDomain->szName );
	...
	mov	eax, DWORD PTR _lpDomain$8818[ebp]
	add	eax, 6
	push	eax
	push	9
	mov	ecx, DWORD PTR _lpDomain$8818[ebp]
	...
	lea	edx, DWORD PTR _szMsg$8831[ebp]
	push	edx
...
; 3812 :                                      szMsg, zMSGQ_DOMAIN_ERROR, 0 );
	...
	push	0
	push	200					; 000000c8H
	lea	eax, DWORD PTR _szMsg$8831[ebp]
	push	eax
...
; 3858 :                            lpDomain = zGETPTR( lpTaskDomain->hDomain );
	...
	mov	ecx, DWORD PTR _lpTaskDomain$8817[ebp]
	mov	edx, DWORD PTR [ecx+14]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpDomain$8818[ebp], eax
...
; 3893 :       zBOOL          bSkipDomain = FALSE;
	...
	mov	BYTE PTR _bSkipDomain$8851[ebp], 0
...
; 3914 :             bSkipDomain = TRUE;
	...
	mov	BYTE PTR _bSkipDomain$8851[ebp], 1
...
; 3923 :       if ( lpViewEntityAttrib->hDomain && bSkipDomain == FALSE )
	...
	je	$L8866
	mov	eax, DWORD PTR _bSkipDomain$8851[ebp]
...
; 3928 :                                                                   hDomain ) );
	...
	mov	ecx, DWORD PTR _lpView$[ebp]
	push	ecx
	lea	edx, DWORD PTR _lpTaskDomain$8850[ebp]
	push	edx
	call	_fnDomainProcessingRequired
	add	esp, 16					; 00000010H
	mov	BYTE PTR _cDomainType$[ebp], al
...
; 3945 :                LPDOMAIN lpDomain = zGETPTR( lpViewEntityAttrib->hDomain );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpDomain$8873[ebp], eax
...
; 3955 :                                        sizeof( unTemp ) );
	...
	push	ecx
	push	9
	mov	edx, DWORD PTR _lpTaskDomain$8850[ebp]
	push	edx
	mov	eax, DWORD PTR _lpCurrentTask$[ebp]
	push	eax
	call	_fnCallDomainOper@40
...
; 3962 :                             zDME_GET_COMPARE_VALUE, lpDomain->szName );
	...
	mov	edx, DWORD PTR _lpDomain$8873[ebp]
	add	edx, 6
	push	edx
	push	9
	mov	eax, DWORD PTR _lpDomain$8873[ebp]
	add	eax, 100				; 00000064H
	push	eax
	push	OFFSET FLAT:??_C@_0EE@ELLG@Operation?5?8?$CFs?8?5does?5not?5handle?5a@ ; `string'
	lea	ecx, DWORD PTR _szMsg$8876[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 20					; 00000014H
...
; 3964 :                                szMsg, zMSGQ_DOMAIN_ERROR, 0 );
	...
	push	0
	push	200					; 000000c8H
	lea	edx, DWORD PTR _szMsg$8876[ebp]
	push	edx
	push	OFFSET FLAT:??_C@_0N@LGH@System?5Error?$AA@ ; `string'
	push	OFFSET FLAT:??_C@_08MEJN@TZDMD101?$AA@	; `string'
	mov	eax, DWORD PTR _lpView$[ebp]
...
; 4036 :                      lpDomain = zGETPTR( lpTaskDomain->hDomain );
	...
	mov	ecx, DWORD PTR _lpTaskDomain$8850[ebp]
	mov	edx, DWORD PTR [ecx+14]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpDomain$8889[ebp], eax
...
; 4040 :                               lpDomain->szName );
	...
	mov	ecx, DWORD PTR _lpDomain$8889[ebp]
	add	ecx, 6
	push	ecx
	lea	edx, DWORD PTR _unTemp$[ebp]
	push	edx
...
; 4073 :          if ( bSkipDomain == FALSE )
	...
	mov	ecx, DWORD PTR _bSkipDomain$8851[ebp]
	and	ecx, 255				; 000000ffH
	test	ecx, ecx
	jne	SHORT $L8904
...
; 4112 :                   zstrcpy( sz, "(L->" );
	...
	lea	eax, DWORD PTR _sz$8921[ebp]
	push	eax
	call	_strcpy
	add	esp, 8
...
; 4113 :                   n = zstrlen( sz );
	...
	lea	ecx, DWORD PTR _sz$8921[ebp]
	push	ecx
	call	_strlen
	add	esp, 4
	mov	WORD PTR _n$8922[ebp], ax

; 4114 :                   *( sz + n++ ) = lpViewEntityAttrib->cType;

	movsx	edx, WORD PTR _n$8922[ebp]
	mov	eax, DWORD PTR _lpViewEntityAttrib$[ebp]
	mov	cl, BYTE PTR [eax+202]
	mov	BYTE PTR _sz$8921[ebp+edx], cl
	mov	dx, WORD PTR _n$8922[ebp]
	add	dx, 1
	mov	WORD PTR _n$8922[ebp], dx

; 4115 :                   *( sz + n++ ) = 0;

	movsx	eax, WORD PTR _n$8922[ebp]
	mov	BYTE PTR _sz$8921[ebp+eax], 0
	mov	cx, WORD PTR _n$8922[ebp]
	add	cx, 1
	mov	WORD PTR _n$8922[ebp], cx

; 4116 :                   zstrcat( sz, "), " );

	push	OFFSET FLAT:??_C@_03OIDK@?$CJ?0?5?$AA@	; `string'
	lea	edx, DWORD PTR _sz$8921[ebp]
	push	edx
	call	_strcat
	add	esp, 8
...
; 4135 :             zstrcpy( sz, "(?->DT), " );
	...
	lea	edx, DWORD PTR _sz$8926[ebp]
	push	edx
	call	_strcpy
	add	esp, 8
...
; 4136 :             zstrcat( sz, lpViewEntity->szName );
	...
	add	eax, 14					; 0000000eH
	push	eax
	lea	ecx, DWORD PTR _sz$8926[ebp]
	push	ecx
	call	_strcat
	add	esp, 8
...
; 4138 :                               lpViewEntityAttrib->szName );
	...
	add	edx, 10					; 0000000aH
	push	edx
	lea	eax, DWORD PTR _sz$8926[ebp]
	push	eax
	push	0
	push	263					; 00000107H
	push	8
...
; 4168 :                      zstrcpy( sz, "(S->L), " );
	...
	lea	eax, DWORD PTR _sz$8943[ebp]
	push	eax
	call	_strcpy
	add	esp, 8
...
; 4169 :                      zstrcat( sz, lpViewEntity->szName );
	...
	add	ecx, 14					; 0000000eH
	push	ecx
	lea	edx, DWORD PTR _sz$8943[ebp]
	push	edx
	call	_strcat
	add	esp, 8
...
; 4171 :                                        lpViewEntityAttrib->szName );
	...
	add	eax, 10					; 0000000aH
	push	eax
	lea	ecx, DWORD PTR _sz$8943[ebp]
	push	ecx
	push	0
	push	263					; 00000107H
	push	8
...
; 4214 :                   zstrcpy( sz, "(S->" );
	...
	lea	ecx, DWORD PTR _sz$8956[ebp]
	push	ecx
	call	_strcpy
	add	esp, 8
...
; 4215 :                   n = zstrlen( sz );
	...
	lea	edx, DWORD PTR _sz$8956[ebp]
	push	edx
	call	_strlen
	add	esp, 4
	mov	WORD PTR _n$8957[ebp], ax

; 4216 :                   *( sz + n++ ) = lpViewEntityAttrib->cType;

	movsx	eax, WORD PTR _n$8957[ebp]
	mov	ecx, DWORD PTR _lpViewEntityAttrib$[ebp]
	mov	dl, BYTE PTR [ecx+202]
	mov	BYTE PTR _sz$8956[ebp+eax], dl
	mov	ax, WORD PTR _n$8957[ebp]
	add	ax, 1
	mov	WORD PTR _n$8957[ebp], ax

; 4217 :                   *( sz + n++ ) = 0;

	movsx	ecx, WORD PTR _n$8957[ebp]
	mov	BYTE PTR _sz$8956[ebp+ecx], 0
	mov	dx, WORD PTR _n$8957[ebp]
	add	dx, 1
	mov	WORD PTR _n$8957[ebp], dx

; 4218 :                   zstrcat( sz, "), " );

	push	OFFSET FLAT:??_C@_03OIDK@?$CJ?0?5?$AA@	; `string'
	lea	eax, DWORD PTR _sz$8956[ebp]
	push	eax
	call	_strcat
	add	esp, 8
...
; 4257 :                   zstrcpy( sz, "(M->" );
	...
	lea	ecx, DWORD PTR _sz$8970[ebp]
	push	ecx
	call	_strcpy
	add	esp, 8
...
; 4258 :                   n = zstrlen( sz );
	...
	lea	edx, DWORD PTR _sz$8970[ebp]
	push	edx
	call	_strlen
	add	esp, 4
	mov	WORD PTR _n$8971[ebp], ax

; 4259 :                   *(sz + n++) = lpViewEntityAttrib->cType;

	movsx	eax, WORD PTR _n$8971[ebp]
	mov	ecx, DWORD PTR _lpViewEntityAttrib$[ebp]
	mov	dl, BYTE PTR [ecx+202]
	mov	BYTE PTR _sz$8970[ebp+eax], dl
	mov	ax, WORD PTR _n$8971[ebp]
	add	ax, 1
	mov	WORD PTR _n$8971[ebp], ax

; 4260 :                   *(sz + n++) = 0;

	movsx	ecx, WORD PTR _n$8971[ebp]
	mov	BYTE PTR _sz$8970[ebp+ecx], 0
	mov	dx, WORD PTR _n$8971[ebp]
	add	dx, 1
	mov	WORD PTR _n$8971[ebp], dx

; 4261 :                   zstrcat( sz, "), " );

	push	OFFSET FLAT:??_C@_03OIDK@?$CJ?0?5?$AA@	; `string'
	lea	eax, DWORD PTR _sz$8970[ebp]
	push	eax
	call	_strcat
	add	esp, 8
...
_nRC$ = -4
_lpViewEntity$9090 = -24
_lpEntityInstance$9098 = -28
_bFound$9101 = -32
_bForward$9102 = -36
...
; 4531 :             LPVIEWENTITY lpViewEntity = zGETPTR( lpSearchEntityInstance->hViewEntity );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$9090[ebp], eax
...
; 4535 :             return( CheckExistenceOfEntity( lpView, lpViewEntity->szName ) );
	...
	mov	edx, DWORD PTR _lpViewEntity$9090[ebp]
	add	edx, 14					; 0000000eH
	push	edx
	mov	eax, DWORD PTR _lpView$[ebp]
	push	eax
...
; 4554 :          LPENTITYINSTANCE lpEntityInstance = zGETPTR( lpViewEntityCsr->hEntityInstance );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpEntityInstance$9098[ebp], eax
...
; 4562 :          if ( lpEntityInstance->u.nInd.bHidden )
	...
	mov	edx, DWORD PTR _lpEntityInstance$9098[ebp]
	mov	eax, DWORD PTR [edx+6]
	shr	eax, 10					; 0000000aH
	and	eax, 1
	test	eax, eax
...
; 4567 :             bFound = FALSE;
	...
	mov	BYTE PTR _bFound$9101[ebp], 0
...
$L9886:
	...
	mov	BYTE PTR _bForward$9102[ebp], al
...
; 4572 :                     (bForward == FALSE && lpSearchEntityInstance->hNextTwin) )
	...
	mov	eax, DWORD PTR _bForward$9102[ebp]
	and	eax, 255				; 000000ffH
	test	eax, eax
	je	SHORT $L9108
	mov	ecx, DWORD PTR _lpSearchEntityInstance$[ebp]
	...
	jne	SHORT $L9107
$L9108:
	mov	edx, DWORD PTR _bForward$9102[ebp]
	and	edx, 255				; 000000ffH
	test	edx, edx
	jne	SHORT $L9106
	mov	eax, DWORD PTR _lpSearchEntityInstance$[ebp]
...
; 4576 :                                zGETPTR( lpSearchEntityInstance->hNextTwin );
	...
	mov	ecx, DWORD PTR _bForward$9102[ebp]
	and	ecx, 255				; 000000ffH
	test	ecx, ecx
	je	SHORT $L9887
	mov	edx, DWORD PTR _lpSearchEntityInstance$[ebp]
...
; 4579 :                   bFound = TRUE;
	...
	mov	BYTE PTR _bFound$9101[ebp], 1
...
; 4584 :             if ( bFound )
	...
	mov	eax, DWORD PTR _bFound$9101[ebp]
	and	eax, 255				; 000000ffH
	test	eax, eax
	je	SHORT $L9112
...
_lpNextHier$9222 = -44
_lpSrchViewEntity$9240 = -48
_lpTempEntityCsr$9290 = -60
_lpFoundEntityInstance$9291 = -56
_bRebuild$9292 = -52
_lpResetInstance$9317 = -64
_lpParent$9318 = -72
_lpResetCsr$9319 = -68
_bFound$9344 = -76
_bForward$9345 = -80
...
; 4693 :                LPENTITYINSTANCE lpPrevHier = zGETPTR( lpSearchEntityInstance->hPrevHier );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpPrevHier$9185[ebp], eax

; 4694 : 
; 4695 :                if ( lpPrevHier && lpPrevHier->nLevel > nStopLevel )

	cmp	DWORD PTR _lpPrevHier$9185[ebp], 0
	je	SHORT $L9187
	mov	eax, DWORD PTR _lpPrevHier$9185[ebp]
	movsx	ecx, WORD PTR [eax+58]
...
; 4759 :                LPENTITYINSTANCE lpNextHier = zGETPTR( lpSearchEntityInstance->hNextHier );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpNextHier$9222[ebp], eax

; 4760 : 
; 4761 :                if ( lpNextHier && lpNextHier->nLevel > nStopLevel )

	cmp	DWORD PTR _lpNextHier$9222[ebp], 0
	je	SHORT $L9224
	mov	eax, DWORD PTR _lpNextHier$9222[ebp]
	movsx	ecx, WORD PTR [eax+58]
	movsx	edx, WORD PTR _nStopLevel$[ebp]
	cmp	ecx, edx
	jle	SHORT $L9224
...
; 4798 :       lpSrchViewEntity = zGETPTR( lpSearchEntityInstance->hViewEntity );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrchViewEntity$9240[ebp], eax
...
; 4827 :                                  lpCurrentTask )) )
	...
	test	eax, eax
	jne	$L9253
	mov	ecx, DWORD PTR _lpSrchViewEntity$9240[ebp]
	cmp	ecx, DWORD PTR _lpViewEntity$[ebp]
	je	SHORT $L9246
	mov	edx, DWORD PTR _lpSrchViewEntity$9240[ebp]
...
; 4970 :                     lpSearchEntityInstance->hPrevTwin )
	...
	mov	eax, DWORD PTR _lpSrchViewEntity$9240[ebp]
	cmp	eax, DWORD PTR _lpViewEntity$[ebp]
	jne	SHORT $L9284
	mov	ecx, DWORD PTR _lpSearchEntityInstance$[ebp]
	movsx	edx, WORD PTR [ecx+58]
...
; 4994 :          bRebuild = FALSE;
	...
	mov	BYTE PTR _bRebuild$9292[ebp], 0

; 4995 :          lpFoundEntityInstance = lpSearchEntityInstance;

	mov	eax, DWORD PTR _lpSearchEntityInstance$[ebp]
	mov	DWORD PTR _lpFoundEntityInstance$9291[ebp], eax
...
; 5012 :             lpTempEntityCsr = lpViewEntityCsr;
	...
	mov	eax, DWORD PTR _lpViewEntityCsr$[ebp]
	mov	DWORD PTR _lpTempEntityCsr$9290[ebp], eax
$L9301:

; 5013 :             while ( lpTempEntityCsr->hParent &&
; 5014 :                     zGETPTR( lpTempEntityCsr->hParent ) != lpScopingViewEntityCsr )

	mov	ecx, DWORD PTR _lpTempEntityCsr$9290[ebp]
	cmp	DWORD PTR [ecx+10], 0
	je	SHORT $L9302
	mov	edx, DWORD PTR _lpTempEntityCsr$9290[ebp]
	mov	eax, DWORD PTR [edx+10]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	cmp	eax, DWORD PTR _lpScopingViewEntityCsr$[ebp]
...
; 5022 :                     (lpTempEntityCsr->nLevel != lpSearchEntityInstance->nLevel ) )
	...
	je	SHORT $L9308
	mov	eax, DWORD PTR _lpTempEntityCsr$9290[ebp]
	mov	ecx, DWORD PTR [eax+26]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	cmp	eax, DWORD PTR _lpSearchEntityInstance$[ebp]
...
; 5024 :                   bRebuild = TRUE;
	...
	mov	BYTE PTR _bRebuild$9292[ebp], 1
...
; 5034 :          if ( bRebuild )
	...
	mov	eax, DWORD PTR _bRebuild$9292[ebp]
	and	eax, 255				; 000000ffH
	test	eax, eax
	je	SHORT $L9311
...
; 5040 :                                            lpFoundEntityInstance );
	...
	mov	edx, DWORD PTR _lpFoundEntityInstance$9291[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewEntityCsr$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpView$[ebp]
...
; 5057 :             lpResetCsr      = lpViewEntityCsr;
	...
	mov	ecx, DWORD PTR _lpViewEntityCsr$[ebp]
	mov	DWORD PTR _lpResetCsr$9319[ebp], ecx

; 5058 :             lpResetInstance = lpSearchEntityInstance;

	mov	edx, DWORD PTR _lpSearchEntityInstance$[ebp]
	mov	DWORD PTR _lpResetInstance$9317[ebp], edx

; 5059 :             lpParent        = zGETPTR( lpResetCsr->hParent );

	mov	eax, DWORD PTR _lpResetCsr$9319[ebp]
	mov	ecx, DWORD PTR [eax+10]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$9318[ebp], eax
$L9322:
...
; 5064 :                     lpParent->hEntityInstance != lpResetInstance->hParent )
	...
	cmp	DWORD PTR _lpParent$9318[ebp], 0
	je	SHORT $L9323
	mov	edx, DWORD PTR _lpParent$9318[ebp]
	mov	eax, DWORD PTR _lpResetInstance$9317[ebp]
...
; 5066 :                lpResetCsr      = zGETPTR( lpResetCsr->hParent );
	...
	mov	edx, DWORD PTR _lpResetCsr$9319[ebp]
	mov	eax, DWORD PTR [edx+10]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpResetCsr$9319[ebp], eax

; 5067 :                lpResetInstance = zGETPTR( lpResetInstance->hParent );

	mov	ecx, DWORD PTR _lpResetInstance$9317[ebp]
	mov	edx, DWORD PTR [ecx+30]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpResetInstance$9317[ebp], eax
...
; 5083 :                if ( lpResetCsr != lpViewEntityCsr )
	...
	mov	ecx, DWORD PTR _lpResetCsr$9319[ebp]
...
; 5092 :                   while ( lpViewEntityCsr != lpResetCsr )
	...
	mov	eax, DWORD PTR _lpViewEntityCsr$[ebp]
	cmp	eax, DWORD PTR _lpResetCsr$9319[ebp]
	je	SHORT $L9337
...
; 5121 :          bFound = FALSE;
	...
	mov	BYTE PTR _bFound$9344[ebp], 0
...
$L9892:
	...
	mov	BYTE PTR _bForward$9345[ebp], cl
$L9347:
...
; 5126 :                  (bForward == FALSE && lpSearchEntityInstance->hNextTwin) )
	...
	mov	edx, DWORD PTR _bForward$9345[ebp]
	and	edx, 255				; 000000ffH
	test	edx, edx
	je	SHORT $L9350
	mov	eax, DWORD PTR _lpSearchEntityInstance$[ebp]
	...
	jne	SHORT $L9349
$L9350:
	mov	ecx, DWORD PTR _bForward$9345[ebp]
	and	ecx, 255				; 000000ffH
	test	ecx, ecx
	jne	SHORT $L9348
	mov	edx, DWORD PTR _lpSearchEntityInstance$[ebp]
...
; 5130 :                                zGETPTR( lpSearchEntityInstance->hNextTwin );
	...
	mov	eax, DWORD PTR _bForward$9345[ebp]
	and	eax, 255				; 000000ffH
	test	eax, eax
	je	SHORT $L9893
	mov	ecx, DWORD PTR _lpSearchEntityInstance$[ebp]
...
; 5133 :                bFound = TRUE;
	...
	mov	BYTE PTR _bFound$9344[ebp], 1
...
; 5138 :          if ( bFound )
	...
	mov	edx, DWORD PTR _bFound$9344[ebp]
	and	edx, 255				; 000000ffH
	test	edx, edx
	je	SHORT $L9354
...
_lpCurrentTask$ = 52
_nRC$ = -4
_lpViewEntityCsrDA$9387 = -8
_lpViewEntityCsrForDomain$9398 = -12
_lpViewEntityCsrForDomain$9402 = -16
_lpViewEntityCsrForDomain$9406 = -20
_lpViewEntityCsrForDomain$9410 = -24
...
; 5201 :                                                     lpSearchEntityInstance );
	...
	call	_fnEstablishViewForInstance
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _lpViewEntityCsrDA$9387[ebp], eax
...
; 5205 :                                       lpCurrentTask, zDERIVED_GET );
	...
	mov	edx, DWORD PTR _lpViewAttrib$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewEntityCsrDA$9387[ebp]
	mov	ecx, DWORD PTR [eax+14]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	push	eax
...
; 5220 :                                                     lpSearchEntityInstance );
	...
	call	_fnEstablishViewForInstance
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _lpViewEntityCsrForDomain$9398[ebp], eax
...
; 5226 :                                                 lpCurrentTask, 0 );
	...
	mov	edx, DWORD PTR _lpViewAttrib$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewEntityCsrForDomain$9398[ebp]
	push	eax
	mov	ecx, DWORD PTR _vAttrView$[ebp]
	push	ecx
	call	_fnCompareAttributeToVariable
...
; 5240 :                                                     lpSearchEntityInstance );
	...
	call	_fnEstablishViewForInstance
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _lpViewEntityCsrForDomain$9402[ebp], eax
...
; 5245 :                                                 cpcContextName, lpCurrentTask, 0 );
	...
	mov	edx, DWORD PTR _lpViewAttrib$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewEntityCsrForDomain$9402[ebp]
	push	eax
	mov	ecx, DWORD PTR _vAttrView$[ebp]
	push	ecx
	call	_fnCompareAttributeToVariable
...
; 5259 :                                                     lpSearchEntityInstance );
	...
	call	_fnEstablishViewForInstance
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _lpViewEntityCsrForDomain$9406[ebp], eax
...
; 5265 :                                                 lpCurrentTask, 0 );
	...
	mov	eax, DWORD PTR _lpViewAttrib$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpViewEntityCsrForDomain$9406[ebp]
	push	ecx
	mov	edx, DWORD PTR _vAttrView$[ebp]
	push	edx
	call	_fnCompareAttributeToVariable
...
; 5279 :                                                     lpSearchEntityInstance );
	...
	call	_fnEstablishViewForInstance
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _lpViewEntityCsrForDomain$9410[ebp], eax
...
; 5285 :                                                 lpCurrentTask, 0 );
	...
	mov	edx, DWORD PTR _lpViewAttrib$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewEntityCsrForDomain$9410[ebp]
	push	eax
	mov	ecx, DWORD PTR _vAttrView$[ebp]
	push	ecx
	call	_fnCompareAttributeToVariable
...
_hViewEntity$ = -16
_nRC$ = -4
_lpEntityInstance$9434 = -24
_lpOwningTask$9467 = -32
_lpViewOI$9468 = -36
_hInstance$9469 = -28
_lpView$9484 = -40
...
; 5362 :          LPENTITYINSTANCE lpEntityInstance = zGETPTR( hEntityInstance );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpEntityInstance$9434[ebp], eax
...
; 5369 :                     lpEntityInstance->u.nInd.bHidden )
	...
	mov	eax, DWORD PTR _lpEntityInstance$9434[ebp]
	movsx	ecx, WORD PTR [eax]
	cmp	ecx, 10024				; 00002728H
	jne	SHORT $L9442
	mov	edx, DWORD PTR _lpEntityInstance$9434[ebp]
	mov	eax, DWORD PTR [edx+6]
	shr	eax, 10					; 0000000aH
	and	eax, 1
	test	eax, eax
...
; 5411 :                     lpEntityInstance->u.nInd.bHidden )
	...
	mov	ecx, DWORD PTR _lpEntityInstance$9434[ebp]
...
; 5499 :             lpOwningTask = zGETPTR( lpViewOI->hTask );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpOwningTask$9467[ebp], eax
...
; 5503 :                                           1, 0, iSelectedInstance );
	...
	push	1
	push	16					; 00000010H
	mov	edx, DWORD PTR _lpOwningTask$9467[ebp]
	mov	eax, DWORD PTR [edx+94]
	push	eax
	call	_fnAllocDataspace
	add	esp, 20					; 00000014H
	mov	DWORD PTR _hInstance$9469[ebp], eax

; 5504 :             lpSrchSelectedInstance = zGETPTR( hInstance );

	mov	ecx, DWORD PTR _hInstance$9469[ebp]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrchSelectedInstance$[ebp], eax
...
; 5508 :                   lpPrevSelectedInstance->hNextSelectedInstance = hInstance;
	...
	mov	edx, DWORD PTR _lpPrevSelectedInstance$[ebp]
	mov	eax, DWORD PTR _hInstance$9469[ebp]
	mov	DWORD PTR [edx+2], eax
...
; 5510 :                   lpViewCsr->hFirstSelectedInstance = hInstance;
	...
	mov	ecx, DWORD PTR _lpViewCsr$[ebp]
	mov	edx, DWORD PTR _hInstance$9469[ebp]
...
; 5521 :                zVIEW lpView = zGETPTR( lpViewCsr->hView );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpView$9484[ebp], eax
...
; 5523 :                                  20, 12, 0, 0, 0 );
	...
	push	12					; 0000000cH
	push	20					; 00000014H
	mov	eax, DWORD PTR _lpView$9484[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpView$9484[ebp]
	mov	edx, DWORD PTR [ecx+14]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	push	eax
...
_bOperationIdxSet$ = -8
_lpTask$9546 = -48
_lpHierRootEntityInstance$9558 = -52
_lpTask$9561 = -56
_lpTask$9565 = -60
_lpTask$9570 = -64
_lpParent$9602 = -68
_lpTask$9623 = -72
_lpTask$9627 = -76
_lpTempViewEntity1$9629 = -80
_lpTempViewEntity2$9631 = -84
...
; 5662 :             LPTASK lpTask = zGETPTR( lpView->hTask );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$9546[ebp], eax
...
; 5665 :                               lpViewEntity->szName, 0 );
	...
	mov	eax, DWORD PTR _lpView$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpTask$9546[ebp]
	push	ecx
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
...
; 5689 :                            zGETPTR( lpViewCsr->hHierRootEntityInstance );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpHierRootEntityInstance$9558[ebp], eax
...
; 5694 :          LPTASK lpTask = zGETPTR( lpView->hTask );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$9561[ebp], eax
...
; 5696 :          fnIssueCoreError( lpTask, lpView, 8, 264, 0, 0, 0 );
	...
	mov	ecx, DWORD PTR _lpView$[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpTask$9561[ebp]
	push	edx
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
...
; 5703 :       if ( lpHierRootEntityInstance->u.nInd.bHidden )
	...
	mov	eax, DWORD PTR _lpHierRootEntityInstance$9558[ebp]
	mov	ecx, DWORD PTR [eax+6]
	shr	ecx, 10					; 0000000aH
	and	ecx, 1
	test	ecx, ecx
...
; 5705 :          LPTASK lpTask = zGETPTR( lpView->hTask );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$9565[ebp], eax
...
; 5707 :          fnIssueCoreError( lpTask, lpView, 8, 267, 0, 0, 0 );
	...
	mov	ecx, DWORD PTR _lpView$[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpTask$9565[ebp]
	push	edx
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
...
; 5718 :          LPTASK lpTask = zGETPTR( lpView->hTask );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$9570[ebp], eax
...
; 5720 :          fnIssueCoreError( lpTask, lpView, 8, 265, 0, 0, 0 );
	...
	mov	eax, DWORD PTR _lpView$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpTask$9570[ebp]
	push	ecx
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
...
; 5818 :             lpParent = zGETPTR( lpScopingEntityInstance->hParent );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$9602[ebp], eax

; 5819 :             if ( lpParent->u.nInd.bHidden == FALSE )

	mov	edx, DWORD PTR _lpParent$9602[ebp]
	mov	eax, DWORD PTR [edx+6]
	shr	eax, 10					; 0000000aH
	and	eax, 1
	test	eax, eax
...
; 5822 :             lpScopingEntityInstance = lpParent;
	...
	mov	ecx, DWORD PTR _lpParent$9602[ebp]
...
; 5868 :          LPTASK lpTask = zGETPTR( lpView->hTask );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$9623[ebp], eax
...
; 5871 :                            lpViewEntity->szName, 0 );
	...
	mov	edx, DWORD PTR _lpView$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpTask$9623[ebp]
	push	eax
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
...
; 5891 :       LPTASK lpTask = zGETPTR( lpView->hTask );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$9627[ebp], eax
...
; 5893 :                            zGETPTR( lpScopingViewEntityCsr->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempViewEntity1$9629[ebp], eax
...
; 5895 :                            zGETPTR( lpViewEntityCsr->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempViewEntity2$9631[ebp], eax
...
; 5904 :                         lpTempViewEntity2->szName );
	...
	mov	eax, DWORD PTR _lpTempViewEntity2$9631[ebp]
	add	eax, 14					; 0000000eH
	push	eax
	mov	ecx, DWORD PTR _lpTempViewEntity1$9629[ebp]
	add	ecx, 14					; 0000000eH
	push	ecx
	push	0
	push	257					; 00000101H
	...
	mov	edx, DWORD PTR _lpView$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpTask$9627[ebp]
	push	eax
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
...
; 6167 :          zVIEW lpView = zGETPTR( lpViewCsr->hView );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpView$9737[ebp], eax
...
; 6170 :                         "call to fnEstablishCursorForView", 1 );
	...
	mov	eax, DWORD PTR _lpView$9737[ebp]
	push	eax
	call	_SysMessageBox@16
