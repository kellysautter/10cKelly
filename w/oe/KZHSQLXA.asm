...
_DATA	SEGMENT DWORD USE32 PUBLIC 'DATA'
_DATA	ENDS
;	COMDAT ??_C@_0BF@GOJF@Jan?5?59?52025?509?309?306?$AA@
_DATA	SEGMENT DWORD USE32 PUBLIC 'DATA'
_DATA	ENDS
...
PUBLIC	??_C@_0BF@GOJF@Jan?5?59?52025?509?309?306?$AA@	; `string'
...
;	COMDAT ??_C@_0BF@GOJF@Jan?5?59?52025?509?309?306?$AA@
_DATA	SEGMENT
??_C@_0BF@GOJF@Jan?5?59?52025?509?309?306?$AA@ DB 'Jan  9 2025 09:09:06', 00H ; `string'
_DATA	ENDS
;	COMDAT ??_C@_0CD@BONL@Compile?5date?1time?5for?5KZHSQLXX?5i@
_DATA	SEGMENT
...
; 864  :                   __DATE__ " " __TIME__ );
	...
	push	OFFSET FLAT:??_C@_0BF@GOJF@Jan?5?59?52025?509?309?306?$AA@ ; `string'
...
; 914  :                 szStr );
	...
	lea	ecx, DWORD PTR _szMsg$57469[ebp]
	push	ecx
...
; 915  :       DBH_Error( vDbhWork, szMsg, 0, 0 );
	...
	push	0
	push	0
	lea	edx, DWORD PTR _szMsg$57469[ebp]
	push	edx
	mov	eax, DWORD PTR _vDbhWork$[ebp]
	push	eax
	call	_DBH_Error
...
; 927  :       zSHORT nLth = zstrlen( szLogicalName );
	...
	call	_strlen
	add	esp, 4
	mov	WORD PTR _nLth$57477[ebp], ax
...
; 932  :          GetAddrForAttribute( &pch, vDbhWork, "Connection", "LogicalUserName" );
	...
	mov	edx, DWORD PTR _vDbhWork$[ebp]
	push	edx
	lea	eax, DWORD PTR _pch$57476[ebp]
	push	eax
	call	_GetAddrForAttribute@16

; 933  :          if ( zstrncmp( szLogicalName, pch, nLth ) == 0 )

	movsx	ecx, WORD PTR _nLth$57477[ebp]
	push	ecx
	mov	edx, DWORD PTR _pch$57476[ebp]
	push	edx
...
; 947  :                 szLogicalName );
	...
	lea	edx, DWORD PTR _szMsg$57483[ebp]
	push	edx
	call	DWORD PTR __imp__sprintf
	add	esp, 12					; 0000000cH
...
; 949  :       TraceLineS( "ERROR ********** CloseDatabase ", szMsg );
	...
	lea	eax, DWORD PTR _szMsg$57483[ebp]
	push	eax
...
; 969  :       for ( k = 0; k < lpConnection->nQualCount; k++ )
	...
	mov	WORD PTR _k$57489[ebp], 0
	jmp	SHORT $L57490
$L57491:
	mov	dx, WORD PTR _k$57489[ebp]
	add	dx, 1
	mov	WORD PTR _k$57489[ebp], dx
$L57490:
	movsx	eax, WORD PTR _k$57489[ebp]
	mov	ecx, DWORD PTR _lpConnection$[ebp]
...
; 975  :       for ( k = 0; k < lpConnection->nOpenDatabaseCount; k++ )
	...
	jmp	SHORT $L57493
$L57494:
	mov	cx, WORD PTR _k$57489[ebp]
	add	cx, 1
	mov	WORD PTR _k$57489[ebp], cx
$L57493:
	movsx	edx, WORD PTR _k$57489[ebp]
	mov	eax, DWORD PTR _lpConnection$[ebp]
...
; 1103 :       for ( k = 0; k < lpConnection->nOpenDatabaseCount; k++ )
	...
	mov	WORD PTR _k$57510[ebp], 0
	jmp	SHORT $L57517
$L57518:
	mov	cx, WORD PTR _k$57510[ebp]
	add	cx, 1
	mov	WORD PTR _k$57510[ebp], cx
$L57517:
	movsx	edx, WORD PTR _k$57510[ebp]
	mov	eax, DWORD PTR _lpConnection$[ebp]
	movsx	ecx, WORD PTR [eax+216]
	cmp	edx, ecx
	jge	SHORT $L57519
...
; 1451 :          nLevel = (*plpChildEntity)->nLevel;
	...
	mov	WORD PTR _nLevel$57576[ebp], cx
$L57579:
...
; 1452 :          while ( (*plpChildEntity) && (*plpChildEntity)->nLevel >= nLevel )
	...
	mov	ecx, DWORD PTR [eax]
	movsx	edx, WORD PTR [ecx+215]
	movsx	eax, WORD PTR _nLevel$57576[ebp]
	cmp	edx, eax
	jl	SHORT $L57580
$L57582:
...
_TEXT	SEGMENT
_lpLoopInfo$ = 8
_lpViewAttrib$57591 = -4
_lpDataRecord$57595 = -8
_lpDataRecord$57601 = -12
_lpLoadViewEntity$57604 = -16
...
; 1496 :                            zGETPTR( lpLoopInfo->lpViewEntity->hFirstDataRecord );
	...
	push	eax
	call	_SysGetPointerFromHandle@4
	mov	DWORD PTR _lpDataRecord$57595[ebp], eax

; 1497 : 
; 1498 :             lpLoopInfo->lpDataField = zGETPTR( lpDataRecord->hFirstDataField );

	mov	ecx, DWORD PTR _lpDataRecord$57595[ebp]
...
; 1530 :                         zGETPTR( lpLoopInfo->lpChildEntity->hFirstDataRecord );
	...
	push	edx
	call	_SysGetPointerFromHandle@4
	mov	DWORD PTR _lpDataRecord$57601[ebp], eax

; 1531 :                   lpLoopInfo->lpDataField = zGETPTR( lpDataRecord->hFirstDataField );

	mov	eax, DWORD PTR _lpDataRecord$57601[ebp]
...
; 1554 :       lpViewAttrib = zGETPTR( lpLoopInfo->lpDataField->hViewAttrib );
	...
	push	eax
	call	_SysGetPointerFromHandle@4
	mov	DWORD PTR _lpViewAttrib$57591[ebp], eax
...
; 1564 :          if ( lpLoopInfo->bKeysOnly && lpViewAttrib->bKey == FALSE )
	...
	test	ecx, ecx
	je	SHORT $L57605
	mov	edx, DWORD PTR _lpViewAttrib$57591[ebp]
...
; 1571 :               lpViewAttrib->bAutoSeq == FALSE )
	...
	mov	ecx, DWORD PTR _lpViewAttrib$57591[ebp]
	mov	edx, DWORD PTR [ecx+193]
	shr	edx, 5
	and	edx, 1
	test	edx, edx
	je	SHORT $L57606
	mov	eax, DWORD PTR _lpViewAttrib$57591[ebp]
...
; 1576 :          lpLoadViewEntity = zGETPTR( lpViewAttrib->hViewEntity );
	...
	push	ecx
	call	_SysGetPointerFromHandle@4
	mov	DWORD PTR _lpLoadViewEntity$57604[ebp], eax
...
; 1580 :          if ( lpLoadViewEntity->bHasDB_Oper && lpViewAttrib->cDB_Oper == 0 )
	...
	mov	edx, DWORD PTR _lpLoadViewEntity$57604[ebp]
...
_nKeyCnt$ = -20
_nRC$ = -4
_pchEntityJoinTable$57649 = -40
_lControl$57657 = -52
_pQualValue$57658 = -44
_lpLoopViewAttrib$57660 = -48
_chType$57679 = -56
_ulLth$57680 = -60
_plKeyValue$57686 = -64
_pchKeyValue$57691 = -68
_szDecimal$57720 = -168
...
; 1751 :       zPCHAR pchEntityJoinTable = lpBoundList->pchEntityJoinTable;
	...
	mov	edx, DWORD PTR [ecx+18]
	mov	DWORD PTR _pchEntityJoinTable$57649[ebp], edx
...
; 1762 :                                            zSELECT_JOINEDWITHMULTCHILD) != 0 )
	...
	mov	edx, DWORD PTR _pchEntityJoinTable$57649[ebp]
...
; 1770 :                                            zSELECT_JOINEDWITHPARENT) == 0 )
	...
	mov	ecx, DWORD PTR _lpSearchEntity$[ebp]
	movsx	edx, WORD PTR [ecx+217]
	mov	eax, DWORD PTR _pchEntityJoinTable$57649[ebp]
	movsx	ecx, BYTE PTR [eax+edx]
	and	ecx, 1
	test	ecx, ecx
	jne	SHORT $L57654
...
; 1781 :       zLONG        lControl   = zQUAL_ATTR_HIDDEN | zQUAL_EQUAL;
	...
	mov	DWORD PTR _lControl$57657[ebp], 16777232 ; 01000010H

; 1782 :       zCPVOID      pQualValue = (zCPVOID) lpKeyData[ 0 ].lpPtr;

	mov	eax, DWORD PTR _lpKeyData$[ebp]
	mov	ecx, DWORD PTR [eax+12]
	mov	DWORD PTR _pQualValue$57658[ebp], ecx
...
; 1787 :       lpLoopViewAttrib = lpKeyData[ 0 ].lpViewAttrib;
	...
	mov	eax, DWORD PTR [edx+4]
	mov	DWORD PTR _lpLoopViewAttrib$57660[ebp], eax
...
; 1792 :             lControl |= zQUAL_INTEGER;
	...
	mov	ecx, DWORD PTR _lControl$57657[ebp]
	or	ch, 1
	mov	DWORD PTR _lControl$57657[ebp], ecx
...
; 1796 :             lControl |= zQUAL_STRING;
	...
	mov	edx, DWORD PTR _lControl$57657[ebp]
	or	dh, 4
	mov	DWORD PTR _lControl$57657[ebp], edx
...
; 1800 :             lControl |= zQUAL_DECIMAL;
	...
	mov	eax, DWORD PTR _lControl$57657[ebp]
	or	ah, 2
	mov	DWORD PTR _lControl$57657[ebp], eax
...
; 1819 :                                    0, 0, 0 ) )
	...
	push	0
	push	0
	mov	edx, DWORD PTR _pQualValue$57658[ebp]
	push	edx
	mov	eax, DWORD PTR _lControl$57657[ebp]
	or	al, 1
	push	eax
	mov	ecx, DWORD PTR _lpLoopViewAttrib$57660[ebp]
...
$L57674:
	...
	push	0
	push	0
	mov	ecx, DWORD PTR _pQualValue$57658[ebp]
	push	ecx
	mov	edx, DWORD PTR _lControl$57657[ebp]
	or	edx, 3
	push	edx
	mov	eax, DWORD PTR _lpLoopViewAttrib$57660[ebp]
	add	eax, 10					; 0000000aH
	push	eax
...
; 1841 :                                       (zCOREMEM) &plKeyValue, &chType, &ulLth );
	...
	lea	eax, DWORD PTR _ulLth$57680[ebp]
	push	eax
	lea	ecx, DWORD PTR _chType$57679[ebp]
	push	ecx
	lea	edx, DWORD PTR _plKeyValue$57686[ebp]
	push	edx
...
; 1845 :                   if ( *plKeyValue != *((zPLONG) lpPtr) )
	...
	mov	eax, DWORD PTR _plKeyValue$57686[ebp]
...
; 1856 :                                       (zCOREMEM) &pchKeyValue, &chType, &ulLth );
	...
	lea	ecx, DWORD PTR _chType$57679[ebp]
	push	ecx
	lea	edx, DWORD PTR _pchKeyValue$57691[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewAttrib$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpLoadEntity$[ebp]
...
; 1937 :                                  szDecimal, sizeof( szDecimal ) );
	...
	push	100					; 00000064H
	lea	ecx, DWORD PTR _szDecimal$57720[ebp]
	push	ecx
...
; 1939 :                                  szDecimal );
	...
	lea	edx, DWORD PTR _szDecimal$57720[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewAttrib$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpLoadEntity$[ebp]
...
_szMsg$57782 = -2648
_k$57786 = -2652
_lpParent$57804 = -2656
_hTask$57839 = -2660
_bEntityCreatedList$57849 = -3160
_lpLastCreatedEntity$57853 = -3168
_bNewEntity$57854 = -3172
_lpCreatedEntity$57855 = -3164
_lpLoadEntity$57861 = -3176
_lTemp$57887 = -3180
_szTemp$57889 = -3212
_dTemp$57893 = -3252
_szDateTime$57897 = -3272
_Load	PROC NEAR
...
; 2114 :                 lpViewOD->szName, lpViewEntity->szName );
	...
	lea	edx, DWORD PTR _szMsg$57782[ebp]
	push	edx
	call	DWORD PTR __imp__sprintf
	add	esp, 16					; 00000010H
...
; 2115 :       SysMessageBox( lpView, "DBHandler Warning", szMsg, 0 );
	...
	push	0
	lea	eax, DWORD PTR _szMsg$57782[ebp]
	push	eax
...
; 2132 :       for ( k = 0; k < lpConnection->nQualCount; k++ )
	...
	mov	WORD PTR _k$57786[ebp], 0
	jmp	SHORT $L57787
$L57788:
	mov	cx, WORD PTR _k$57786[ebp]
	add	cx, 1
	mov	WORD PTR _k$57786[ebp], cx
$L57787:
	movsx	edx, WORD PTR _k$57786[ebp]
	mov	eax, DWORD PTR _lpConnection$[ebp]
	movsx	ecx, WORD PTR [eax+188]
	cmp	edx, ecx
	jge	SHORT $L57789
...
; 2145 :          if ( lpConnection->lpQualEntityList[ k ] )
	...
	movsx	eax, WORD PTR _k$57786[ebp]
	mov	ecx, DWORD PTR _lpConnection$[ebp]
...
; 2156 :          if ( k == lpConnection->nQualCount )
	...
	movsx	ecx, WORD PTR _k$57786[ebp]
	mov	edx, DWORD PTR _lpConnection$[ebp]
...
; 2192 :          LPVIEWENTITY lpParent = zGETPTR( lpViewEntity->hParent );
	...
	push	ecx
	call	_SysGetPointerFromHandle@4
	mov	DWORD PTR _lpParent$57804[ebp], eax

; 2193 : 
; 2194 :          DisplayEntityInstance( lpView, lpParent->szName );

	mov	edx, DWORD PTR _lpParent$57804[ebp]
	add	edx, 14					; 0000000eH
	push	edx
	mov	eax, DWORD PTR _lpView$[ebp]
	push	eax
...
; 2869 :       zLONG hTask = SysGetTaskFromView( lpView );
	...
	push	ecx
	call	_SysGetTaskFromView@4
	mov	DWORD PTR _hTask$57839[ebp], eax
...
; 2870 :       if ( fnCreateKeyList( hTask, lpConnection, lpBoundList, lpQualEntity ) < 0 )
	...
	mov	ecx, DWORD PTR _lpConnection$[ebp]
	push	ecx
	mov	edx, DWORD PTR _hTask$57839[ebp]
	push	edx
...
; 3023 :       zmemset( bEntityCreatedList, 0, sizeof( bEntityCreatedList ) );
	...
	push	500					; 000001f4H
	push	0
	lea	edx, DWORD PTR _bEntityCreatedList$57849[ebp]
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
...
; 3035 :          LPVIEWENTITY lpCreatedEntity = 0;
	...
	mov	DWORD PTR _lpCreatedEntity$57855[ebp], 0
...
; 3058 :          lpLastCreatedEntity        = 0;
	...
	mov	DWORD PTR _lpLastCreatedEntity$57853[ebp], 0

; 3059 :          bNewEntity                 = FALSE;

	mov	BYTE PTR _bNewEntity$57854[ebp], 0
...
; 3082 :             lpLoadEntity = zGETPTR( lpViewAttrib->hViewEntity );
	...
	push	ecx
	call	_SysGetPointerFromHandle@4
	mov	DWORD PTR _lpLoadEntity$57861[ebp], eax

; 3083 : 
; 3084 :             if ( lpLoadEntity != lpLastCreatedEntity )

	mov	edx, DWORD PTR _lpLoadEntity$57861[ebp]
	cmp	edx, DWORD PTR _lpLastCreatedEntity$57853[ebp]
	je	SHORT $L57862

; 3085 :                bNewEntity = TRUE;

	mov	BYTE PTR _bNewEntity$57854[ebp], 1
...
; 3106 :                   lpKeyData[ 0 ].lpLoadEntity != lpLoadEntity) )
	...
	jle	$L57878
	mov	ecx, DWORD PTR _lpKeyData$[ebp]
	cmp	ecx, DWORD PTR _lpLoadEntity$57861[ebp]
	je	$L57878
$L57865:
...
; 3116 :                                            lRootCnt, lpBoundList );
	...
	push	edx
	lea	eax, DWORD PTR _bEntityCreatedList$57849[ebp]
	push	eax
...
; 3129 :                      if ( lpLoadEntity == lpViewEntity )
	...
	mov	eax, DWORD PTR _lpLoadEntity$57861[ebp]
...
; 3137 :                                     lpLoadEntity->szName );
	...
	mov	ecx, DWORD PTR _lpLoadEntity$57861[ebp]
	add	ecx, 14					; 0000000eH
	push	ecx
...
; 3143 :                   lpLastCreatedEntity = lpLoadEntity;
	...
	mov	edx, DWORD PTR _lpLoadEntity$57861[ebp]
	mov	DWORD PTR _lpLastCreatedEntity$57853[ebp], edx
...
; 3153 :                   if ( bNewEntity )
	...
	mov	edx, DWORD PTR _bNewEntity$57854[ebp]
	and	edx, 255				; 000000ffH
	test	edx, edx
	je	SHORT $L57876
...
; 3157 :                      bEntityCreatedList[ lpLoadEntity->nHierNbr ] = TRUE;
	...
	mov	eax, DWORD PTR _lpLoadEntity$57861[ebp]
	movsx	ecx, WORD PTR [eax+217]
	mov	BYTE PTR _bEntityCreatedList$57849[ebp+ecx], 1
$L57876:
...
; 3165 :                     bEntityCreatedList[ lpLoadEntity->nHierNbr ] == FALSE )
	...
	movsx	edx, WORD PTR [ecx+217]
	xor	eax, eax
	mov	al, BYTE PTR _bEntityCreatedList$57849[ebp+edx]
	test	eax, eax
	jne	SHORT $L57878
...
; 3481 :                   lpLoadEntity->nHierNbr > lpCreatedEntity->nHierNbr) )
	...
	cmp	DWORD PTR _lpCreatedEntity$57855[ebp], 0
	je	SHORT $L57880
	mov	ecx, DWORD PTR _lpLoadEntity$57861[ebp]
	cmp	ecx, DWORD PTR _lpCreatedEntity$57855[ebp]
	je	SHORT $L57879
	mov	edx, DWORD PTR _lpLoadEntity$57861[ebp]
	movsx	eax, WORD PTR [edx+217]
	mov	ecx, DWORD PTR _lpCreatedEntity$57855[ebp]
	movsx	edx, WORD PTR [ecx+217]
	cmp	eax, edx
	jle	SHORT $L57879
$L57880:
...
; 3484 :                lpCreatedEntity = lpLoadEntity;
	...
	mov	edx, DWORD PTR _lpLoadEntity$57861[ebp]
	mov	DWORD PTR _lpCreatedEntity$57855[ebp], edx
$L57879:
...
; 3493 :                   zLONG lTemp = lpConnection->lIntegerCount++;
	...
	mov	DWORD PTR _lTemp$57887[ebp], edx
	mov	eax, DWORD PTR _lpConnection$[ebp]
...
; 3496 :                                       &lTemp, 0 );
	...
	push	0
	lea	eax, DWORD PTR _lTemp$57887[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpViewAttrib$[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpLoadEntity$57861[ebp]
...
; 3505 :                             lpConnection->lStringCount++ );
	...
	lea	ecx, DWORD PTR _szTemp$57889[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpConnection$[ebp]
...
; 3507 :                                       (zPVOID) szTemp, 0 );
	...
	push	0
	lea	edx, DWORD PTR _szTemp$57889[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewAttrib$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpLoadEntity$57861[ebp]
...
; 3517 :                            &dTemp );
	...
	lea	eax, DWORD PTR _dTemp$57893[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpConnection$[ebp]
...
; 3519 :                                       (zPVOID) &dTemp, 0 );
	...
	push	0
	lea	ecx, DWORD PTR _dTemp$57893[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpViewAttrib$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpLoadEntity$57861[ebp]
...
; 3527 :                   SysGetDateTime( szDateTime );
	...
	lea	edx, DWORD PTR _szDateTime$57897[ebp]
	push	edx
...
; 3529 :                                        szDateTime );
	...
	lea	eax, DWORD PTR _szDateTime$57897[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpViewAttrib$[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpLoadEntity$57861[ebp]
...
; 3616 :    if ( nReturnCode == 0 && bRootLimitReached )
	...
	test	edx, edx
	jne	SHORT $EndOfFunction$57780
	mov	eax, DWORD PTR _bRootLimitReached$[ebp]
	and	eax, 255				; 000000ffH
	test	eax, eax
	je	SHORT $EndOfFunction$57780
...
; 3894 :          LPVIEWENTITY lpParent = zGETPTR( lpViewEntity->hParent );
	...
	push	edx
	call	_SysGetPointerFromHandle@4
	mov	DWORD PTR _lpParent$57960[ebp], eax
...
; 3897 :          DisplayEntityInstance( lpView, lpParent->szName );
	...
	mov	eax, DWORD PTR _lpParent$57960[ebp]
	add	eax, 14					; 0000000eH
	push	eax
	mov	ecx, DWORD PTR _lpView$[ebp]
	push	ecx
...
; 4740 :       zSHORT           nTraceLevel = 0;
	...
	mov	WORD PTR _nTraceLevel$58123[ebp], 0
...
; 4765 :          zVIEW v = GetDefaultViewForActiveTask( );
	...
	mov	DWORD PTR _v$58127[ebp], eax

; 4766 :          zLONG lTask;
; 4767 : 
; 4768 :          if ( v && (LPTASK) (lTask = SysGetTaskFromView( v )) != hTask )

	cmp	DWORD PTR _v$58127[ebp], 0
	je	SHORT $L58130
	mov	edx, DWORD PTR _v$58127[ebp]
	push	edx
	call	_SysGetTaskFromView@4
	mov	DWORD PTR _lTask$58128[ebp], eax
	mov	eax, DWORD PTR _lTask$58128[ebp]
...
; 4771 :                        hTask, lTask );
	...
	mov	ecx, DWORD PTR _lTask$58128[ebp]
	push	ecx
...
; 4795 :          zmemset( (zPVOID) &ConnRec, 0, sizeof( ConnRec ) );
	...
	push	804					; 00000324H
	push	0
	lea	eax, DWORD PTR _ConnRec$58122[ebp]
	push	eax
	call	_memset
	add	esp, 12					; 0000000cH
...
; 4797 :          zstrcpy( ConnRec.szDebug1, "Conn BEGIN" );
	...
	lea	ecx, DWORD PTR _ConnRec$58122[ebp]
	push	ecx
	call	_strcpy
	add	esp, 8
...
; 4798 :          zstrcpy( ConnRec.szDebug2, "Conn END" );
	...
	lea	edx, DWORD PTR _ConnRec$58122[ebp+784]
	push	edx
	call	_strcpy
	add	esp, 8
...
; 4840 :          nTraceLevel = GetTaskDBHandlerTraceLevel( lpView );
	...
	mov	WORD PTR _nTraceLevel$58123[ebp], ax
$L58147:

; 4841 : 
; 4842 :       if ( nTraceLevel == 0 )

	movsx	eax, WORD PTR _nTraceLevel$58123[ebp]
	test	eax, eax
	jne	SHORT $L58152
...
; 4847 :          SysReadZeidonIni( -1, "[" DBHANDLER_NAME "]", "TraceLevel", szStr );
	...
	lea	ecx, DWORD PTR _szStr$58149[ebp]
	push	ecx
...
; 4848 :          if ( szStr[ 0 ] )
	...
	movsx	edx, BYTE PTR _szStr$58149[ebp]
	test	edx, edx
	je	SHORT $L58152

; 4849 :             nTraceLevel = (zSHORT) zatol( szStr );

	lea	eax, DWORD PTR _szStr$58149[ebp]
	push	eax
...
; 4852 :       lpConnection->nTraceLevel = nTraceLevel;
	...
	mov	ecx, DWORD PTR _lpConnection$[ebp]
	mov	dx, WORD PTR _nTraceLevel$58123[ebp]
...
; 5489 :             LPVIEWENTITY lpParent = zGETPTR( lpViewEntity->hParent );
	...
	push	ecx
	call	_SysGetPointerFromHandle@4
	mov	DWORD PTR _lpParent$58294[ebp], eax
...
; 5492 :             DisplayEntityInstance( lpView, lpParent->szName );
	...
	mov	edx, DWORD PTR _lpParent$58294[ebp]
	add	edx, 14					; 0000000eH
	push	edx
	mov	eax, DWORD PTR _lpView$[ebp]
	push	eax
