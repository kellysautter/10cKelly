...
; 150  :       {
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR $L9154[edx]
	jmp	DWORD PTR $L9155[ecx*4]
$L7877:
...
_hTempValueBuffer$ = -8
_nReturn$ = -4
_szAttribIdent$7899 = -524
_pchAttribValue$7900 = -528
_chType$7907 = -532
_lCharCount$7911 = -536
_pch$7913 = -540
...
; 208  :          zstrcpy( szAttribIdent, "KEY WAS BLOB - NOT SUPPORTED" );
	...
	lea	eax, DWORD PTR _szAttribIdent$7899[ebp]
	push	eax
	call	_strcpy
	add	esp, 8
...
; 217  :                              &pchAttribValue, &chType, &ulLth );
	...
	push	eax
	lea	ecx, DWORD PTR _chType$7907[ebp]
	push	ecx
	lea	edx, DWORD PTR _pchAttribValue$7900[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewAttrib$[ebp]
	push	eax
...
; 221  :          if ( ulLth <= 1 || pchAttribValue == 0 )
	...
	jbe	SHORT $L7909
	cmp	DWORD PTR _pchAttribValue$7900[ebp], 0
	jne	SHORT $L7908
$L7909:
...
; 225  :             szAttribIdent[ 0 ] = 0;
	...
	mov	BYTE PTR _szAttribIdent$7899[ebp], 0
...
; 235  :             if ( (lCharCount = fnContainsSpecialChar( pchAttribValue ) ) )
	...
	mov	edx, DWORD PTR _pchAttribValue$7900[ebp]
	push	edx
	call	_fnContainsSpecialChar@4
	mov	DWORD PTR _lCharCount$7911[ebp], eax
	cmp	DWORD PTR _lCharCount$7911[ebp], 0
	je	$L7912
...
; 244  :                if ( lTempBufferLth < ulLth + lCharCount * 6 )
	...
	mov	eax, DWORD PTR _lCharCount$7911[ebp]
	imul	eax, 6
	mov	ecx, DWORD PTR _ulLth$[ebp]
	add	ecx, eax
...
; 261  :                      pchAttribValue++ )
	...
	mov	DWORD PTR _pch$7913[ebp], edx
	jmp	SHORT $L7918
$L7919:
	mov	eax, DWORD PTR _pchAttribValue$7900[ebp]
	add	eax, 1
	mov	DWORD PTR _pchAttribValue$7900[ebp], eax
$L7918:
	mov	ecx, DWORD PTR _pchAttribValue$7900[ebp]
	movsx	edx, BYTE PTR [ecx]
	test	edx, edx
	je	$L7920
...
; 266  :                         *pch++ = '&';
	...
	mov	edx, DWORD PTR _pch$7913[ebp]
	mov	BYTE PTR [edx], 38			; 00000026H
	mov	eax, DWORD PTR _pch$7913[ebp]
	add	eax, 1
	mov	DWORD PTR _pch$7913[ebp], eax

; 267  :                         *pch++ = 'a';

	mov	ecx, DWORD PTR _pch$7913[ebp]
...
; 268  :                         *pch++ = 'm';
	...
	mov	ecx, DWORD PTR _pch$7913[ebp]
	add	ecx, 1
	mov	DWORD PTR _pch$7913[ebp], ecx
...
; 335  :                zstrcpy( szAttribIdent, pchTempValueBuffer );
	...
	push	ecx
	lea	edx, DWORD PTR _szAttribIdent$7899[ebp]
	push	edx
	call	_strcpy
	add	esp, 8
...
; 340  :                zstrcpy( szAttribIdent, pchAttribValue );
	...
	mov	eax, DWORD PTR _pchAttribValue$7900[ebp]
	push	eax
	lea	ecx, DWORD PTR _szAttribIdent$7899[ebp]
	push	ecx
	call	_strcpy
	add	esp, 8
...
_bSkipIfNull$ = -544
_nReturn$ = -4
_szIncreFlags$7988 = -556
_lCharCount$8014 = -560
_pch$8016 = -564
...
; 450  :                zCHAR szIncreFlags[ 10 ] = "..";
	...
	mov	WORD PTR _szIncreFlags$7988[ebp], dx
	mov	al, BYTE PTR ??_C@_02OOND@?4?4?$AA@+2
	mov	BYTE PTR _szIncreFlags$7988[ebp+2], al
	xor	ecx, ecx
	mov	DWORD PTR _szIncreFlags$7988[ebp+3], ecx
	mov	WORD PTR _szIncreFlags$7988[ebp+7], cx
	mov	BYTE PTR _szIncreFlags$7988[ebp+9], cl
...
; 453  :                   szIncreFlags[ ATTRIB_FLAGS_ACTIVATED_IDX ] = 'Y';
	...
	mov	BYTE PTR _szIncreFlags$7988[ebp], 89	; 00000059H
$L7990:
...
; 456  :                   szIncreFlags[ ATTRIB_FLAGS_UPDATED_IDX ] = 'Y';
	...
	mov	BYTE PTR _szIncreFlags$7988[ebp+1], 89	; 00000059H
$L7991:
...
; 459  :                if ( zstrcmp( szIncreFlags, ".." ) != 0 )
	...
	movsx	eax, BYTE PTR _szIncreFlags$7988[ebp]
	movsx	ecx, BYTE PTR ??_C@_02OOND@?4?4?$AA@
	cmp	eax, ecx
	jne	SHORT $L9160
	push	OFFSET FLAT:??_C@_02OOND@?4?4?$AA@	; `string'
	lea	edx, DWORD PTR _szIncreFlags$7988[ebp]
	push	edx
	call	_strcmp
	add	esp, 8
...
; 462  :                             " zIncreFlags=\"%s\"", szIncreFlags );
	...
	lea	eax, DWORD PTR _szIncreFlags$7988[ebp]
	push	eax
...
; 528  :             if ( (lCharCount = fnContainsSpecialChar( pchAttribValue )) )
	...
	push	edx
	call	_fnContainsSpecialChar@4
	mov	DWORD PTR _lCharCount$8014[ebp], eax
	cmp	DWORD PTR _lCharCount$8014[ebp], 0
	je	$L8015
...
; 537  :                if ( lTempBufferLth < ulLth + lCharCount * 6 )
	...
	mov	eax, DWORD PTR _lCharCount$8014[ebp]
	imul	eax, 6
	mov	ecx, DWORD PTR _ulLth$[ebp]
	add	ecx, eax
	cmp	DWORD PTR _lTempBufferLth$[ebp], ecx
...
; 554  :                      pchAttribValue++ )
	...
	mov	edx, DWORD PTR _pchTempValueBuffer$[ebp]
	mov	DWORD PTR _pch$8016[ebp], edx
	jmp	SHORT $L8021
$L8022:
	mov	eax, DWORD PTR _pchAttribValue$[ebp]
	add	eax, 1
...
; 557  :                   {
	...
	xor	eax, eax
	mov	al, BYTE PTR $L9162[ecx]
	jmp	DWORD PTR $L9163[eax*4]
$L8028:

; 558  :                      case '&':
; 559  :                         *pch++ = '&';

	mov	edx, DWORD PTR _pch$8016[ebp]
	mov	BYTE PTR [edx], 38			; 00000026H
	mov	eax, DWORD PTR _pch$8016[ebp]
	add	eax, 1
	mov	DWORD PTR _pch$8016[ebp], eax

; 560  :                         *pch++ = 'a';

	mov	ecx, DWORD PTR _pch$8016[ebp]
	mov	BYTE PTR [ecx], 97			; 00000061H
	mov	edx, DWORD PTR _pch$8016[ebp]
	add	edx, 1
	mov	DWORD PTR _pch$8016[ebp], edx
...
; 561  :                         *pch++ = 'm';
	...
	mov	ecx, DWORD PTR _pch$8016[ebp]
	add	ecx, 1
	mov	DWORD PTR _pch$8016[ebp], ecx
...
_lpParent$8101 = -32
_szIncreFlags$8116 = -44
_hEntityInstance$8137 = -52
_lpViewEntityCsr$8139 = -56
_lpSrchSelectedInstance$8140 = -48
...
; 804  :                   lpParent = zGETPTR( lpParent->hParent ) )
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$8101[ebp], eax
	jmp	SHORT $L8104
$L8105:
	mov	eax, DWORD PTR _lpParent$8101[ebp]
	mov	ecx, DWORD PTR [eax+10]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$8101[ebp], eax
$L8104:
	mov	edx, DWORD PTR _lpParent$8101[ebp]
	mov	eax, DWORD PTR [edx+235]
...
; 810  :             pchEntityName = lpParent->szName;
	...
	mov	ecx, DWORD PTR _lpParent$8101[ebp]
	add	ecx, 14					; 0000000eH
...
; 850  :       zCHAR szIncreFlags[ 10 ] = "........";
	...
	mov	DWORD PTR _szIncreFlags$8116[ebp], edx
	mov	eax, DWORD PTR ??_C@_08JLEF@?4?4?4?4?4?4?4?4?$AA@+4
	mov	DWORD PTR _szIncreFlags$8116[ebp+4], eax
	mov	cl, BYTE PTR ??_C@_08JLEF@?4?4?4?4?4?4?4?4?$AA@+8
	mov	BYTE PTR _szIncreFlags$8116[ebp+8], cl
	xor	edx, edx
	mov	BYTE PTR _szIncreFlags$8116[ebp+9], dl
...
; 853  :          szIncreFlags[ ENTITY_FLAGS_HANGING_IDX ] = 'Y';
	...
	mov	BYTE PTR _szIncreFlags$8116[ebp], 89	; 00000059H
$L8118:
...
; 855  :          szIncreFlags[ ENTITY_FLAGS_CREATED_IDX ] = 'Y';
	...
	mov	BYTE PTR _szIncreFlags$8116[ebp+1], 89	; 00000059H
$L8119:
...
; 857  :          szIncreFlags[ ENTITY_FLAGS_UPDATED_IDX ] = 'Y';
	...
	mov	BYTE PTR _szIncreFlags$8116[ebp+2], 89	; 00000059H
$L8120:
...
; 859  :          szIncreFlags[ ENTITY_FLAGS_DELETED_IDX ] = 'Y';
	...
	mov	BYTE PTR _szIncreFlags$8116[ebp+3], 89	; 00000059H
$L8121:
...
; 861  :          szIncreFlags[ ENTITY_FLAGS_EXCLUDED_IDX ] = 'Y';
	...
	mov	BYTE PTR _szIncreFlags$8116[ebp+4], 89	; 00000059H
$L8122:
...
; 863  :          szIncreFlags[ ENTITY_FLAGS_INCLUDED_IDX ] = 'Y';
	...
	mov	BYTE PTR _szIncreFlags$8116[ebp+5], 89	; 00000059H
$L8123:
...
; 865  :          szIncreFlags[ ENTITY_FLAGS_HIDDEN_IDX ] = 'Y';
	...
	mov	BYTE PTR _szIncreFlags$8116[ebp+6], 89	; 00000059H
$L8124:
...
; 867  :          szIncreFlags[ ENTITY_FLAGS_TEMPORAL_IDX ] = 'Y';
	...
	mov	BYTE PTR _szIncreFlags$8116[ebp+7], 89	; 00000059H
$L8125:
...
; 872  :                    " zIncreFlags=\"%s\"", szIncreFlags );
	...
	lea	ecx, DWORD PTR _szIncreFlags$8116[ebp]
	push	ecx
	push	OFFSET FLAT:??_C@_0BC@KMBD@?5zIncreFlags?$DN?$CC?$CFs?$CC?$AA@ ; `string'
	mov	edx, DWORD PTR _lpWriteInfo$[ebp]
	add	edx, 20					; 00000014H
...
; 887  :       LPENTITYINSTANCE   hEntityInstance = zGETHNDL( lpEntityInstance );
	...
	mov	DWORD PTR _hEntityInstance$8137[ebp], eax
...
; 906  :       if ( zGETPTR( lpViewEntityCsr->hEntityInstance ) == lpEntityInstance )
	...
	mov	edx, DWORD PTR _lpViewEntityCsr$8139[ebp]
...
; 917  :                       zGETPTR( lpSrchSelectedInstance->hNextSelectedInstance ) )
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrchSelectedInstance$8140[ebp], eax
	jmp	SHORT $L8150
$L8151:
	mov	ecx, DWORD PTR _lpSrchSelectedInstance$8140[ebp]
	mov	edx, DWORD PTR [ecx+2]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrchSelectedInstance$8140[ebp], eax
$L8150:
	cmp	DWORD PTR _lpSrchSelectedInstance$8140[ebp], 0
	je	SHORT $L8152

; 919  :          // Check to see if the current EI is selected.
; 920  :          if ( hEntityInstance != lpSrchSelectedInstance->xEntityInstance )

	mov	eax, DWORD PTR _lpSrchSelectedInstance$8140[ebp]
	mov	ecx, DWORD PTR _hEntityInstance$8137[ebp]
...
; 923  :          if ( hViewEntity != lpSrchSelectedInstance->hViewEntity )
	...
	mov	edx, DWORD PTR _lpSrchSelectedInstance$8140[ebp]
...
; 993  :       if ( (lCharCount = fnContainsSpecialChar( pchAttribValue ) ) )
	...
	push	ecx
	call	_fnContainsSpecialChar@4
	mov	DWORD PTR _lCharCount$8184[ebp], eax
	cmp	DWORD PTR _lCharCount$8184[ebp], 0
	je	$L8185
...
; 1002 :          if ( lTempBufferLth < ulLth + lCharCount * 6 )
	...
	mov	edx, DWORD PTR _lCharCount$8184[ebp]
	imul	edx, 6
	mov	eax, DWORD PTR _ulLth$[ebp]
	add	eax, edx
...
; 1006 :                                                0, 0, 0 );
	...
	push	0
	push	0
	mov	ecx, DWORD PTR _lCharCount$8184[ebp]
	imul	ecx, 6
...
; 1016 :                pchAttribValue++ )
	...
	mov	eax, DWORD PTR _pchTempValueBuffer$[ebp]
	mov	DWORD PTR _pch$8186[ebp], eax
	jmp	SHORT $L8190
$L8191:
	mov	ecx, DWORD PTR _pchAttribValue$[ebp]
	add	ecx, 1
...
; 1019 :             {
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR $L9169[edx]
	jmp	DWORD PTR $L9170[ecx*4]
$L8197:

; 1020 :                case '&':
; 1021 :                   *pch++ = '&';

	mov	eax, DWORD PTR _pch$8186[ebp]
	mov	BYTE PTR [eax], 38			; 00000026H
	mov	ecx, DWORD PTR _pch$8186[ebp]
	add	ecx, 1
	mov	DWORD PTR _pch$8186[ebp], ecx

; 1022 :                   *pch++ = 'a';

	mov	edx, DWORD PTR _pch$8186[ebp]
...
; 1023 :                   *pch++ = 'm';
	...
	mov	edx, DWORD PTR _pch$8186[ebp]
	add	edx, 1
	mov	DWORD PTR _pch$8186[ebp], edx
...
_pchEntityName$ = -12
_lSkipAttribFlag$ = -8
_lpAbstractChild$8377 = -20
_lpAbstractEntity$8398 = -24
...
; 1443 :       LPENTITYINSTANCE lpAbstractChild = 0;
	...
	mov	DWORD PTR _lpAbstractChild$8377[ebp], 0
...
; 1467 :                                                      lpEntityInstance );
	...
	push	ecx
	call	_fnWriteEntityStartTag@12
	mov	DWORD PTR _lpAbstractChild$8377[ebp], eax
...
; 1484 :                          (zSHORT) (lpEntityInstance->nLevel + 1), lpAbstractEntity, 0 );
	...
	push	0
	mov	eax, DWORD PTR _lpAbstractEntity$8398[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpEntityInstance$[ebp]
	movsx	edx, WORD PTR [ecx+58]
	add	edx, 1
...
_pch$ = -1008
_nRC$ = -1016
_lpViewEntityCsr$8448 = -11476
_lpSearch$8469 = -11480
...
; 1608 :       if ( fnValidViewEntity( &lpViewEntityCsr, vOI, pchEntityName, 0 ) == 0 )
	...
	mov	ecx, DWORD PTR _vOI$[ebp]
	push	ecx
	lea	edx, DWORD PTR _lpViewEntityCsr$8448[ebp]
	push	edx
...
; 1614 :       if ( lpViewEntityCsr->hEntityInstance == UNSET_CSR )
	...
	mov	ecx, DWORD PTR _lpViewEntityCsr$8448[ebp]
	cmp	DWORD PTR [ecx+26], 1
	jne	SHORT $L8451

; 1615 :          fnEstablishCursorForView( lpViewEntityCsr );

	mov	edx, DWORD PTR _lpViewEntityCsr$8448[ebp]
	push	edx
...
; 1617 :       lpStartEntityInstance = zGETPTR( lpViewEntityCsr->hEntityInstance );
	...
	mov	eax, DWORD PTR _lpViewEntityCsr$8448[ebp]
...
; 1665 :             lpSearch = zGETPTR( lpSearch->hNextTwin ) )
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSearch$8469[ebp], eax
	jmp	SHORT $L8472
$L8473:
	mov	eax, DWORD PTR _lpSearch$8469[ebp]
	mov	ecx, DWORD PTR [eax+22]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSearch$8469[ebp], eax
$L8472:
	cmp	DWORD PTR _lpSearch$8469[ebp], 0
	je	SHORT $L8474

; 1667 :          // If it's hidden, skip it.
; 1668 :          if ( lpSearch->u.nInd.bHidden )

	mov	edx, DWORD PTR _lpSearch$8469[ebp]
	mov	eax, DWORD PTR [edx+6]
...
; 1918 :       zsprintf( szMsg, "(xml) Attrib %s = %s", ppAtts[ k ], ppAtts[ k + 1 ] );
	...
	lea	ecx, DWORD PTR _szMsg$8604[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 16					; 00000010H
...
; 1919 :       TraceLineS( szMsg, "" );
	...
	lea	edx, DWORD PTR _szMsg$8604[ebp]
	push	edx
	call	_TraceLineS@8
...
_szMsg$8649 = -280
_lpViewCsr$8654 = -284
_lpWkViewEntity$8661 = -288
_lpViewCsr$8677 = -292
_lER_Tok$8684 = -300
_lpWkViewEntity$8685 = -296
...
; 1994 :                 lpInfo->lpViewEntity->szName, lpParent->szName, pchEntityName );
	...
	lea	ecx, DWORD PTR _szMsg$8649[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
...
; 1995 :       TraceLineS( szMsg, "" );
	...
	push	OFFSET FLAT:??_C@_00A@?$AA@		; `string'
	lea	edx, DWORD PTR _szMsg$8649[ebp]
	push	edx
	call	_TraceLineS@8
...
; 1996 :       SysMessageBox( 0, "XML Parser", szMsg, -1 );
	...
	push	-1
	lea	eax, DWORD PTR _szMsg$8649[ebp]
	push	eax
...
; 2014 :       LPVIEWCSR lpViewCsr = zGETPTR( lpInfo->vOI->hViewCsr );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$8654[ebp], eax
$L8657:
...
; 2017 :               lpViewCsr->hFirstViewSubobject )
	...
	cmp	ecx, edx
	jle	SHORT $L8658
	mov	eax, DWORD PTR _lpViewCsr$8654[ebp]
...
; 2031 :                   zGETPTR( lpInfo->lpPrevEntityInstance->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWkViewEntity$8661[ebp], eax

; 2032 : 
; 2033 :       fnSetViewToSubobject( lpInfo->vOI, lpWkViewEntity, 0 );

	push	0
	mov	ecx, DWORD PTR _lpWkViewEntity$8661[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpInfo$[ebp]
	mov	eax, DWORD PTR [edx+6]
	push	eax
...
; 2078 :          LPVIEWCSR lpViewCsr = zGETPTR( lpInfo->vOI->hViewCsr );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$8677[ebp], eax
$L8680:
...
; 2081 :                  lpViewCsr->hFirstViewSubobject )
	...
	cmp	edx, eax
	jle	SHORT $L8681
	mov	ecx, DWORD PTR _lpViewCsr$8677[ebp]
...
; 2096 :          LPVIEWENTITY lpWkViewEntity = zGETPTR( lpEntityInstance->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWkViewEntity$8685[ebp], eax

; 2097 : 
; 2098 :          fnSetViewToSubobject( lpInfo->vOI, lpWkViewEntity, 0 );

	push	0
	mov	eax, DWORD PTR _lpWkViewEntity$8685[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpInfo$[ebp]
	mov	edx, DWORD PTR [ecx+6]
	push	edx
...
; 2104 :          lER_Tok = lpWkViewEntity->lEREntTok;
	...
	mov	DWORD PTR _lER_Tok$8684[ebp], ecx
...
; 2107 :                lpWkViewEntity = zGETPTR( lpWkViewEntity->hParent ) )
	...
	mov	edx, DWORD PTR _lpWkViewEntity$8685[ebp]
	mov	eax, DWORD PTR [edx+10]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWkViewEntity$8685[ebp], eax
	jmp	SHORT $L8689
$L8690:
	mov	ecx, DWORD PTR _lpWkViewEntity$8685[ebp]
	mov	edx, DWORD PTR [ecx+10]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWkViewEntity$8685[ebp], eax
$L8689:
	mov	eax, DWORD PTR _lpWkViewEntity$8685[ebp]
	mov	ecx, DWORD PTR [eax+195]
	cmp	ecx, DWORD PTR _lER_Tok$8684[ebp]
	je	SHORT $L8691
...
; 2170 :                 lpViewEntity->szName, pchAttribName );
	...
	lea	ecx, DWORD PTR _szMsg$8739[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 16					; 00000010H
...
; 2171 :       TraceLineS( szMsg, "" );
	...
	push	OFFSET FLAT:??_C@_00A@?$AA@		; `string'
	lea	edx, DWORD PTR _szMsg$8739[ebp]
	push	edx
	call	_TraceLineS@8
...
; 2172 :       SysMessageBox( 0, "XML Parser", szMsg, -1 );
	...
	push	-1
	lea	eax, DWORD PTR _szMsg$8739[ebp]
	push	eax
	push	OFFSET FLAT:??_C@_0L@NHGM@XML?5Parser?$AA@ ; `string'
	push	0
	call	_SysMessageBox@16
...
_pchEntityName$ = -12
_lpInfo$ = -8
_lpViewEntity$8776 = -16
_lpParentViewEntity$8790 = -20
_k$8813 = -24
_lpViewAttrib$8818 = -28
_lpAttribFlags$8819 = -32
...
; 2259 :             lpViewEntity = zGETPTR( lpViewEntity->hNextHier ) )
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$8776[ebp], eax
	jmp	SHORT $L8779
$L8780:
	mov	edx, DWORD PTR _lpViewEntity$8776[ebp]
	mov	eax, DWORD PTR [edx+2]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$8776[ebp], eax
$L8779:
	cmp	DWORD PTR _lpViewEntity$8776[ebp], 0
	je	SHORT $L8781
...
; 2261 :          if ( zstrcmp( cpcElementName, lpViewEntity->szName ) == 0 )
	...
	mov	ecx, DWORD PTR _cpcElementName$[ebp]
	movsx	edx, BYTE PTR [ecx]
	mov	eax, DWORD PTR _lpViewEntity$8776[ebp]
...
; 2272 :                lpViewEntity = zGETPTR( lpViewEntity->hNextHier ) )
	...
	jmp	SHORT $L8793
$L8794:
	mov	ecx, DWORD PTR _lpViewEntity$8776[ebp]
	mov	edx, DWORD PTR [ecx+2]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$8776[ebp], eax
...
; 2278 :                   lpParentViewEntity = zGETPTR( lpViewEntity->hParent );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParentViewEntity$8790[ebp], eax

; 2279 :                   if ( zstrcmp( lpParentViewEntity->szName, lpInfo->lpViewEntity->szName ) == 0 )

	mov	ecx, DWORD PTR _lpParentViewEntity$8790[ebp]
	...
	add	edx, 14					; 0000000eH
	push	edx
	mov	eax, DWORD PTR _lpParentViewEntity$8790[ebp]
	add	eax, 14					; 0000000eH
	push	eax
	call	_strcmp
	add	esp, 8
...
; 2298 :          for ( k = 0; ppAtts[ k ] != 0; k += 2 )
	...
	mov	WORD PTR _k$8813[ebp], 0
	jmp	SHORT $L8815
$L8816:
	mov	dx, WORD PTR _k$8813[ebp]
	add	dx, 2
	mov	WORD PTR _k$8813[ebp], dx
$L8815:
	movsx	eax, WORD PTR _k$8813[ebp]
...
; 2306 :                   lpViewAttrib = zGETPTR( lpViewAttrib->hNextOD_Attrib ) )
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewAttrib$8818[ebp], eax
	jmp	SHORT $L8822
$L8823:
	mov	ecx, DWORD PTR _lpViewAttrib$8818[ebp]
	mov	edx, DWORD PTR [ecx+2]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewAttrib$8818[ebp], eax
$L8822:
	cmp	DWORD PTR _lpViewAttrib$8818[ebp], 0
	je	SHORT $L8824

; 2308 :                if ( zstrcmp( lpViewAttrib->szXML_SimpleName, ppAtts[ k ] ) == 0 )

	mov	eax, DWORD PTR _lpViewAttrib$8818[ebp]
	movsx	ecx, BYTE PTR [eax+43]
	movsx	edx, WORD PTR _k$8813[ebp]
	mov	eax, DWORD PTR _ppAtts$[ebp]
	mov	edx, DWORD PTR [eax+edx*4]
	movsx	eax, BYTE PTR [edx]
	cmp	ecx, eax
	jne	SHORT $L9212
	movsx	ecx, WORD PTR _k$8813[ebp]
	mov	edx, DWORD PTR _ppAtts$[ebp]
	mov	eax, DWORD PTR [edx+ecx*4]
	push	eax
	mov	ecx, DWORD PTR _lpViewAttrib$8818[ebp]
	...
	jmp	SHORT $L9213
$L9212:
	mov	edx, DWORD PTR _lpViewAttrib$8818[ebp]
	movsx	eax, BYTE PTR [edx+43]
	movsx	ecx, WORD PTR _k$8813[ebp]
	mov	edx, DWORD PTR _ppAtts$[ebp]
...
; 2335 :                GetAttributeFlags( &lpAttribFlags, lpInfo->vOI, lpViewEntity, lpViewAttrib );
	...
	mov	ecx, DWORD PTR [eax+6]
	push	ecx
	lea	edx, DWORD PTR _lpAttribFlags$8819[ebp]
	push	edx
	call	_GetAttributeFlags@16

; 2336 :                lpAttribFlags->u.uFlags = lpInfo->AttribFlags.u.uFlags;

	mov	eax, DWORD PTR _lpAttribFlags$8819[ebp]
	mov	ecx, DWORD PTR _lpInfo$[ebp]
	mov	edx, DWORD PTR [ecx+846]
...
_pvUserData$ = 8
_lpInfo$ = -4
_lpViewAttrib$8851 = -12
_lpViewEntity$8852 = -8
_lpAttribFlags$8854 = -16
...
; 2376 :       LPVIEWATTRIB  lpViewAttrib = lpInfo->lpViewAttrib;
	...
	mov	DWORD PTR _lpViewAttrib$8851[ebp], edx

; 2377 :       LPVIEWENTITY  lpViewEntity = zGETPTR( lpViewAttrib->hViewEntity );

	mov	eax, DWORD PTR _lpViewAttrib$8851[ebp]
	mov	ecx, DWORD PTR [eax+6]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$8852[ebp], eax
...
; 2384 :                              lpInfo->nBufferCurrentUsed );
	...
	mov	edx, DWORD PTR _lpViewAttrib$8851[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewEntity$8852[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpInfo$[ebp]
	mov	edx, DWORD PTR [ecx+6]
	push	edx
...
; 2392 :                               lpInfo->pchAttributeBuffer );
	...
	mov	eax, DWORD PTR _lpViewAttrib$8851[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpViewEntity$8852[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpInfo$[ebp]
	mov	eax, DWORD PTR [edx+6]
	push	eax
...
; 2396 :       GetAttributeFlags( &lpAttribFlags, lpInfo->vOI, lpViewEntity, lpViewAttrib );
	...
	mov	ecx, DWORD PTR _lpViewAttrib$8851[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpViewEntity$8852[ebp]
	push	edx
	mov	eax, DWORD PTR _lpInfo$[ebp]
	mov	ecx, DWORD PTR [eax+6]
	push	ecx
	lea	edx, DWORD PTR _lpAttribFlags$8854[ebp]
	push	edx
	call	_GetAttributeFlags@16

; 2397 :       lpAttribFlags->u.uFlags = lpInfo->AttribFlags.u.uFlags;

	mov	eax, DWORD PTR _lpAttribFlags$8854[ebp]
	mov	ecx, DWORD PTR _lpInfo$[ebp]
	mov	edx, DWORD PTR [ecx+846]
	mov	DWORD PTR [eax], edx
...
; 2461 :       int    nNewSize = nLth + lpInfo->nBufferCurrentUsed + 5000;
	...
	mov	DWORD PTR _nNewSize$8881[ebp], ecx
...
; 2465 :       pchNewBuffer = malloc( nNewSize );
	...
	mov	edx, DWORD PTR _nNewSize$8881[ebp]
	push	edx
	call	DWORD PTR __imp__malloc
	add	esp, 4
	mov	DWORD PTR _pchNewBuffer$8882[ebp], eax
...
; 2471 :                   lpInfo->nBufferCurrentUsed );
	...
	mov	ecx, DWORD PTR [eax+834]
	push	ecx
	mov	edx, DWORD PTR _pchNewBuffer$8882[ebp]
	push	edx
	call	_memcpy
	add	esp, 12					; 0000000cH
...
; 2476 :       lpInfo->pchAttributeBuffer  = pchNewBuffer;
	...
	mov	edx, DWORD PTR _lpInfo$[ebp]
	mov	eax, DWORD PTR _pchNewBuffer$8882[ebp]
...
; 2630 :          lpViewCsr = zGETPTR( vSubtask->hViewCsr );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$8940[ebp], eax
$L8943:

; 2631 :          while ( lpViewCsr->hNextViewCsr )

	mov	edx, DWORD PTR _lpViewCsr$8940[ebp]
	cmp	DWORD PTR [edx+2], 0
	je	SHORT $L8944

; 2632 :             lpViewCsr = zGETPTR( lpViewCsr->hNextViewCsr );

	mov	eax, DWORD PTR _lpViewCsr$8940[ebp]
	mov	ecx, DWORD PTR [eax+2]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$8940[ebp], eax
...
; 2675 :                    XML_GetCurrentLineNumber( parser ) );
	...
	lea	ecx, DWORD PTR _szMsg$8959[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 16					; 00000010H
...
; 2676 :          TraceLineS( "(xml) Error txt: ", szMsg );
	...
	lea	edx, DWORD PTR _szMsg$8959[ebp]
	push	edx
...
; 2813 :          SysWriteLineLth( lpTaskView, hFile, szBuffer, zstrlen( szBuffer ), FALSE );
	...
	push	0
	lea	ecx, DWORD PTR _szBuffer$9026[ebp]
	push	ecx
	call	_strlen
	add	esp, 4
	push	eax
	lea	edx, DWORD PTR _szBuffer$9026[ebp]
	push	edx
...
; 2853 :       fnGetApplicationForSubtask( &lpApp, vOI );
	...
	mov	ecx, DWORD PTR _vOI$[ebp]
	push	ecx
	lea	edx, DWORD PTR _lpApp$9048[ebp]
	push	edx
	call	_fnGetApplicationForSubtask@8

; 2854 :       if ( lpApp )

	cmp	DWORD PTR _lpApp$9048[ebp], 0
	je	SHORT $L9049

; 2855 :          zstrcpy( szOpenFileName, lpApp->szObjectDir );

	mov	eax, DWORD PTR _lpApp$9048[ebp]
...
; 2858 :          lpApp = zGETPTR( AnchorBlock->hSystemApp );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpApp$9048[ebp], eax

; 2859 :          zstrcpy( szOpenFileName, lpApp->szObjectDir );

	mov	ecx, DWORD PTR _lpApp$9048[ebp]
...
; 2908 :       fnGetApplicationForSubtask( &lpApp, vOI );
	...
	mov	eax, DWORD PTR _vOI$[ebp]
	push	eax
	lea	ecx, DWORD PTR _lpApp$9073[ebp]
	push	ecx
	call	_fnGetApplicationForSubtask@8

; 2909 :       if ( lpApp )

	cmp	DWORD PTR _lpApp$9073[ebp], 0
	je	SHORT $L9074

; 2910 :          zstrcpy( szOpenFileName, lpApp->szObjectDir );

	mov	edx, DWORD PTR _lpApp$9073[ebp]
...
; 2913 :          lpApp = zGETPTR( AnchorBlock->hSystemApp );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpApp$9073[ebp], eax

; 2914 :          zstrcpy( szOpenFileName, lpApp->szObjectDir );

	mov	eax, DWORD PTR _lpApp$9073[ebp]
	add	eax, 347				; 0000015bH
	push	eax
	lea	ecx, DWORD PTR _szOpenFileName$[ebp]
	push	ecx
