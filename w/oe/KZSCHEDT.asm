...
; 108  :       SysGetDateTime( szDateTime );
	...
	lea	edx, DWORD PTR _szDateTime$57341[ebp]
	push	edx
...
; 109  :       TraceLineI( szDateTime, nThreadNumber );
	...
	movsx	eax, WORD PTR _nThreadNumber$[ebp]
	push	eax
	lea	ecx, DWORD PTR _szDateTime$57341[ebp]
	push	ecx
	call	_TraceLineI@8
...
; 439  :                for ( k = 1; k <= NUM_THREADS; k++ )
	...
	mov	DWORD PTR _k$57474[ebp], 1
	jmp	SHORT $L57475
$L57476:
	mov	edx, DWORD PTR _k$57474[ebp]
	add	edx, 1
	mov	DWORD PTR _k$57474[ebp], edx
$L57475:
	cmp	DWORD PTR _k$57474[ebp], 1
	jg	SHORT $L57477
...
; 442  :                                                   (void *) k, 0, &g_dwTestThreadID );
	...
	push	0
	mov	eax, DWORD PTR _k$57474[ebp]
	push	eax
...
; 464  :             GetCursorPos( &point );
	...
	lea	eax, DWORD PTR _point$57486[ebp]
	push	eax
	call	DWORD PTR __imp__GetCursorPos@4

; 465  :             HandlePopupMenu( hWnd, point );

	mov	ecx, DWORD PTR _point$57486[ebp+4]
	push	ecx
	mov	edx, DWORD PTR _point$57486[ebp]
	push	edx
	mov	eax, DWORD PTR _hWnd$[ebp]
	push	eax
