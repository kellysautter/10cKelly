...
; 120  :    {
	...
	xor	eax, eax
	mov	al, BYTE PTR $L8884[ecx]
	jmp	DWORD PTR $L8885[eax*4]
$L7554:
...
_nRC$ = -8
_lpViewCsr$7783 = -28
_lpRootViewEntityCsr$7785 = -36
_lpViewEntity$7787 = -32
...
; 704  :       LPVIEWCSR       lpViewCsr = zGETPTR( lpView->hViewCsr );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$7783[ebp], eax

; 705  :       LPVIEWENTITYCSR lpRootViewEntityCsr =
; 706  :                                   zGETPTR( lpViewCsr->hRootViewEntityCsr );

	mov	eax, DWORD PTR _lpViewCsr$7783[ebp]
	mov	ecx, DWORD PTR [eax+18]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpRootViewEntityCsr$7785[ebp], eax

; 707  :       LPVIEWENTITY    lpViewEntity =
; 708  :                                   zGETPTR( lpRootViewEntityCsr->hViewEntity );

	mov	edx, DWORD PTR _lpRootViewEntityCsr$7785[ebp]
	mov	eax, DWORD PTR [edx+14]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$7787[ebp], eax

; 709  : 
; 710  :       pchWorkEntityName = lpViewEntity->szName;

	mov	ecx, DWORD PTR _lpViewEntity$7787[ebp]
...
_nLevel$ = -4
_lpViewCsr$7814 = -36
_lpRootViewEntityCsr$7816 = -44
_lpViewEntity$7818 = -40
...
; 778  :       LPVIEWCSR       lpViewCsr = zGETPTR( lpView->hViewCsr );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$7814[ebp], eax

; 779  :       LPVIEWENTITYCSR lpRootViewEntityCsr =
; 780  :                                   zGETPTR( lpViewCsr->hRootViewEntityCsr );

	mov	eax, DWORD PTR _lpViewCsr$7814[ebp]
	mov	ecx, DWORD PTR [eax+18]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpRootViewEntityCsr$7816[ebp], eax

; 781  :       LPVIEWENTITY    lpViewEntity =
; 782  :                                   zGETPTR( lpRootViewEntityCsr->hViewEntity );

	mov	edx, DWORD PTR _lpRootViewEntityCsr$7816[ebp]
	mov	eax, DWORD PTR [edx+14]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$7818[ebp], eax

; 783  : 
; 784  :       pchWorkEntityName = lpViewEntity->szName;

	mov	ecx, DWORD PTR _lpViewEntity$7818[ebp]
	add	ecx, 14					; 0000000eH
	mov	DWORD PTR _pchWorkEntityName$[ebp], ecx
$L7812:
...
; 938  :       lpViewCsr = zGETPTR( lpNewView->hViewCsr );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$7871[ebp], eax

; 939  :       lpViewEntityCsr = zGETPTR( lpViewCsr->hRootViewEntityCsr );

	mov	edx, DWORD PTR _lpViewCsr$7871[ebp]
...
; 941  :       lpViewOI = zGETPTR( lpViewCsr->hViewOI );
	...
	mov	ecx, DWORD PTR _lpViewCsr$7871[ebp]
	mov	edx, DWORD PTR [ecx+10]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOI$7872[ebp], eax

; 942  :       lpStartInstance = zGETPTR( lpViewOI->hRootEntityInstance );

	mov	eax, DWORD PTR _lpViewOI$7872[ebp]
...
; 1037 :       zCHAR            szFlags[ 50 ] = "Incremental Update Flags: ";
	...
	lea	edi, DWORD PTR _szFlags$7928[ebp]
	rep movsd
	movsw
	movsb
	xor	edx, edx
	mov	DWORD PTR _szFlags$7928[ebp+27], edx
	mov	DWORD PTR _szFlags$7928[ebp+31], edx
	mov	DWORD PTR _szFlags$7928[ebp+35], edx
	mov	DWORD PTR _szFlags$7928[ebp+39], edx
	mov	DWORD PTR _szFlags$7928[ebp+43], edx
	mov	WORD PTR _szFlags$7928[ebp+47], dx
	mov	BYTE PTR _szFlags$7928[ebp+49], dl
...
; 1038 :       LPENTITYINSTANCE lpEntityInstance = zGETPTR( lpViewEntityCsr->hEntityInstance );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpEntityInstance$7930[ebp], eax
...
; 1044 :            lpEntityInstance->u.nInd.bPrevVsnRoot )
	...
	mov	edx, DWORD PTR _lpEntityInstance$7930[ebp]
	mov	eax, DWORD PTR [edx+6]
	shr	eax, 10					; 0000000aH
	and	eax, 1
	test	eax, eax
	jne	SHORT $L7933
	mov	ecx, DWORD PTR _lpEntityInstance$7930[ebp]
	mov	edx, DWORD PTR [ecx+6]
	shr	edx, 11					; 0000000bH
	and	edx, 1
	test	edx, edx
	jne	SHORT $L7933
	mov	eax, DWORD PTR _lpEntityInstance$7930[ebp]
...
; 1062 :          zstrcat( szFlags, "C" );
	...
	lea	ecx, DWORD PTR _szFlags$7928[ebp]
	push	ecx
	call	_strcat
	add	esp, 8
$L7947:
...
; 1076 :       TraceLineS( szSpaces, szFlags );
	...
	lea	edx, DWORD PTR _szFlags$7928[ebp]
	push	edx
...
; 1089 :                                             lpEntityInstance->hViewEntity ) )
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	cmp	eax, DWORD PTR _lpEntityInstance$7930[ebp]
	jne	SHORT $L7966
...
; 1100 :          nWk1 = 0;
	...
	mov	WORD PTR _nWk1$7971[ebp], 0

; 1101 :          nWk2 = 0x0001;

	mov	WORD PTR _nWk2$7972[ebp], 1
...
; 1103 :          for ( nWk3 = 1; nWk3 < 17; nWk3++ )
	...
	mov	WORD PTR _nWk3$7973[ebp], 1
	jmp	SHORT $L7975
$L7976:
	mov	cx, WORD PTR _nWk3$7973[ebp]
	add	cx, 1
	mov	WORD PTR _nWk3$7973[ebp], cx
$L7975:
	movsx	edx, WORD PTR _nWk3$7973[ebp]
...
; 1105 :             if ( lpSelectedInstance->nSelectSet & nWk2 )
	...
	movsx	edx, WORD PTR _nWk2$7972[ebp]
	and	ecx, edx
	test	ecx, ecx
	je	SHORT $L7978
...
; 1107 :                if ( nWk1 )
	...
	movsx	eax, WORD PTR _nWk1$7971[ebp]
	test	eax, eax
	je	SHORT $L7979
...
; 1110 :                zltoa( (zLONG) nWk3, &szWorkString[ 250 ] );
	...
	push	edx
	movsx	eax, WORD PTR _nWk3$7973[ebp]
	push	eax
	call	DWORD PTR __imp___ltoa
	add	esp, 12					; 0000000cH
...
; 1112 :                nWk1++;
	...
	mov	ax, WORD PTR _nWk1$7971[ebp]
	add	ax, 1
	mov	WORD PTR _nWk1$7971[ebp], ax
$L7978:

; 1114 : 
; 1115 :             nWk2 <<= 1;

	mov	cx, WORD PTR _nWk2$7972[ebp]
	shl	cx, 1
	mov	WORD PTR _nWk2$7972[ebp], cx
...
; 1136 :             ulLth = 0;
	...
	mov	DWORD PTR _ulLth$7992[ebp], 0
...
; 1139 :                                   lpViewAttrib );
	...
	mov	ecx, DWORD PTR _lpView$[ebp]
	push	ecx
	lea	edx, DWORD PTR _ulLth$7992[ebp]
	push	edx
...
; 1140 :             if ( ulLth )
	...
	cmp	DWORD PTR _ulLth$7992[ebp], 0
	je	SHORT $L7994
...
; 1143 :                zltoa( (zLONG) ulLth, &szWorkString[ k + 9 ] );
	...
	push	eax
	mov	ecx, DWORD PTR _ulLth$7992[ebp]
	push	ecx
	call	DWORD PTR __imp___ltoa
	add	esp, 12					; 0000000cH
...
; 1312 :          lpRecursViewEntity = zGETPTR( lpViewSubobject->hRecursViewEntity );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpRecursViewEntity$8088[ebp], eax

; 1313 :          TraceLineS( "**Recursive View Entity: ",
; 1314 :                      lpRecursViewEntity->szName );

	mov	edx, DWORD PTR _lpRecursViewEntity$8088[ebp]
	add	edx, 14					; 0000000eH
	push	edx
...
; 1347 :       LPVIEWENTITY lpParent = zGETPTR( lpViewEntity->hParent );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$8108[ebp], eax

; 1348 :       TraceLineS( "      Parent name = ", lpParent->szName );

	mov	eax, DWORD PTR _lpParent$8108[ebp]
	add	eax, 14					; 0000000eH
	push	eax
...
_lpRelField$ = -20
_sz$ = -24
_lpDBHandler$8283 = -36
_lpGKHandler$8287 = -40
_lpTemp$8332 = -44
_lpTempDataField$8368 = -56
_lpTempViewAttrib$8369 = -48
_lpTempViewEntity$8370 = -52
...
; 1579 :       LPDBHANDLER lpDBHandler = zGETPTR( lpViewOD->hDBHandler );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpDBHandler$8283[ebp], eax

; 1580 : 
; 1581 :       TraceLineS( "DBHandler name = ", lpDBHandler->szName );

	mov	eax, DWORD PTR _lpDBHandler$8283[ebp]
...
; 1586 :       LPGKHANDLER lpGKHandler = zGETPTR( lpViewOD->hGKHandler );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpGKHandler$8287[ebp], eax

; 1587 : 
; 1588 :       TraceLineS( "GKHandler name = ", lpGKHandler->szName );

	mov	ecx, DWORD PTR _lpGKHandler$8287[ebp]
	add	ecx, 10					; 0000000aH
	push	ecx
...
; 1662 :             LPVIEWATTRIB lpTemp = zGETPTR( lpDataField->hViewAttrib );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTemp$8332[ebp], eax

; 1663 : 
; 1664 :             TraceLineS( "                DATAFIELD Attribute name = ",
; 1665 :                         lpTemp->szName );

	mov	eax, DWORD PTR _lpTemp$8332[ebp]
	add	eax, 10					; 0000000aH
	push	eax
...
; 1728 :                   lpTempDataField  = zGETPTR( lpRelField->hSrcDataField );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempDataField$8368[ebp], eax

; 1729 :                   lpTempViewAttrib = zGETPTR( lpTempDataField->hViewAttrib );

	mov	edx, DWORD PTR _lpTempDataField$8368[ebp]
	mov	eax, DWORD PTR [edx+6]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempViewAttrib$8369[ebp], eax

; 1730 :                   lpTempViewEntity = zGETPTR( lpTempViewAttrib->hViewEntity );

	mov	ecx, DWORD PTR _lpTempViewAttrib$8369[ebp]
	mov	edx, DWORD PTR [ecx+6]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempViewEntity$8370[ebp], eax

; 1731 : 
; 1732 :                   TraceLineS( "                     Source entity = ",
; 1733 :                               lpTempViewEntity->szName );

	mov	eax, DWORD PTR _lpTempViewEntity$8370[ebp]
	add	eax, 14					; 0000000eH
	push	eax
...
_lpCurrentTask$ = -12
_nRC$ = -4
_lpFirstSrcViewAttrib$8409 = -20
_lpTgtViewAttrib$8410 = -24
_lpSrcViewAttrib$8411 = -16
_lpCompareViewAttrib$8435 = -28
...
; 1808 :       lpFirstSrcViewAttrib = zGETPTR( lpSrcViewEntity->hFirstOD_Attrib );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpFirstSrcViewAttrib$8409[ebp], eax
...
; 1811 :             lpTgtViewAttrib = zGETPTR( lpTgtViewAttrib->hNextOD_Attrib ) )
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtViewAttrib$8410[ebp], eax
	jmp	SHORT $L8415
$L8416:
	mov	eax, DWORD PTR _lpTgtViewAttrib$8410[ebp]
	mov	ecx, DWORD PTR [eax+2]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtViewAttrib$8410[ebp], eax
$L8415:
	cmp	DWORD PTR _lpTgtViewAttrib$8410[ebp], 0
	je	$L8417
...
; 1819 :          if ( lpTgtViewAttrib->bHidden )
	...
	mov	edx, DWORD PTR _lpTgtViewAttrib$8410[ebp]
	mov	eax, DWORD PTR [edx+193]
	shr	eax, 5
	and	eax, 1
	test	eax, eax
...
; 1823 :          lpSrcViewAttrib = lpFirstSrcViewAttrib;
	...
	mov	ecx, DWORD PTR _lpFirstSrcViewAttrib$8409[ebp]
	mov	DWORD PTR _lpSrcViewAttrib$8411[ebp], ecx
$L8428:
...
; 1826 :                           lpTgtViewAttrib->szName ) != 0 )
	...
	cmp	DWORD PTR _lpSrcViewAttrib$8411[ebp], 0
	je	SHORT $L8429
	mov	edx, DWORD PTR _lpSrcViewAttrib$8411[ebp]
	movsx	eax, BYTE PTR [edx+10]
	mov	ecx, DWORD PTR _lpTgtViewAttrib$8410[ebp]
	...
	add	eax, 10					; 0000000aH
	push	eax
	mov	ecx, DWORD PTR _lpSrcViewAttrib$8411[ebp]
	add	ecx, 10					; 0000000aH
	push	ecx
	call	_strcmp
	add	esp, 8
...
; 1828 :             lpSrcViewAttrib = zGETPTR( lpSrcViewAttrib->hNextOD_Attrib );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcViewAttrib$8411[ebp], eax
...
; 1840 :                                 0, lpSrcEntityInstance, lpSrcViewAttrib, 0 ) != 0 )
	...
	push	0
	mov	eax, DWORD PTR _lpSrcViewAttrib$8411[ebp]
	push	eax
...
; 1855 :             lpCompareViewAttrib = zGETPTR( lpCompareViewAttrib->hNextOD_Attrib ) )
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpCompareViewAttrib$8435[ebp], eax
	jmp	SHORT $L8438
$L8439:
	mov	edx, DWORD PTR _lpCompareViewAttrib$8435[ebp]
	mov	eax, DWORD PTR [edx+2]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpCompareViewAttrib$8435[ebp], eax
$L8438:
	cmp	DWORD PTR _lpCompareViewAttrib$8435[ebp], 0
	je	$L8440
...
; 1863 :          if ( lpCompareViewAttrib->bHidden )
	...
	mov	ecx, DWORD PTR _lpCompareViewAttrib$8435[ebp]
	mov	edx, DWORD PTR [ecx+193]
	shr	edx, 5
	and	edx, 1
	test	edx, edx
...
; 1870 :                                 lpCompareViewAttrib, 0 ) != 0 )
	...
	push	0
	mov	eax, DWORD PTR _lpCompareViewAttrib$8435[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpSrcEntityInstance$[ebp]
	push	ecx
	push	0
...
_lpViewOI$ = -12
_lpCurrentTask$ = -20
_lpFirstSrcViewAttrib$8484 = -28
_lpTgtViewAttrib$8485 = -32
_lpSrcViewAttrib$8486 = -24
_lpCompareViewAttrib$8523 = -36
...
; 1989 :       lpFirstSrcViewAttrib = zGETPTR( lpSrcViewEntity->hFirstOD_Attrib );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpFirstSrcViewAttrib$8484[ebp], eax
...
; 1992 :             lpTgtViewAttrib = zGETPTR( lpTgtViewAttrib->hNextOD_Attrib ) )
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtViewAttrib$8485[ebp], eax
	jmp	SHORT $L8490
$L8491:
	mov	eax, DWORD PTR _lpTgtViewAttrib$8485[ebp]
	mov	ecx, DWORD PTR [eax+2]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtViewAttrib$8485[ebp], eax
$L8490:
	cmp	DWORD PTR _lpTgtViewAttrib$8485[ebp], 0
	je	$L8492

; 1994 :          if ( lpTgtViewAttrib->bHidden )

	mov	edx, DWORD PTR _lpTgtViewAttrib$8485[ebp]
	mov	eax, DWORD PTR [edx+193]
	shr	eax, 5
	and	eax, 1
	test	eax, eax
...
; 2022 :          lpSrcViewAttrib = lpFirstSrcViewAttrib;
	...
	mov	ecx, DWORD PTR _lpFirstSrcViewAttrib$8484[ebp]
	mov	DWORD PTR _lpSrcViewAttrib$8486[ebp], ecx
$L8516:
...
; 2025 :                           lpTgtViewAttrib->szName ) != 0 )
	...
	cmp	DWORD PTR _lpSrcViewAttrib$8486[ebp], 0
	je	SHORT $L8517
	mov	edx, DWORD PTR _lpSrcViewAttrib$8486[ebp]
	movsx	eax, BYTE PTR [edx+10]
	mov	ecx, DWORD PTR _lpTgtViewAttrib$8485[ebp]
	movsx	edx, BYTE PTR [ecx+10]
	cmp	eax, edx
	jne	SHORT $L8925
	mov	eax, DWORD PTR _lpTgtViewAttrib$8485[ebp]
	add	eax, 10					; 0000000aH
	push	eax
	mov	ecx, DWORD PTR _lpSrcViewAttrib$8486[ebp]
	add	ecx, 10					; 0000000aH
	push	ecx
	call	_strcmp
	add	esp, 8
...
; 2027 :             lpSrcViewAttrib = zGETPTR( lpSrcViewAttrib->hNextOD_Attrib );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcViewAttrib$8486[ebp], eax
...
; 2040 :                                 lpSrcViewAttrib, 0 ) != 0 )
	...
	push	0
	mov	eax, DWORD PTR _lpSrcViewAttrib$8486[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpSrcEntityInstance$[ebp]
	push	ecx
	push	0
...
; 2055 :             lpCompareViewAttrib = zGETPTR( lpCompareViewAttrib->hNextOD_Attrib ) )
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpCompareViewAttrib$8523[ebp], eax
	jmp	SHORT $L8526
$L8527:
	mov	edx, DWORD PTR _lpCompareViewAttrib$8523[ebp]
	mov	eax, DWORD PTR [edx+2]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpCompareViewAttrib$8523[ebp], eax
$L8526:
	cmp	DWORD PTR _lpCompareViewAttrib$8523[ebp], 0
	je	$L8528

; 2057 :          if ( lpCompareViewAttrib->bHidden )

	mov	ecx, DWORD PTR _lpCompareViewAttrib$8523[ebp]
	mov	edx, DWORD PTR [ecx+193]
	shr	edx, 5
	and	edx, 1
	test	edx, edx
...
; 2088 :                                 lpCompareViewAttrib, 0 ) != 0 )
	...
	push	0
	mov	eax, DWORD PTR _lpCompareViewAttrib$8523[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpSrcEntityInstance$[ebp]
	push	ecx
	push	0
...
; 2193 :       LPVIEWENTITY lpViewEntity = zGETPTR( (*ppEntityInstance)->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$8578[ebp], eax
...
; 2199 :            lpViewEntity->hFirstDataRecord == 0 )
	...
	test	eax, eax
	je	SHORT $L8580
	mov	ecx, DWORD PTR _lpViewEntity$8578[ebp]
...
; 2212 :       bSkip = FALSE;
	...
	mov	BYTE PTR _bSkip$8577[ebp], 0
...
; 2216 :          bSkip = TRUE;
	...
	mov	BYTE PTR _bSkip$8577[ebp], 1
$L8582:
...
; 2220 :       if ( bSkip == FALSE )
	...
	mov	eax, DWORD PTR _bSkip$8577[ebp]
	and	eax, 255				; 000000ffH
	test	eax, eax
	jne	SHORT $L8583
...
; 2237 :          nLevel = (*ppEntityInstance)->nLevel;
	...
	mov	WORD PTR _nLevel$8587[ebp], cx
$L8588:
...
; 2242 :                    (*ppEntityInstance)->nLevel > nLevel );
	...
	mov	edx, DWORD PTR [ecx]
	movsx	eax, WORD PTR [edx+58]
	movsx	ecx, WORD PTR _nLevel$8587[ebp]
	cmp	eax, ecx
	jg	SHORT $L8588
$L8592:
...
_lpTgtEntity$8620 = -40
_lpSrcEntity$8621 = -36
...
; 2326 :       lpTgtEntity = zGETPTR( lpTgtInstance->hViewEntity );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtEntity$8620[ebp], eax
...
; 2327 :       lpSrcEntity = zGETPTR( lpSrcInstance->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcEntity$8621[ebp], eax
...
; 2332 :            lpSrcInstance->nLevel != lpTgtInstance->nLevel )
	...
	mov	ecx, DWORD PTR _lpSrcEntity$8621[ebp]
	cmp	ecx, DWORD PTR _lpTgtEntity$8620[ebp]
	jne	SHORT $L8629
	mov	edx, DWORD PTR _lpSrcInstance$[ebp]
	movsx	eax, WORD PTR [edx+58]
...
; 2345 :          if ( lpTgtEntity->bCreate == FALSE && lpTgtEntity->bUpdate == FALSE )
	...
	mov	ecx, DWORD PTR _lpTgtEntity$8620[ebp]
	mov	edx, DWORD PTR [ecx+235]
	and	edx, 1
	test	edx, edx
	jne	SHORT $L8632
	mov	eax, DWORD PTR _lpTgtEntity$8620[ebp]
	mov	ecx, DWORD PTR [eax+235]
	shr	ecx, 2
	and	ecx, 1
	test	ecx, ecx
...
; 2347 :             if ( lpTgtEntity->bInclude == FALSE )
	...
	mov	edx, DWORD PTR _lpTgtEntity$8620[ebp]
	mov	eax, DWORD PTR [edx+235]
	shr	eax, 3
	and	eax, 1
	test	eax, eax
