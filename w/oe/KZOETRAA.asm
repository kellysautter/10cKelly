...
; 120  :    {
	...
	xor	eax, eax
	mov	al, BYTE PTR $L8887[ecx]
	jmp	DWORD PTR $L8888[eax*4]
$L7557:
...
_szMessage$ = -256
_nTitleLth$7619 = -260
_nStringLth$7620 = -264
_nLth$7628 = -276
_nMsgOffset$7629 = -268
_pch$7630 = -272
_nVacant$7631 = -280
...
; 297  :       int  nTitleLth = zstrlen( Title );
	...
	call	_strlen
	add	esp, 4
	mov	DWORD PTR _nTitleLth$7619[ebp], eax
...
; 301  :          nStringLth = zstrlen( String );
	...
	call	_strlen
	add	esp, 4
	mov	DWORD PTR _nStringLth$7620[ebp], eax
...
; 303  :          nStringLth = 6;   // for "(null)"
	...
	mov	DWORD PTR _nStringLth$7620[ebp], 6
$L7622:
...
; 307  :       if ( nTitleLth + nStringLth < zMAX_MSG_LTH )
	...
	mov	edx, DWORD PTR _nTitleLth$7619[ebp]
	add	edx, DWORD PTR _nStringLth$7620[ebp]
...
; 311  :             zstrcpy( szMessage + nTitleLth, String );
	...
	push	edx
	mov	eax, DWORD PTR _nTitleLth$7619[ebp]
...
; 321  :          int    nLth = 0;           // amount sent so far
	...
	mov	DWORD PTR _nLth$7628[ebp], 0

; 322  :          int    nMsgOffset = 0;     // amount of szMessage currently loaded

	mov	DWORD PTR _nMsgOffset$7629[ebp], 0
$L7633:
...
; 326  :          while ( nLth < nTitleLth )
	...
	mov	ecx, DWORD PTR _nLth$7628[ebp]
	cmp	ecx, DWORD PTR _nTitleLth$7619[ebp]
	jge	$L7634

; 328  :             nVacant = zMAX_MSG_LTH - nMsgOffset;

	mov	edx, 255				; 000000ffH
	sub	edx, DWORD PTR _nMsgOffset$7629[ebp]
	mov	DWORD PTR _nVacant$7631[ebp], edx

; 329  :             if ( nVacant > nTitleLth - nLth )  // fit rest of title?

	mov	eax, DWORD PTR _nTitleLth$7619[ebp]
	sub	eax, DWORD PTR _nLth$7628[ebp]
	cmp	DWORD PTR _nVacant$7631[ebp], eax
	jle	SHORT $L7635

; 331  :                zstrcpy( szMessage + nMsgOffset, Title + nLth );

	mov	ecx, DWORD PTR _Title$[ebp]
	add	ecx, DWORD PTR _nLth$7628[ebp]
	push	ecx
	mov	edx, DWORD PTR _nMsgOffset$7629[ebp]
	lea	eax, DWORD PTR _szMessage$[ebp+edx]
	push	eax
	call	_strcpy
	add	esp, 8
...
; 332  :                nVacant -= (nTitleLth - nLth);
	...
	mov	ecx, DWORD PTR _nTitleLth$7619[ebp]
	sub	ecx, DWORD PTR _nLth$7628[ebp]
	mov	edx, DWORD PTR _nVacant$7631[ebp]
	sub	edx, ecx
	mov	DWORD PTR _nVacant$7631[ebp], edx
...
; 333  :                nMsgOffset += nTitleLth - nLth;
	...
	mov	eax, DWORD PTR _nTitleLth$7619[ebp]
	sub	eax, DWORD PTR _nLth$7628[ebp]
	mov	ecx, DWORD PTR _nMsgOffset$7629[ebp]
	add	ecx, eax
	mov	DWORD PTR _nMsgOffset$7629[ebp], ecx

; 334  :                nLth = nTitleLth;

	mov	edx, DWORD PTR _nTitleLth$7619[ebp]
	mov	DWORD PTR _nLth$7628[ebp], edx
...
; 340  :                zstrncpy( szMessage + nMsgOffset, Title + nLth, nVacant );
	...
	mov	eax, DWORD PTR _nVacant$7631[ebp]
	push	eax
	mov	ecx, DWORD PTR _Title$[ebp]
	add	ecx, DWORD PTR _nLth$7628[ebp]
	push	ecx
...
; 343  :                pch = zstrrchr( szMessage, ',' );
	...
	add	esp, 8
	mov	DWORD PTR _pch$7630[ebp], eax

; 344  :                if ( pch > szMessage + 5 )

	lea	edx, DWORD PTR _szMessage$[ebp+5]
	cmp	DWORD PTR _pch$7630[ebp], edx
	jbe	SHORT $L7638

; 346  :                   pch++;

	mov	eax, DWORD PTR _pch$7630[ebp]
	add	eax, 1
	mov	DWORD PTR _pch$7630[ebp], eax

; 347  :                   *pch = 0;

	mov	ecx, DWORD PTR _pch$7630[ebp]
	mov	BYTE PTR [ecx], 0

; 348  :                   nLth += (pch - (zPCHAR) szMessage) - nMsgOffset;

	mov	edx, DWORD PTR _pch$7630[ebp]
	lea	eax, DWORD PTR _szMessage$[ebp]
	sub	edx, eax
	sub	edx, DWORD PTR _nMsgOffset$7629[ebp]
	mov	ecx, DWORD PTR _nLth$7628[ebp]
	add	ecx, edx
	mov	DWORD PTR _nLth$7628[ebp], ecx
...
; 353  :                   if ( pch > szMessage + 5 )
	...
	cmp	DWORD PTR _pch$7630[ebp], eax
	jbe	SHORT $L7642
...
; 355  :                      pch++;
	...
	mov	ecx, DWORD PTR _pch$7630[ebp]
	add	ecx, 1
	mov	DWORD PTR _pch$7630[ebp], ecx
...
; 357  :                      nLth += (pch - (zPCHAR) szMessage) - nMsgOffset;
	...
	lea	ecx, DWORD PTR _szMessage$[ebp]
	sub	eax, ecx
	sub	eax, DWORD PTR _nMsgOffset$7629[ebp]
	mov	edx, DWORD PTR _nLth$7628[ebp]
	add	edx, eax
	mov	DWORD PTR _nLth$7628[ebp], edx
...
; 360  :                      nLth += nVacant;
	...
	mov	eax, DWORD PTR _nLth$7628[ebp]
	add	eax, DWORD PTR _nVacant$7631[ebp]
	mov	DWORD PTR _nLth$7628[ebp], eax
$L7644:
...
; 365  :                nMsgOffset = 5;
	...
	mov	DWORD PTR _nMsgOffset$7629[ebp], 5
$L7636:
...
; 370  :          while ( nLth < nStringLth )
	...
	mov	eax, DWORD PTR _nLth$7628[ebp]
	cmp	eax, DWORD PTR _nStringLth$7620[ebp]
	jge	$L7648

; 372  :             nVacant = zMAX_MSG_LTH - nMsgOffset;

	mov	ecx, 255				; 000000ffH
	sub	ecx, DWORD PTR _nMsgOffset$7629[ebp]
	mov	DWORD PTR _nVacant$7631[ebp], ecx

; 373  :             if ( nVacant > nStringLth - nLth )  // fit rest of string?

	mov	edx, DWORD PTR _nStringLth$7620[ebp]
	sub	edx, DWORD PTR _nLth$7628[ebp]
	cmp	DWORD PTR _nVacant$7631[ebp], edx
	jle	SHORT $L7649

; 375  :                zstrcpy( szMessage + nMsgOffset, String + nLth );

	mov	eax, DWORD PTR _String$[ebp]
	add	eax, DWORD PTR _nLth$7628[ebp]
	push	eax
	mov	ecx, DWORD PTR _nMsgOffset$7629[ebp]
...
; 376  :                nVacant -= (nStringLth - nLth);
	...
	mov	eax, DWORD PTR _nStringLth$7620[ebp]
	sub	eax, DWORD PTR _nLth$7628[ebp]
	mov	ecx, DWORD PTR _nVacant$7631[ebp]
	sub	ecx, eax
	mov	DWORD PTR _nVacant$7631[ebp], ecx
...
; 377  :                nMsgOffset += nStringLth - nLth;
	...
	mov	edx, DWORD PTR _nStringLth$7620[ebp]
	sub	edx, DWORD PTR _nLth$7628[ebp]
	mov	eax, DWORD PTR _nMsgOffset$7629[ebp]
	add	eax, edx
	mov	DWORD PTR _nMsgOffset$7629[ebp], eax

; 378  :                nLth = nStringLth;

	mov	ecx, DWORD PTR _nStringLth$7620[ebp]
	mov	DWORD PTR _nLth$7628[ebp], ecx
...
; 388  :                if ( pch > szMessage + 5 )
	...
	cmp	DWORD PTR _pch$7630[ebp], ecx
	jbe	SHORT $L7652
...
; 390  :                   pch++;
	...
	mov	edx, DWORD PTR _pch$7630[ebp]
	add	edx, 1
	mov	DWORD PTR _pch$7630[ebp], edx
...
; 404  :                      nLth += nVacant;
	...
	mov	edx, DWORD PTR _nLth$7628[ebp]
	add	edx, DWORD PTR _nVacant$7631[ebp]
	mov	DWORD PTR _nLth$7628[ebp], edx
$L7658:
...
_nRC$ = -8
_lpViewCsr$7786 = -28
_lpRootViewEntityCsr$7788 = -36
_lpViewEntity$7790 = -32
...
; 704  :       LPVIEWCSR       lpViewCsr = zGETPTR( lpView->hViewCsr );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$7786[ebp], eax

; 705  :       LPVIEWENTITYCSR lpRootViewEntityCsr =
; 706  :                                   zGETPTR( lpViewCsr->hRootViewEntityCsr );

	mov	eax, DWORD PTR _lpViewCsr$7786[ebp]
	mov	ecx, DWORD PTR [eax+18]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpRootViewEntityCsr$7788[ebp], eax

; 707  :       LPVIEWENTITY    lpViewEntity =
; 708  :                                   zGETPTR( lpRootViewEntityCsr->hViewEntity );

	mov	edx, DWORD PTR _lpRootViewEntityCsr$7788[ebp]
	mov	eax, DWORD PTR [edx+14]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$7790[ebp], eax

; 709  : 
; 710  :       pchWorkEntityName = lpViewEntity->szName;

	mov	ecx, DWORD PTR _lpViewEntity$7790[ebp]
...
_nLevel$ = -4
_lpViewCsr$7817 = -36
_lpRootViewEntityCsr$7819 = -44
_lpViewEntity$7821 = -40
...
; 778  :       LPVIEWCSR       lpViewCsr = zGETPTR( lpView->hViewCsr );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$7817[ebp], eax

; 779  :       LPVIEWENTITYCSR lpRootViewEntityCsr =
; 780  :                                   zGETPTR( lpViewCsr->hRootViewEntityCsr );

	mov	eax, DWORD PTR _lpViewCsr$7817[ebp]
	mov	ecx, DWORD PTR [eax+18]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpRootViewEntityCsr$7819[ebp], eax

; 781  :       LPVIEWENTITY    lpViewEntity =
; 782  :                                   zGETPTR( lpRootViewEntityCsr->hViewEntity );

	mov	edx, DWORD PTR _lpRootViewEntityCsr$7819[ebp]
	mov	eax, DWORD PTR [edx+14]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$7821[ebp], eax

; 783  : 
; 784  :       pchWorkEntityName = lpViewEntity->szName;

	mov	ecx, DWORD PTR _lpViewEntity$7821[ebp]
	add	ecx, 14					; 0000000eH
	mov	DWORD PTR _pchWorkEntityName$[ebp], ecx
$L7815:
...
; 938  :       lpViewCsr = zGETPTR( lpNewView->hViewCsr );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$7874[ebp], eax

; 939  :       lpViewEntityCsr = zGETPTR( lpViewCsr->hRootViewEntityCsr );

	mov	edx, DWORD PTR _lpViewCsr$7874[ebp]
...
; 941  :       lpViewOI = zGETPTR( lpViewCsr->hViewOI );
	...
	mov	ecx, DWORD PTR _lpViewCsr$7874[ebp]
	mov	edx, DWORD PTR [ecx+10]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOI$7875[ebp], eax

; 942  :       lpStartInstance = zGETPTR( lpViewOI->hRootEntityInstance );

	mov	eax, DWORD PTR _lpViewOI$7875[ebp]
...
; 1037 :       zCHAR            szFlags[ 50 ] = "Incremental Update Flags: ";
	...
	lea	edi, DWORD PTR _szFlags$7931[ebp]
	rep movsd
	movsw
	movsb
	xor	edx, edx
	mov	DWORD PTR _szFlags$7931[ebp+27], edx
	mov	DWORD PTR _szFlags$7931[ebp+31], edx
	mov	DWORD PTR _szFlags$7931[ebp+35], edx
	mov	DWORD PTR _szFlags$7931[ebp+39], edx
	mov	DWORD PTR _szFlags$7931[ebp+43], edx
	mov	WORD PTR _szFlags$7931[ebp+47], dx
	mov	BYTE PTR _szFlags$7931[ebp+49], dl
...
; 1038 :       LPENTITYINSTANCE lpEntityInstance = zGETPTR( lpViewEntityCsr->hEntityInstance );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpEntityInstance$7933[ebp], eax
...
; 1044 :            lpEntityInstance->u.nInd.bPrevVsnRoot )
	...
	mov	edx, DWORD PTR _lpEntityInstance$7933[ebp]
	mov	eax, DWORD PTR [edx+6]
	shr	eax, 10					; 0000000aH
	and	eax, 1
	test	eax, eax
	jne	SHORT $L7936
	mov	ecx, DWORD PTR _lpEntityInstance$7933[ebp]
	mov	edx, DWORD PTR [ecx+6]
	shr	edx, 11					; 0000000bH
	and	edx, 1
	test	edx, edx
	jne	SHORT $L7936
	mov	eax, DWORD PTR _lpEntityInstance$7933[ebp]
...
; 1062 :          zstrcat( szFlags, "C" );
	...
	lea	ecx, DWORD PTR _szFlags$7931[ebp]
	push	ecx
	call	_strcat
	add	esp, 8
$L7950:
...
; 1076 :       TraceLineS( szSpaces, szFlags );
	...
	lea	edx, DWORD PTR _szFlags$7931[ebp]
	push	edx
...
; 1089 :                                             lpEntityInstance->hViewEntity ) )
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	cmp	eax, DWORD PTR _lpEntityInstance$7933[ebp]
	jne	SHORT $L7969
...
; 1100 :          nWk1 = 0;
	...
	mov	WORD PTR _nWk1$7974[ebp], 0

; 1101 :          nWk2 = 0x0001;

	mov	WORD PTR _nWk2$7975[ebp], 1
...
; 1103 :          for ( nWk3 = 1; nWk3 < 17; nWk3++ )
	...
	mov	WORD PTR _nWk3$7976[ebp], 1
	jmp	SHORT $L7978
$L7979:
	mov	cx, WORD PTR _nWk3$7976[ebp]
	add	cx, 1
	mov	WORD PTR _nWk3$7976[ebp], cx
$L7978:
	movsx	edx, WORD PTR _nWk3$7976[ebp]
...
; 1105 :             if ( lpSelectedInstance->nSelectSet & nWk2 )
	...
	movsx	edx, WORD PTR _nWk2$7975[ebp]
	and	ecx, edx
	test	ecx, ecx
	je	SHORT $L7981
...
; 1107 :                if ( nWk1 )
	...
	movsx	eax, WORD PTR _nWk1$7974[ebp]
	test	eax, eax
	je	SHORT $L7982
...
; 1110 :                zltoa( (zLONG) nWk3, &szWorkString[ 250 ] );
	...
	push	edx
	movsx	eax, WORD PTR _nWk3$7976[ebp]
	push	eax
	call	DWORD PTR __imp___ltoa
	add	esp, 12					; 0000000cH
...
; 1112 :                nWk1++;
	...
	mov	ax, WORD PTR _nWk1$7974[ebp]
	add	ax, 1
	mov	WORD PTR _nWk1$7974[ebp], ax
$L7981:

; 1114 : 
; 1115 :             nWk2 <<= 1;

	mov	cx, WORD PTR _nWk2$7975[ebp]
	shl	cx, 1
	mov	WORD PTR _nWk2$7975[ebp], cx
...
; 1136 :             ulLth = 0;
	...
	mov	DWORD PTR _ulLth$7995[ebp], 0
...
; 1139 :                                   lpViewAttrib );
	...
	mov	ecx, DWORD PTR _lpView$[ebp]
	push	ecx
	lea	edx, DWORD PTR _ulLth$7995[ebp]
	push	edx
...
; 1140 :             if ( ulLth )
	...
	cmp	DWORD PTR _ulLth$7995[ebp], 0
	je	SHORT $L7997
...
; 1143 :                zltoa( (zLONG) ulLth, &szWorkString[ k + 9 ] );
	...
	push	eax
	mov	ecx, DWORD PTR _ulLth$7995[ebp]
	push	ecx
	call	DWORD PTR __imp___ltoa
	add	esp, 12					; 0000000cH
...
; 1312 :          lpRecursViewEntity = zGETPTR( lpViewSubobject->hRecursViewEntity );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpRecursViewEntity$8091[ebp], eax

; 1313 :          TraceLineS( "**Recursive View Entity: ",
; 1314 :                      lpRecursViewEntity->szName );

	mov	edx, DWORD PTR _lpRecursViewEntity$8091[ebp]
	add	edx, 14					; 0000000eH
	push	edx
...
; 1347 :       LPVIEWENTITY lpParent = zGETPTR( lpViewEntity->hParent );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$8111[ebp], eax

; 1348 :       TraceLineS( "      Parent name = ", lpParent->szName );

	mov	eax, DWORD PTR _lpParent$8111[ebp]
	add	eax, 14					; 0000000eH
	push	eax
...
_lpRelField$ = -20
_sz$ = -24
_lpDBHandler$8286 = -36
_lpGKHandler$8290 = -40
_lpTemp$8335 = -44
_lpTempDataField$8371 = -56
_lpTempViewAttrib$8372 = -48
_lpTempViewEntity$8373 = -52
...
; 1579 :       LPDBHANDLER lpDBHandler = zGETPTR( lpViewOD->hDBHandler );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpDBHandler$8286[ebp], eax

; 1580 : 
; 1581 :       TraceLineS( "DBHandler name = ", lpDBHandler->szName );

	mov	eax, DWORD PTR _lpDBHandler$8286[ebp]
...
; 1586 :       LPGKHANDLER lpGKHandler = zGETPTR( lpViewOD->hGKHandler );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpGKHandler$8290[ebp], eax

; 1587 : 
; 1588 :       TraceLineS( "GKHandler name = ", lpGKHandler->szName );

	mov	ecx, DWORD PTR _lpGKHandler$8290[ebp]
	add	ecx, 10					; 0000000aH
	push	ecx
...
; 1662 :             LPVIEWATTRIB lpTemp = zGETPTR( lpDataField->hViewAttrib );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTemp$8335[ebp], eax

; 1663 : 
; 1664 :             TraceLineS( "                DATAFIELD Attribute name = ",
; 1665 :                         lpTemp->szName );

	mov	eax, DWORD PTR _lpTemp$8335[ebp]
	add	eax, 10					; 0000000aH
	push	eax
...
; 1728 :                   lpTempDataField  = zGETPTR( lpRelField->hSrcDataField );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempDataField$8371[ebp], eax

; 1729 :                   lpTempViewAttrib = zGETPTR( lpTempDataField->hViewAttrib );

	mov	edx, DWORD PTR _lpTempDataField$8371[ebp]
	mov	eax, DWORD PTR [edx+6]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempViewAttrib$8372[ebp], eax

; 1730 :                   lpTempViewEntity = zGETPTR( lpTempViewAttrib->hViewEntity );

	mov	ecx, DWORD PTR _lpTempViewAttrib$8372[ebp]
	mov	edx, DWORD PTR [ecx+6]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempViewEntity$8373[ebp], eax

; 1731 : 
; 1732 :                   TraceLineS( "                     Source entity = ",
; 1733 :                               lpTempViewEntity->szName );

	mov	eax, DWORD PTR _lpTempViewEntity$8373[ebp]
	add	eax, 14					; 0000000eH
	push	eax
...
_lpCurrentTask$ = -12
_nRC$ = -4
_lpFirstSrcViewAttrib$8412 = -20
_lpTgtViewAttrib$8413 = -24
_lpSrcViewAttrib$8414 = -16
_lpCompareViewAttrib$8438 = -28
...
; 1808 :       lpFirstSrcViewAttrib = zGETPTR( lpSrcViewEntity->hFirstOD_Attrib );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpFirstSrcViewAttrib$8412[ebp], eax
...
; 1811 :             lpTgtViewAttrib = zGETPTR( lpTgtViewAttrib->hNextOD_Attrib ) )
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtViewAttrib$8413[ebp], eax
	jmp	SHORT $L8418
$L8419:
	mov	eax, DWORD PTR _lpTgtViewAttrib$8413[ebp]
	mov	ecx, DWORD PTR [eax+2]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtViewAttrib$8413[ebp], eax
$L8418:
	cmp	DWORD PTR _lpTgtViewAttrib$8413[ebp], 0
	je	$L8420
...
; 1819 :          if ( lpTgtViewAttrib->bHidden )
	...
	mov	edx, DWORD PTR _lpTgtViewAttrib$8413[ebp]
	mov	eax, DWORD PTR [edx+193]
	shr	eax, 5
	and	eax, 1
	test	eax, eax
...
; 1823 :          lpSrcViewAttrib = lpFirstSrcViewAttrib;
	...
	mov	ecx, DWORD PTR _lpFirstSrcViewAttrib$8412[ebp]
	mov	DWORD PTR _lpSrcViewAttrib$8414[ebp], ecx
$L8431:
...
; 1826 :                           lpTgtViewAttrib->szName ) != 0 )
	...
	cmp	DWORD PTR _lpSrcViewAttrib$8414[ebp], 0
	je	SHORT $L8432
	mov	edx, DWORD PTR _lpSrcViewAttrib$8414[ebp]
	movsx	eax, BYTE PTR [edx+10]
	mov	ecx, DWORD PTR _lpTgtViewAttrib$8413[ebp]
	...
	add	eax, 10					; 0000000aH
	push	eax
	mov	ecx, DWORD PTR _lpSrcViewAttrib$8414[ebp]
	add	ecx, 10					; 0000000aH
	push	ecx
	call	_strcmp
	add	esp, 8
...
; 1828 :             lpSrcViewAttrib = zGETPTR( lpSrcViewAttrib->hNextOD_Attrib );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcViewAttrib$8414[ebp], eax
...
; 1840 :                                 0, lpSrcEntityInstance, lpSrcViewAttrib, 0 ) != 0 )
	...
	push	0
	mov	eax, DWORD PTR _lpSrcViewAttrib$8414[ebp]
	push	eax
...
; 1855 :             lpCompareViewAttrib = zGETPTR( lpCompareViewAttrib->hNextOD_Attrib ) )
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpCompareViewAttrib$8438[ebp], eax
	jmp	SHORT $L8441
$L8442:
	mov	edx, DWORD PTR _lpCompareViewAttrib$8438[ebp]
	mov	eax, DWORD PTR [edx+2]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpCompareViewAttrib$8438[ebp], eax
$L8441:
	cmp	DWORD PTR _lpCompareViewAttrib$8438[ebp], 0
	je	$L8443
...
; 1863 :          if ( lpCompareViewAttrib->bHidden )
	...
	mov	ecx, DWORD PTR _lpCompareViewAttrib$8438[ebp]
	mov	edx, DWORD PTR [ecx+193]
	shr	edx, 5
	and	edx, 1
	test	edx, edx
...
; 1870 :                                 lpCompareViewAttrib, 0 ) != 0 )
	...
	push	0
	mov	eax, DWORD PTR _lpCompareViewAttrib$8438[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpSrcEntityInstance$[ebp]
	push	ecx
	push	0
...
_lpViewOI$ = -12
_lpCurrentTask$ = -20
_lpFirstSrcViewAttrib$8487 = -28
_lpTgtViewAttrib$8488 = -32
_lpSrcViewAttrib$8489 = -24
_lpCompareViewAttrib$8526 = -36
...
; 1989 :       lpFirstSrcViewAttrib = zGETPTR( lpSrcViewEntity->hFirstOD_Attrib );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpFirstSrcViewAttrib$8487[ebp], eax
...
; 1992 :             lpTgtViewAttrib = zGETPTR( lpTgtViewAttrib->hNextOD_Attrib ) )
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtViewAttrib$8488[ebp], eax
	jmp	SHORT $L8493
$L8494:
	mov	eax, DWORD PTR _lpTgtViewAttrib$8488[ebp]
	mov	ecx, DWORD PTR [eax+2]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtViewAttrib$8488[ebp], eax
$L8493:
	cmp	DWORD PTR _lpTgtViewAttrib$8488[ebp], 0
	je	$L8495

; 1994 :          if ( lpTgtViewAttrib->bHidden )

	mov	edx, DWORD PTR _lpTgtViewAttrib$8488[ebp]
	mov	eax, DWORD PTR [edx+193]
	shr	eax, 5
	and	eax, 1
	test	eax, eax
...
; 2022 :          lpSrcViewAttrib = lpFirstSrcViewAttrib;
	...
	mov	ecx, DWORD PTR _lpFirstSrcViewAttrib$8487[ebp]
	mov	DWORD PTR _lpSrcViewAttrib$8489[ebp], ecx
$L8519:
...
; 2025 :                           lpTgtViewAttrib->szName ) != 0 )
	...
	cmp	DWORD PTR _lpSrcViewAttrib$8489[ebp], 0
	je	SHORT $L8520
	mov	edx, DWORD PTR _lpSrcViewAttrib$8489[ebp]
	movsx	eax, BYTE PTR [edx+10]
	mov	ecx, DWORD PTR _lpTgtViewAttrib$8488[ebp]
	movsx	edx, BYTE PTR [ecx+10]
	cmp	eax, edx
	jne	SHORT $L8928
	mov	eax, DWORD PTR _lpTgtViewAttrib$8488[ebp]
	add	eax, 10					; 0000000aH
	push	eax
	mov	ecx, DWORD PTR _lpSrcViewAttrib$8489[ebp]
	add	ecx, 10					; 0000000aH
	push	ecx
	call	_strcmp
	add	esp, 8
...
; 2027 :             lpSrcViewAttrib = zGETPTR( lpSrcViewAttrib->hNextOD_Attrib );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcViewAttrib$8489[ebp], eax
...
; 2040 :                                 lpSrcViewAttrib, 0 ) != 0 )
	...
	push	0
	mov	eax, DWORD PTR _lpSrcViewAttrib$8489[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpSrcEntityInstance$[ebp]
	push	ecx
	push	0
...
; 2055 :             lpCompareViewAttrib = zGETPTR( lpCompareViewAttrib->hNextOD_Attrib ) )
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpCompareViewAttrib$8526[ebp], eax
	jmp	SHORT $L8529
$L8530:
	mov	edx, DWORD PTR _lpCompareViewAttrib$8526[ebp]
	mov	eax, DWORD PTR [edx+2]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpCompareViewAttrib$8526[ebp], eax
$L8529:
	cmp	DWORD PTR _lpCompareViewAttrib$8526[ebp], 0
	je	$L8531

; 2057 :          if ( lpCompareViewAttrib->bHidden )

	mov	ecx, DWORD PTR _lpCompareViewAttrib$8526[ebp]
	mov	edx, DWORD PTR [ecx+193]
	shr	edx, 5
	and	edx, 1
	test	edx, edx
...
; 2088 :                                 lpCompareViewAttrib, 0 ) != 0 )
	...
	push	0
	mov	eax, DWORD PTR _lpCompareViewAttrib$8526[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpSrcEntityInstance$[ebp]
	push	ecx
	push	0
...
; 2193 :       LPVIEWENTITY lpViewEntity = zGETPTR( (*ppEntityInstance)->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$8581[ebp], eax
...
; 2199 :            lpViewEntity->hFirstDataRecord == 0 )
	...
	test	eax, eax
	je	SHORT $L8583
	mov	ecx, DWORD PTR _lpViewEntity$8581[ebp]
...
; 2212 :       bSkip = FALSE;
	...
	mov	BYTE PTR _bSkip$8580[ebp], 0
...
; 2216 :          bSkip = TRUE;
	...
	mov	BYTE PTR _bSkip$8580[ebp], 1
$L8585:
...
; 2220 :       if ( bSkip == FALSE )
	...
	mov	eax, DWORD PTR _bSkip$8580[ebp]
	and	eax, 255				; 000000ffH
	test	eax, eax
	jne	SHORT $L8586
...
; 2237 :          nLevel = (*ppEntityInstance)->nLevel;
	...
	mov	WORD PTR _nLevel$8590[ebp], cx
$L8591:
...
; 2242 :                    (*ppEntityInstance)->nLevel > nLevel );
	...
	mov	edx, DWORD PTR [ecx]
	movsx	eax, WORD PTR [edx+58]
	movsx	ecx, WORD PTR _nLevel$8590[ebp]
	cmp	eax, ecx
	jg	SHORT $L8591
$L8595:
...
_lpTgtEntity$8623 = -40
_lpSrcEntity$8624 = -36
...
; 2326 :       lpTgtEntity = zGETPTR( lpTgtInstance->hViewEntity );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtEntity$8623[ebp], eax
...
; 2327 :       lpSrcEntity = zGETPTR( lpSrcInstance->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcEntity$8624[ebp], eax
...
; 2332 :            lpSrcInstance->nLevel != lpTgtInstance->nLevel )
	...
	mov	ecx, DWORD PTR _lpSrcEntity$8624[ebp]
	cmp	ecx, DWORD PTR _lpTgtEntity$8623[ebp]
	jne	SHORT $L8632
	mov	edx, DWORD PTR _lpSrcInstance$[ebp]
	movsx	eax, WORD PTR [edx+58]
...
; 2345 :          if ( lpTgtEntity->bCreate == FALSE && lpTgtEntity->bUpdate == FALSE )
	...
	mov	ecx, DWORD PTR _lpTgtEntity$8623[ebp]
	mov	edx, DWORD PTR [ecx+235]
	and	edx, 1
	test	edx, edx
	jne	SHORT $L8635
	mov	eax, DWORD PTR _lpTgtEntity$8623[ebp]
	mov	ecx, DWORD PTR [eax+235]
	shr	ecx, 2
	and	ecx, 1
	test	ecx, ecx
...
; 2347 :             if ( lpTgtEntity->bInclude == FALSE )
	...
	mov	edx, DWORD PTR _lpTgtEntity$8623[ebp]
	mov	eax, DWORD PTR [edx+235]
	shr	eax, 3
	and	eax, 1
	test	eax, eax
