...
_BSS	ENDS
_DATA	SEGMENT
$SG14384 DB	'Invalid parameter', 00H
	ORG $+2
$SG14385 DB	'Zeidon Error', 00H
	ORG $+3
$SG13440 DB	'AM', 00H
	ORG $+1
$SG13441 DB	'PM', 00H
...
$SG13539 DB	'Zeidon Error', 00H
	ORG $+3
$SG14592 DB	'ZeidonStringCopy: Invalid parameter.', 00H
	ORG $+3
$SG14594 DB	'ZeidonStringCopy: Target string has negative length', 00H
$SG14597 DB	'ZeidonStringCopy: Target string is too small', 00H
	ORG $+3
$SG14599 DB	'ZeidonStringCopy: Invalid parameter (source index).', 00H
$SG14626 DB	'ZeidonStringConcat: Invalid parameter.', 00H
	ORG $+1
$SG14628 DB	'ZeidonStringConcat: Target string has negative length.', 00H
	ORG $+1
$SG14630 DB	'ZeidonStringConcat: Source string has negative length.', 00H
	ORG $+1
$SG13606 DB	'AM', 00H
	ORG $+1
$SG14632 DB	'ZeidonStringConcat: Target string is too small.', 00H
$SG13611 DB	'PM', 00H
	ORG $+1
$SG13617 DB	'DD', 00H
	ORG $+1
$SG14656 DB	'ZeidonStringCompare: Invalid parameter.', 00H
$SG14658 DB	'ZeidonStringCompare: Target string has negative length.', 00H
$SG14660 DB	'ZeidonStringCompare: Source string has negative length.', 00H
$SG14662 DB	'ZeidonStringCompare: Target string is too short.', 00H
	ORG $+3
$SG13642 DB	'jj', 00H
	ORG $+1
$SG13652 DB	'mm', 00H
	ORG $+1
$SG14698 DB	'ZeidonStringConvertFromNumber: Target string has negativ'
	DB	'e length.', 00H
	ORG $+2
$SG14702 DB	'ZeidonStringConvertFromNumber: Invalid parameter.', 00H
	ORG $+2
$SG14720 DB	'ZeidonStringCopy: Invalid parameter.', 00H
	ORG $+3
$SG14722 DB	'ZeidonStringCopy: Target string is too small', 00H
	ORG $+3
_cMonth_Val DB	06H
	DB	02H
	DB	02H
...
_usLeapDayTable DW 00H
	...
	DW	0131H
	DW	014fH
$SG14823 DB	'aeiou', 00H
	ORG $+2
$SG14824 DB	'_', 00H
	ORG $+2
$SG14827 DB	'aeiou', 00H
	ORG $+2
$SG14829 DB	'*', 00H
	ORG $+2
$SG14830 DB	'bcdfghjklmnpqrstvwxyz', 00H
	ORG $+2
$SG14884 DB	'UfZProbeOn: No more probes available for: ', 00H
	ORG $+1
$SG14889 DB	'UfZProbeOn: Invalid probe descriptor for probe: ', 00H
	ORG $+3
$SG14890 DB	'UfZProbeOn: Invalid probe descriptor   (input): ', 00H
	ORG $+3
$SG14891 DB	'UfZProbeOn: Invalid probe descriptor (current): ', 00H
	ORG $+3
$SG14906 DB	'UfZProbeOff: Invalid probe number: ', 00H
$SG14907 DB	'UfZProbeOff:           descriptor: ', 00H
$SG14910 DB	'UfZProbeOff: Probe not on for number: ', 00H
	ORG $+1
$SG14911 DB	'UfZProbeOff:              descriptor: ', 00H
	ORG $+1
$SG14935 DB	'UfZProbeOffByDesc: Probe not on for descriptor: ', 00H
	ORG $+3
$SG14955 DB	'======= Probe Trace - %30s ===START===', 00H
	ORG $+1
$SG14957 DB	'zp.ALL. -- elapsed for Init to Trace->:%8.3f seconds', 00H
	ORG $+3
$SG14961 DB	'zp.%03d. %30s:%8.3f secs. (avg.%8.3f for %8d times)', 00H
_Encrypt1 DB	016H
	DB	05H
	DB	0dH
	DB	010H
	...
	DB	08H
	ORG $+2
$SG14962 DB	'zp.%03d. %30s:%8.3f secs. (avg.%8.3f for %8d times OFF, '
	DB	'but ON is %d times)', 00H
$SG14964 DB	'======= Probe Trace - %30s === END ===', 00H
	ORG $+1
_Encrypt2 DB	0aH
	DB	011H
	DB	04H
...
_EncryptNonAlpha DB 00H
	...
	DB	030H
	ORG $+1
$SG14204 DB	'Error decrypting string', 00H
$SG14205 DB	'Zeidon Internal Error', 00H
	ORG $+2
$SG14254 DB	'00010101', 00H
	ORG $+3
$SG14259 DB	'Year less than 1', 00H
	ORG $+3
$SG14260 DB	'Zeidon Error', 00H
	ORG $+3
$SG14262 DB	'Year greater than 9999', 00H
	ORG $+1
$SG14263 DB	'Zeidon Error', 00H
	ORG $+3
$SG14272 DB	'Year less than 1', 00H
	ORG $+3
$SG14273 DB	'Zeidon Error', 00H
	ORG $+3
$SG14277 DB	'Year greater than 9999', 00H
	ORG $+1
$SG14278 DB	'Zeidon Error', 00H
	ORG $+3
$SG14289 DB	'Invalid parameter', 00H
	ORG $+2
$SG14290 DB	'Zeidon Error', 00H
	ORG $+3
$SG14298 DB	'Year less than 1', 00H
	ORG $+3
$SG14299 DB	'Zeidon Error', 00H
	ORG $+3
$SG14302 DB	'Year less than 1', 00H
	ORG $+3
$SG14303 DB	'Zeidon Error', 00H
	ORG $+3
$SG14306 DB	'Integer overflow', 00H
	ORG $+3
$SG14307 DB	'Zeidon Error', 00H
_DATA	ENDS
...
; 4490 :          pchPrevChar = "aeiou";
	...
	mov	DWORD PTR _pchPrevChar$[ebp], OFFSET $SG14823
