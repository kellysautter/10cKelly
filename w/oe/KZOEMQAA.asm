...
; 200  :                    cpcMsgId, cpcTitle, cpcMsgText, lMsgType );
	...
	lea	edx, DWORD PTR _szMsg$7625[ebp]
	push	edx
...
; 201  :          SysMessageBox( vSubtask, g_pchMQI[ 0 ], szMsg, 1 );
	...
	push	1
	lea	eax, DWORD PTR _szMsg$7625[ebp]
	push	eax
...
; 281  :                   MQ_MessageSend pfn = (MQ_MessageSend) lpMQInterface->pfnMQ[ 0 ];
	...
	mov	DWORD PTR _pfn$7655[ebp], ecx
...
; 296  :                MQ_MessageSend pfn = (MQ_MessageSend) lpMQInterface->pfnMQ[ 0 ];
	...
	mov	eax, DWORD PTR _lpMQInterface$[ebp]
	mov	ecx, DWORD PTR [eax+6]
	mov	DWORD PTR _pfn$7660[ebp], ecx
...
; 475  :             MQ_MessagePrompt pfn = lpMQInterface->pfnMQ[ 1 ];
	...
	mov	DWORD PTR _pfn$7708[ebp], ecx
...
; 578  :          pfn = lpMQInterface->pfnMQ[ 2 ];
	...
	mov	DWORD PTR _pfn$7738[ebp], eax
...
; 667  :          pfn = (MQ_MessagePresent) lpMQInterface->pfnMQ[ 3 ];
	...
	mov	DWORD PTR _pfn$7760[ebp], edx
...
_lpLibrary$7794 = -20
_lpViewOD$7800 = -28
_lpMQInterface$7801 = -32
_hMQInterface$7802 = -36
_hLibrary$7803 = -24
_lpTask$7808 = -40
_bMutexLocked$7813 = -44
_lpTask$7819 = -48
_szMsg$7839 = -560
_k$7844 = -564
_lpTask$7849 = -568
...
; 757  :             LPLIBRARY lpLibrary = zGETPTR( lpTaskApp->hLibrary );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpLibrary$7794[ebp], eax

; 758  : 
; 759  :             if ( lpLibrary && lpLibrary->lProcessID != lProcessID )

	cmp	DWORD PTR _lpLibrary$7794[ebp], 0
	je	SHORT $L7796
	mov	ecx, DWORD PTR _lpLibrary$7794[ebp]
...
; 789  :          LPTASK lpTask = zGETPTR( vSubtask->hTask );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$7808[ebp], eax
...
; 792  :                            "fnFindMQInterface", "TaskAppRecord" );
	...
	mov	edx, DWORD PTR _vSubtask$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpTask$7808[ebp]
	push	eax
...
; 806  :                                           iMQInterface );
	...
	call	_fnAllocDataspace
	add	esp, 20					; 00000014H
	mov	DWORD PTR _hMQInterface$7802[ebp], eax

; 807  :          lpMQInterface = zGETPTR( hMQInterface );

	mov	ecx, DWORD PTR _hMQInterface$7802[ebp]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpMQInterface$7801[ebp], eax

; 808  :          if ( lpMQInterface == 0 )

	cmp	DWORD PTR _lpMQInterface$7801[ebp], 0
	jne	SHORT $L7818
...
; 810  :             LPTASK lpTask = zGETPTR( vSubtask->hTask );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$7819[ebp], eax
...
; 813  :                               "MQInterfaceRecord" );
	...
	mov	ecx, DWORD PTR _vSubtask$[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpTask$7819[ebp]
	push	edx
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
...
; 819  :          lpTaskApp->hMQInterface = hMQInterface;
	...
	mov	ecx, DWORD PTR _lpTaskApp$[ebp]
	mov	edx, DWORD PTR _hMQInterface$7802[ebp]
...
; 824  :             bMutexLocked = TRUE;
	...
	mov	BYTE PTR _bMutexLocked$7813[ebp], 1
...
; 828  :             bMutexLocked = FALSE;
	...
	mov	BYTE PTR _bMutexLocked$7813[ebp], 0
$L7823:
...
; 833  :          if ( bMutexLocked )
	...
	mov	edx, DWORD PTR _bMutexLocked$7813[ebp]
...
; 845  :             lpViewOD = zGETPTR( lpViewOD->hNextViewOD ) )
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOD$7800[ebp], eax
	jmp	SHORT $L7828
$L7829:
	mov	edx, DWORD PTR _lpViewOD$7800[ebp]
	mov	eax, DWORD PTR [edx+2]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOD$7800[ebp], eax
$L7828:
	cmp	DWORD PTR _lpViewOD$7800[ebp], 0
	je	SHORT $L7830

; 847  :          if ( zstrcmp( lpViewOD->szName, szlMessageObject ) == 0 )

	mov	ecx, DWORD PTR _lpViewOD$7800[ebp]
	...
	push	edx
	mov	eax, DWORD PTR _lpViewOD$7800[ebp]
...
; 863  :          zstrcat( szMsg, szlMessageObject );
	...
	mov	edx, DWORD PTR _szlMessageObject
	push	edx
	lea	eax, DWORD PTR _szMsg$7839[ebp]
	push	eax
	call	_strcat
	add	esp, 8
...
; 869  :                                                lpViewOD->szOperLibname, 0 );
	...
	mov	DWORD PTR _hLibrary$7803[ebp], eax
...
; 873  :          if ( hLibrary )
	...
	cmp	DWORD PTR _hLibrary$7803[ebp], 0
	je	SHORT $L7843
...
; 877  :             lpTaskApp->hLibrary = hLibrary;
	...
	mov	edx, DWORD PTR _lpTaskApp$[ebp]
	mov	eax, DWORD PTR _hLibrary$7803[ebp]
	mov	DWORD PTR [edx+18], eax

; 878  :             for ( k = 0; k < MAX_CORE_MQ_INT; k++ )

	mov	WORD PTR _k$7844[ebp], 0
	jmp	SHORT $L7845
$L7846:
	mov	cx, WORD PTR _k$7844[ebp]
	add	cx, 1
	mov	WORD PTR _k$7844[ebp], cx
$L7845:
	movsx	edx, WORD PTR _k$7844[ebp]
	cmp	edx, 4
	jge	SHORT $L7847

; 879  :                lpMQInterface->pfnMQ[ k ] = SysGetProc( hLibrary, g_pchMQI[ k ] );

	movsx	eax, WORD PTR _k$7844[ebp]
	mov	ecx, DWORD PTR _g_pchMQI[eax*4]
	push	ecx
	mov	edx, DWORD PTR _hLibrary$7803[ebp]
	push	edx
	call	_SysGetProc@8
	movsx	ecx, WORD PTR _k$7844[ebp]
	mov	edx, DWORD PTR _lpMQInterface$7801[ebp]
...
; 883  :             LPTASK lpTask = zGETPTR( vSubtask->hTask );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$7849[ebp], eax
...
; 886  :                               lpViewOD->szOperLibname, 0 );
	...
	mov	eax, DWORD PTR _vSubtask$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpTask$7849[ebp]
	push	ecx
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
$L7848:
