...
_nRC$ = -8
_lpParent$7537 = -24
_lpParentViewEntity$7538 = -28
_lpParent$7543 = -32
_lpViewSubobject$7547 = -36
_lpRecursViewEntity$7548 = -44
_lpParent$7549 = -40
...
; 118  :       lpParent           = zGETPTR( lpViewEntityCsr->hParent );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$7537[ebp], eax

; 119  :       lpParentViewEntity = zGETPTR( lpParent->hViewEntity );

	mov	eax, DWORD PTR _lpParent$7537[ebp]
	mov	ecx, DWORD PTR [eax+14]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParentViewEntity$7538[ebp], eax

; 120  : 
; 121  :       zstrcpy( pchReturnString, lpParentViewEntity->szName );

	mov	edx, DWORD PTR _lpParentViewEntity$7538[ebp]
...
; 131  :       lpParent = zGETPTR( lpViewEntity->hParent );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$7543[ebp], eax

; 132  :       zstrcpy( pchReturnString, lpParent->szName );

	mov	ecx, DWORD PTR _lpParent$7543[ebp]
...
; 143  :       lpViewSubobject = zGETPTR( lpViewCsr->hFirstViewSubobject );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewSubobject$7547[ebp], eax

; 144  :       if ( lpViewSubobject->hRecursViewEntity )

	mov	eax, DWORD PTR _lpViewSubobject$7547[ebp]
	cmp	DWORD PTR [eax+36], 0
	je	SHORT $L7551

; 146  :          lpRecursViewEntity = zGETPTR( lpViewSubobject->hRecursViewEntity );

	mov	ecx, DWORD PTR _lpViewSubobject$7547[ebp]
	mov	edx, DWORD PTR [ecx+36]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpRecursViewEntity$7548[ebp], eax

; 147  :          lpParent           = zGETPTR( lpRecursViewEntity->hParent );

	mov	eax, DWORD PTR _lpRecursViewEntity$7548[ebp]
	mov	ecx, DWORD PTR [eax+10]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$7549[ebp], eax

; 148  :          zstrcpy( pchReturnString, lpParent->szName );

	mov	edx, DWORD PTR _lpParent$7549[ebp]
	add	edx, 14					; 0000000eH
	push	edx
	mov	eax, DWORD PTR _pchReturnString$[ebp]
	push	eax
...
; 525  :          LPENTITYINSTANCE lpPrevVsn = zGETPTR( lpEntityInstance->hPrevVsn );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpPrevVsn$7678[ebp], eax

; 526  : 
; 527  :          if ( lpPrevVsn->u.nInd.bPrevVsnRoot )

	mov	eax, DWORD PTR _lpPrevVsn$7678[ebp]
...
; 736  :       if ( nRC )
	...
	movsx	eax, WORD PTR _nRC$7736[ebp]
	test	eax, eax
	je	SHORT $L7741
...
; 1121 :       lpViewEntity = zGETPTR( lpEntityInstance->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$7862[ebp], eax

; 1122 :       if ( lpViewEntity->bDerived ||
; 1123 :            lpViewEntity->bDerivedPath ||
; 1124 :            lpViewEntity->bHasDB_Oper ) // added Phil/Doug 2005.10.17

	mov	ecx, DWORD PTR _lpViewEntity$7862[ebp]
	mov	edx, DWORD PTR [ecx+235]
	shr	edx, 13					; 0000000dH
	and	edx, 1
	test	edx, edx
	jne	SHORT $L7867
	mov	eax, DWORD PTR _lpViewEntity$7862[ebp]
	mov	ecx, DWORD PTR [eax+235]
	shr	ecx, 14					; 0000000eH
	and	ecx, 1
	test	ecx, ecx
	jne	SHORT $L7867
	mov	edx, DWORD PTR _lpViewEntity$7862[ebp]
...
; 1234 :          zBOOL bSetTo = (lFlag & 0x00000002) ? 1 : 0;
	...
	sbb	edx, edx
	neg	edx
	mov	BYTE PTR _bSetTo$7904[ebp], dl
...
; 1239 :                        lpApp->szName, bSetTo == TRUE ? "ON" : "OFF" );
	...
	mov	eax, DWORD PTR _bSetTo$7904[ebp]
	and	eax, 255				; 000000ffH
	cmp	eax, 1
	jne	SHORT $L8039
