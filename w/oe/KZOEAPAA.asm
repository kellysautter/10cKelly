...
; 97   :       LPSUBTASK lpSubtask = zGETPTR( lpView->hSubtask );
	...
	mov	DWORD PTR _lpSubtask$7533[ebp], eax

; 98   : 
; 99   :       lpApp = lpSubtask->hApp;

	mov	ecx, DWORD PTR _lpSubtask$7533[ebp]
...
; 104  :       LPVIEWOD lpViewOD = zGETPTR( lpView->hViewOD );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOD$7537[ebp], eax

; 105  : 
; 106  :       lpApp = lpViewOD->hApp;

	mov	eax, DWORD PTR _lpViewOD$7537[ebp]
...
; 177  :       LPSUBTASK lpSubtask = zGETPTR( lpView->hSubtask );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSubtask$7564[ebp], eax

; 178  :       *lpApp = zGETPTR( lpSubtask->hApp );

	mov	ecx, DWORD PTR _lpSubtask$7564[ebp]
	mov	edx, DWORD PTR [ecx+10]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	ecx, DWORD PTR _lpApp$[ebp]
...
; 187  :       lpViewCsr = zGETPTR( lpView->hViewCsr );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$7569[ebp], eax

; 188  :       lpViewOI  = zGETPTR( lpViewCsr->hViewOI );

	mov	edx, DWORD PTR _lpViewCsr$7569[ebp]
	mov	eax, DWORD PTR [edx+10]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOI$7571[ebp], eax

; 189  :       lpViewOD  = zGETPTR( lpViewOI->hViewOD );

	mov	ecx, DWORD PTR _lpViewOI$7571[ebp]
	mov	edx, DWORD PTR [ecx+6]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOD$7570[ebp], eax

; 190  :       *lpApp    = zGETPTR( lpViewOD->hApp );

	mov	eax, DWORD PTR _lpViewOD$7570[ebp]
	mov	ecx, DWORD PTR [eax+6]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	edx, DWORD PTR _lpApp$[ebp]
...
; 200  :       LPVIEWOD lpViewOD = zGETPTR( lpView->hViewOD );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOD$7578[ebp], eax

; 201  :       *lpApp = zGETPTR( lpViewOD->hApp );

	mov	eax, DWORD PTR _lpViewOD$7578[ebp]
	mov	ecx, DWORD PTR [eax+6]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	edx, DWORD PTR _lpApp$[ebp]
...
; 206  :       LPTASK lpTask = zGETPTR( lpView->hTask );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$7583[ebp], eax

; 207  :       *lpApp = zGETPTR( lpTask->hApp );

	mov	eax, DWORD PTR _lpTask$7583[ebp]
	mov	ecx, DWORD PTR [eax+10]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	edx, DWORD PTR _lpApp$[ebp]
...
; 211  :       LPTASK lpTask = zGETPTR( lpView->hTask );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$7587[ebp], eax
...
; 218  :       fnIssueCoreError( lpTask, lpView, 8, 107, 0, 0, 0 );
	...
	mov	eax, DWORD PTR _lpView$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpTask$7587[ebp]
	push	ecx
...
_hContext$7880 = -1188
_k$7884 = -1192
_lpTempTable$7915 = -1196
_lpCurrContext$8039 = -1204
_lpNextContext$8040 = -1200
...
; 852  :       zSHORT k = zstrlen( szWorkString );
	...
	call	_strlen
	add	esp, 4
	mov	WORD PTR _k$7861[ebp], ax
$L7863:

; 853  :       while( k-- )

	movsx	eax, WORD PTR _k$7861[ebp]
	mov	cx, WORD PTR _k$7861[ebp]
	sub	cx, 1
	mov	WORD PTR _k$7861[ebp], cx
	test	eax, eax
	je	SHORT $L7864

; 855  :          if ( szWorkString[ k ] == ' ' )

	movsx	edx, WORD PTR _k$7861[ebp]
...
; 856  :             szWorkString[ k ] = '_';
	...
	movsx	ecx, WORD PTR _k$7861[ebp]
...
; 947  :          for ( k = 0; !zisspace( pchLine[ k + 1 ] ) && pchLine[ k + 1 ]; k++ )
	...
	mov	WORD PTR _k$7884[ebp], 0
	jmp	SHORT $L7885
$L7886:
	mov	cx, WORD PTR _k$7884[ebp]
	add	cx, 1
	mov	WORD PTR _k$7884[ebp], cx
$L7885:
	mov	edx, DWORD PTR __imp____mb_cur_max
	cmp	DWORD PTR [edx], 1
	jle	SHORT $L8388
	push	8
	movsx	eax, WORD PTR _k$7884[ebp]
	mov	ecx, DWORD PTR _pchLine$[ebp]
...
$L8389:
	...
	jne	SHORT $L7887
	movsx	ecx, WORD PTR _k$7884[ebp]
	mov	edx, DWORD PTR _pchLine$[ebp]
...
; 948  :             szAttrName[ k ] = pchLine[ k + 1 ];
	...
	movsx	ecx, WORD PTR _k$7884[ebp]
	movsx	edx, WORD PTR _k$7884[ebp]
	mov	eax, DWORD PTR _pchLine$[ebp]
...
; 981  :                                            sizeof( DomainRecord ), 1, 0, iDomain );
	...
	call	_fnAllocDataspace
	add	esp, 20					; 00000014H
	mov	DWORD PTR _hDomain$7879[ebp], eax

; 982  : 
; 983  :                if ( hDomain )

	cmp	DWORD PTR _hDomain$7879[ebp], 0
	je	SHORT $L7900

; 985  :                   lpDomain = zGETPTR( hDomain );

	mov	ecx, DWORD PTR _hDomain$7879[ebp]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
...
; 989  :                   lpApp->hFirstDomain = hDomain;
	...
	mov	ecx, DWORD PTR _lpApp$[ebp]
	mov	edx, DWORD PTR _hDomain$7879[ebp]
...
; 1010 :                                             iContext );
	...
	call	_fnAllocDataspace
	add	esp, 20					; 00000014H
	mov	DWORD PTR _hContext$7880[ebp], eax

; 1011 :                if ( hContext )

	cmp	DWORD PTR _hContext$7880[ebp], 0
	je	SHORT $L7905

; 1013 :                   lpContext = zGETPTR( hContext );

	mov	eax, DWORD PTR _hContext$7880[ebp]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
...
; 1017 :                   lpDomain->hFirstContext = hContext;
	...
	mov	ecx, DWORD PTR _lpDomain$[ebp]
	mov	edx, DWORD PTR _hContext$7880[ebp]
...
; 1052 :                      lpTempTable = zGETPTR( lpContext->hLastTableEntry );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempTable$7915[ebp], eax

; 1053 :                      lpTempTable->hNextTableEntry = hTemp;

	mov	eax, DWORD PTR _lpTempTable$7915[ebp]
	mov	ecx, DWORD PTR _hTemp$[ebp]
...
; 1173 :                   {
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR $L8391[edx]
	jmp	DWORD PTR $L8392[ecx*4]
$L7951:
...
; 1254 :                   {
	...
	xor	ecx, ecx
	mov	cl, BYTE PTR $L8393[edx]
	jmp	DWORD PTR $L8394[ecx*4]
$L7985:
...
; 1428 :       lpCurrContext = 0;   // last valid context, 0 means at head of queue
	...
	mov	DWORD PTR _lpCurrContext$8039[ebp], 0
...
; 1431 :             lpContext = zGETPTR( lpNextContext ) )
	...
	jmp	SHORT $L8047
$L8048:
	mov	ecx, DWORD PTR _lpNextContext$8040[ebp]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpContext$[ebp], eax
$L8047:
...
; 1433 :          lpNextContext = lpContext->hNextContext;
	...
	mov	DWORD PTR _lpNextContext$8040[ebp], eax
...
; 1461 :             if ( lpCurrContext )
	...
	cmp	DWORD PTR _lpCurrContext$8039[ebp], 0
	je	SHORT $L8062

; 1462 :                lpCurrContext->hNextContext = lpNextContext;

	mov	eax, DWORD PTR _lpCurrContext$8039[ebp]
	mov	ecx, DWORD PTR _lpNextContext$8040[ebp]
	mov	DWORD PTR [eax+2], ecx
...
; 1464 :                lpDomain->hFirstContext = lpNextContext;
	...
	mov	edx, DWORD PTR _lpDomain$[ebp]
	mov	eax, DWORD PTR _lpNextContext$8040[ebp]
	mov	DWORD PTR [edx+47], eax
$L8063:
...
; 1469 :          lpCurrContext = lpContext; // indicate curr context as valid
	...
	mov	ecx, DWORD PTR _lpContext$[ebp]
	mov	DWORD PTR _lpCurrContext$8039[ebp], ecx
...
; 1588 :          lpTempTable = zGETPTR( lpTableEntry->hNextTableEntry );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempTable$8091[ebp], eax

; 1589 :          lpTempTable->hPrevTableEntry = lpTableEntry->hPrevTableEntry;

	mov	eax, DWORD PTR _lpTempTable$8091[ebp]
	mov	ecx, DWORD PTR _lpTableEntry$[ebp]
	mov	edx, DWORD PTR [ecx+6]
...
_lpDomain$ = 8
_lpContext$8107 = -8
_lpTableEntry$8108 = -12
_lpRegExpression$8109 = -4
...
; 1649 :       lpContext = zGETPTR( lpDomain->hFirstContext );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpContext$8107[ebp], eax
$L8112:

; 1650 :       while ( lpContext->hFirstTableEntry )

	mov	eax, DWORD PTR _lpContext$8107[ebp]
	cmp	DWORD PTR [eax+47], 0
	je	SHORT $L8113

; 1652 :          lpTableEntry = zGETPTR( lpContext->hFirstTableEntry );

	mov	ecx, DWORD PTR _lpContext$8107[ebp]
	mov	edx, DWORD PTR [ecx+47]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTableEntry$8108[ebp], eax

; 1653 :          lpContext->hFirstTableEntry = lpTableEntry->hNextTableEntry;

	mov	eax, DWORD PTR _lpContext$8107[ebp]
	mov	ecx, DWORD PTR _lpTableEntry$8108[ebp]
	mov	edx, DWORD PTR [ecx+2]
	mov	DWORD PTR [eax+47], edx
...
; 1654 :          fnDropTableEntry( lpContext, lpTableEntry, 0 );
	...
	push	0
	mov	eax, DWORD PTR _lpTableEntry$8108[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpContext$8107[ebp]
	push	ecx
	call	_fnDropTableEntry
...
; 1658 :       while ( lpContext->hFirstRegExpression )
	...
	mov	edx, DWORD PTR _lpContext$8107[ebp]
...
; 1660 :          lpRegExpression = zGETPTR( lpContext->hFirstRegExpression );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpRegExpression$8109[ebp], eax

; 1661 :          lpContext->hFirstRegExpression = lpRegExpression->hNextRegExpression;

	mov	edx, DWORD PTR _lpContext$8107[ebp]
	mov	eax, DWORD PTR _lpRegExpression$8109[ebp]
	mov	ecx, DWORD PTR [eax+2]
	mov	DWORD PTR [edx+55], ecx

; 1662 :          fnFreeDataspace( lpRegExpression );

	mov	edx, DWORD PTR _lpRegExpression$8109[ebp]
	push	edx
	call	_fnFreeDataspace
	add	esp, 4
...
; 1761 :             LPVIEWOD lpViewOD = zGETPTR( lpView->hViewOD );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOD$8171[ebp], eax

; 1762 : 
; 1763 :             // Kick out if ViewOD is connected to app.
; 1764 :             if ( lpViewOD->hApp == hApp )

	mov	ecx, DWORD PTR _lpViewOD$8171[ebp]
	mov	edx, DWORD PTR [ecx+6]
...
; 1864 :          LPVIEWOD lpViewOD = zGETPTR( lpViewOI->hViewOD );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOD$8217[ebp], eax

; 1865 : 
; 1866 :          if ( lpViewOD->hApp == hApp )

	mov	edx, DWORD PTR _lpViewOD$8217[ebp]
	mov	eax, DWORD PTR [edx+6]
	cmp	eax, DWORD PTR _hApp$[ebp]
	jne	SHORT $L8219
...
; 1868 :             LPVIEWCSR lpViewCsr = zGETPTR( lpViewOI->hFirstViewCsr );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$8220[ebp], eax

; 1869 : 
; 1870 :             lpView   = zGETPTR( lpViewCsr->hView );

	mov	eax, DWORD PTR _lpViewCsr$8220[ebp]
	mov	ecx, DWORD PTR [eax+6]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpView$[ebp], eax
...
; 1974 :       while ( (hApp2 = lpPrevApp->hNextApp) != 0 )
	...
	mov	edx, DWORD PTR [ecx+2]
	mov	DWORD PTR _hApp2$8273[ebp], edx
	cmp	DWORD PTR _hApp2$8273[ebp], 0
	je	SHORT $L8277

; 1976 :          if ( hApp2 == hApp )

	mov	eax, DWORD PTR _hApp2$8273[ebp]
	cmp	eax, DWORD PTR _hApp$[ebp]
	jne	SHORT $L8278
