...
_nStartLevel$ = -64
_lpPrevVsn$7618 = -88
_lpOldViewEntity$7620 = -92
_lpNextVsn$7631 = -96
_lpOldViewEntity$7641 = -104
_lpNewViewEntity$7643 = -100
_lpOldParent$7649 = -108
_lpPrevTwin$7653 = -112
_lpWork$7657 = -116
...
; 338  :       LPENTITYINSTANCE lpPrevVsn = zGETPTR( lpOldInstance->hPrevVsn );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpPrevVsn$7618[ebp], eax
...
; 339  :       LPVIEWENTITY     lpOldViewEntity = zGETPTR( lpOldInstance->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpOldViewEntity$7620[ebp], eax
...
; 342  :            (lpPrevVsn && lpPrevVsn->u.nInd.bPrevVsnRoot) )
	...
	test	edx, edx
	jne	SHORT $L7623
	cmp	DWORD PTR _lpPrevVsn$7618[ebp], 0
	je	SHORT $L7622
	mov	eax, DWORD PTR _lpPrevVsn$7618[ebp]
	mov	ecx, DWORD PTR [eax+6]
	shr	ecx, 9
	and	ecx, 1
	test	ecx, ecx
...
; 355  :                               lpOldViewEntity->szName );
	...
	mov	eax, DWORD PTR _lpOldViewEntity$7620[ebp]
	add	eax, 14					; 0000000eH
	push	eax
...
; 374  :            lpOldInstance->hNextLinked )
	...
	test	eax, eax
	je	$L7635
	mov	ecx, DWORD PTR _lpOldViewEntity$7620[ebp]
...
; 385  :             LPENTITYINSTANCE lpNextVsn = zGETPTR( lpWrkInstance->hNextVsn );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpNextVsn$7631[ebp], eax

; 386  : 
; 387  :             if ( lpNextVsn &&
; 388  :                  lpNextVsn->hPersistRecord != lpOldInstance->hPersistRecord )

	cmp	DWORD PTR _lpNextVsn$7631[ebp], 0
	je	SHORT $L7633
	mov	eax, DWORD PTR _lpNextVsn$7631[ebp]
	mov	ecx, DWORD PTR _lpOldInstance$[ebp]
...
; 425  :       LPVIEWENTITY lpOldViewEntity = zGETPTR( lpOldInstance->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpOldViewEntity$7641[ebp], eax
...
; 446  :          LPENTITYINSTANCE lpOldParent = zGETPTR( lpOldInstance->hParent );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpOldParent$7649[ebp], eax
...
; 450  :          lpNewInstance->hParent   = lpOldParent->hNextVsn;
	...
	mov	eax, DWORD PTR _lpOldParent$7649[ebp]
...
; 458  :             lpPrevTwin = zGETPTR( lpOldInstance->hPrevTwin );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpPrevTwin$7653[ebp], eax

; 459  :             lpNewInstance->hPrevTwin = lpPrevTwin->hNextVsn;

	mov	edx, DWORD PTR _lpNewInstance$[ebp]
	mov	eax, DWORD PTR _lpPrevTwin$7653[ebp]
	mov	ecx, DWORD PTR [eax+34]
...
; 462  :             lpPrevTwin->hNextTwin = hInstance;
	...
	mov	ecx, DWORD PTR _lpPrevTwin$7653[ebp]
	mov	edx, DWORD PTR _hInstance$[ebp]
...
; 474  :             lpWork = zGETPTR( lpOldInstance->hPrevHier );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWork$7657[ebp], eax

; 475  :             lpWork->hNextHier = hInstance;

	mov	edx, DWORD PTR _lpWork$7657[ebp]
	mov	eax, DWORD PTR _hInstance$[ebp]
...
; 481  :             lpWork->hNextTwin = hInstance;
	...
	mov	ecx, DWORD PTR _lpWork$7657[ebp]
	mov	edx, DWORD PTR _hInstance$[ebp]
	mov	DWORD PTR [ecx+22], edx
$L7660:
...
; 487  :             lpWork->hPrevTwin = hInstance;
	...
	mov	eax, DWORD PTR _lpWork$7657[ebp]
...
; 523  :       lpNewViewEntity = zGETPTR( lpNewInstance->hViewEntity );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpNewViewEntity$7643[ebp], eax

; 524  :       if ( lpDupInstance || lpNewViewEntity->bUpdate == FALSE )

	cmp	DWORD PTR _lpDupInstance$[ebp], 0
	jne	SHORT $L7680
	mov	edx, DWORD PTR _lpNewViewEntity$7643[ebp]
...
; 529  :                  lpNewViewEntity->bUpdate )
	...
	jne	SHORT $L7688
	mov	ecx, DWORD PTR _lpNewViewEntity$7643[ebp]
	mov	edx, DWORD PTR [ecx+235]
	shr	edx, 2
	and	edx, 1
	test	edx, edx
...
; 533  :                                         (zPCHAR) zGETPTR( lpOldInstance->hPersistRecord ), 1 );
	...
	call	DWORD PTR _g_pfnGetPtr
	push	eax
	mov	edx, DWORD PTR _lpOldViewEntity$7641[ebp]
	push	edx
...
; 556  :                                   (zPCHAR) zGETPTR( lpOldInstance->hPersistRecord ), 1 );
	...
	call	DWORD PTR _g_pfnGetPtr
	push	eax
	mov	eax, DWORD PTR _lpOldViewEntity$7641[ebp]
	push	eax
...
; 751  :          lpPrevVsn = zGETPTR( lpRoot->hPrevVsn );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpPrevVsn$7747[ebp], eax
...
; 753  :               (lpPrevVsn && lpPrevVsn->u.nInd.bPrevVsnRoot) )
	...
	test	ecx, ecx
	jne	SHORT $L7752
	cmp	DWORD PTR _lpPrevVsn$7747[ebp], 0
	je	$L7751
	mov	edx, DWORD PTR _lpPrevVsn$7747[ebp]
	mov	eax, DWORD PTR [edx+6]
	shr	eax, 9
	and	eax, 1
	test	eax, eax
...
_szRel$ = -260
_un$7830 = -272
_lpRPViewEntity$7837 = -280
_vErrView$7838 = -276
_lpScanViewEntity$7840 = -292
_nVEStopLevel$7841 = -284
_nVELevel$7842 = -288
...
; 951  :       if ( uMin && un < uMin )
	...
	test	edx, edx
	je	SHORT $L7831
	mov	eax, DWORD PTR _un$7830[ebp]
	and	eax, 65535				; 0000ffffH
...
; 971  :       lpRPViewEntity = fnGetRecurseParentEntity( lpViewEntity );
	...
	add	esp, 4
	mov	DWORD PTR _lpRPViewEntity$7837[ebp], eax

; 972  :       if ( lpRPViewEntity->bRequiredChild )

	mov	eax, DWORD PTR _lpRPViewEntity$7837[ebp]
...
; 975  :          zSHORT         nVEStopLevel = lpRPViewEntity->nLevel;
	...
	mov	edx, DWORD PTR _lpRPViewEntity$7837[ebp]
	mov	ax, WORD PTR [edx+215]
	mov	WORD PTR _nVEStopLevel$7841[ebp], ax

; 976  :          zSHORT         nVELevel = nVEStopLevel + 1;

	movsx	ecx, WORD PTR _nVEStopLevel$7841[ebp]
	add	ecx, 1
	mov	WORD PTR _nVELevel$7842[ebp], cx
...
; 978  :          lpScanViewEntity = zGETPTR( lpRPViewEntity->hNextHier );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpScanViewEntity$7840[ebp], eax
$L7845:

; 979  :          while ( lpScanViewEntity &&
; 980  :                  lpScanViewEntity->nLevel > nVEStopLevel )

	cmp	DWORD PTR _lpScanViewEntity$7840[ebp], 0
	je	$L7846
	mov	ecx, DWORD PTR _lpScanViewEntity$7840[ebp]
	movsx	edx, WORD PTR [ecx+215]
	movsx	eax, WORD PTR _nVEStopLevel$7841[ebp]
	cmp	edx, eax
	jle	$L7846
...
; 983  :                  lpScanViewEntity->uCardMin )
	...
	mov	ecx, DWORD PTR _lpScanViewEntity$7840[ebp]
	movsx	edx, WORD PTR [ecx+215]
	movsx	eax, WORD PTR _nVELevel$7842[ebp]
	cmp	edx, eax
	jne	$L7847
	mov	ecx, DWORD PTR _lpScanViewEntity$7840[ebp]
	xor	edx, edx
...
; 985  :                CreateViewFromViewForTask( &vErrView, lpView, 0 );
	...
	mov	eax, DWORD PTR _lpView$[ebp]
	push	eax
	lea	ecx, DWORD PTR _vErrView$7838[ebp]
	push	ecx
	call	_CreateViewFromViewForTask@12
...
; 986  :                fnEstablishViewForInstance( vErrView, 0, lpEntityInstance );
	...
	push	edx
	push	0
	mov	eax, DWORD PTR _vErrView$7838[ebp]
	push	eax
	call	_fnEstablishViewForInstance
	add	esp, 12					; 0000000cH
...
; 987  :                SetNameForView( vErrView, "KZOEE106", lpView, zLEVEL_TASK );
	...
	mov	edx, DWORD PTR _vErrView$7838[ebp]
	push	edx
...
; 993  :                strcat( szRel, lpScanViewEntity->szName );
	...
	mov	edx, DWORD PTR _lpScanViewEntity$7840[ebp]
	add	edx, 14					; 0000000eH
	push	edx
...
_bCount$ = -284
_szRel$ = -272
_lpRPViewEntity$7877 = -300
_lpViewEntity$7878 = -296
_lpNextHier$7880 = -304
_nRC$7898 = -308
...
; 1097 :          lpViewEntity = zGETPTR( lpWrkEI1->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$7878[ebp], eax
...
; 1102 :               lpViewEntity != lpWrkViewEntity2 )
	...
	test	ecx, ecx
	je	$L7885
	mov	edx, DWORD PTR _lpViewEntity$7878[ebp]
...
; 1130 :               lpWrkViewEntity2->nHierNbr == lpViewEntity->nHierNbr )
	...
	mov	ecx, DWORD PTR _lpWrkViewEntity2$[ebp]
	movsx	edx, WORD PTR [ecx+217]
	mov	eax, DWORD PTR _lpViewEntity$7878[ebp]
	movsx	ecx, WORD PTR [eax+217]
	cmp	edx, ecx
	jne	SHORT $L7890
...
; 1143 :                                                         lpWrkEI1, bCount );
	...
	mov	eax, DWORD PTR _lpWrkEI1$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpViewEntity$7878[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpView$[ebp]
	push	edx
...
; 1167 :          lpRPViewEntity = fnGetRecurseParentEntity( lpViewEntity );
	...
	call	_fnGetRecurseParentEntity
	add	esp, 4
	mov	DWORD PTR _lpRPViewEntity$7877[ebp], eax
...
; 1168 :          lpNextHier = zGETPTR( lpWrkEI1->hNextHier );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpNextHier$7880[ebp], eax

; 1169 :          if ( lpNextHier && lpNextHier->nLevel > nCurrLevel )

	cmp	DWORD PTR _lpNextHier$7880[ebp], 0
	je	SHORT $L7897
	mov	eax, DWORD PTR _lpNextHier$7880[ebp]
	movsx	ecx, WORD PTR [eax+58]
...
; 1174 :                                         (zBOOL) lpRPViewEntity->bRequiredChild );
	...
	mov	eax, DWORD PTR _lpRPViewEntity$7877[ebp]
	mov	ecx, DWORD PTR [eax+239]
	shr	ecx, 9
	and	ecx, 1
	push	ecx
...
; 1176 :             if ( nRC )
	...
	movsx	ecx, WORD PTR _nRC$7898[ebp]
	test	ecx, ecx
	je	SHORT $L7900

; 1177 :                return( nRC );

	mov	ax, WORD PTR _nRC$7898[ebp]
	jmp	$L7860
$L7900:
...
; 1187 :             lpWrkEI1 = lpNextHier;
	...
	mov	edx, DWORD PTR _lpNextHier$7880[ebp]
...
_lpWork$7997 = -100
_nUpdated$8022 = -108
_nUpdatedFile$8023 = -104
_lpPrevVsn$8050 = -112
_hOldInstance$8054 = -120
_hNewInstance$8056 = -116
_lpParent$8063 = -124
_lpNextVsn$8098 = -132
_lpNewViewEntity$8099 = -128
_lpLinked$8131 = -136
_lpPrevLinked$8132 = -140
_nUpdated$8143 = -148
_nUpdatedFile$8144 = -144
_lpViewEntity$8148 = -156
_lpViewEntityCsr$8149 = -160
_lpLastIncluded_NextHier$8150 = -152
_lpWorkViewCsr$8159 = -164
...
; 1415 :                                 zECE_ACCEPT, 0 );
	...
	add	esp, 20					; 00000014H
	mov	WORD PTR _n$7978[ebp], ax

; 1416 :       // If constraint handler doesn't like something, get out.
; 1417 :       if ( n )

	movsx	ecx, WORD PTR _n$7978[ebp]
	test	ecx, ecx
	je	SHORT $L7979
...
; 1503 :             LPVIEWENTITY lpWork = zGETPTR( lpNewInstance->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWork$7997[ebp], eax
...
; 1508 :                               lpWork->szName );
	...
	mov	eax, DWORD PTR _lpWork$7997[ebp]
	add	eax, 14					; 0000000eH
	push	eax
	mov	ecx, DWORD PTR _lpViewEntity$[ebp]
	add	ecx, 14					; 0000000eH
...
; 1587 :          zSHORT nUpdated = 0;
	...
	mov	WORD PTR _nUpdated$8022[ebp], 0

; 1588 :          zSHORT nUpdatedFile = 0;

	mov	WORD PTR _nUpdatedFile$8023[ebp], 0
...
; 1591 :          fnGetResetUpdFlags( lpStartNewInstance, &nUpdated, &nUpdatedFile, 1 );
	...
	push	1
	lea	ecx, DWORD PTR _nUpdatedFile$8023[ebp]
	push	ecx
	lea	edx, DWORD PTR _nUpdated$8022[ebp]
	push	edx
	mov	eax, DWORD PTR _lpStartNewInstance$[ebp]
	push	eax
...
; 1688 :          LPENTITYINSTANCE lpPrevVsn = zGETPTR( lpNewInstance->hPrevVsn );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpPrevVsn$8050[ebp], eax
...
; 1690 :          lpPrevVsn->hNextVsn = zGETHNDL( lpNewInstance );
	...
	push	edx
	call	DWORD PTR _g_pfnGetHndl
	mov	ecx, DWORD PTR _lpPrevVsn$8050[ebp]
...
; 1699 :          zPVOID hOldInstance = zGETHNDL( lpOldInstance );
	...
	push	eax
	call	DWORD PTR _g_pfnGetHndl
	mov	DWORD PTR _hOldInstance$8054[ebp], eax
...
; 1700 :          zPVOID hNewInstance = zGETHNDL( lpNewInstance );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetHndl
	mov	DWORD PTR _hNewInstance$8056[ebp], eax
...
; 1729 :                      lpParent = zGETPTR( lpParent->hParent ) )
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$8063[ebp], eax
	jmp	SHORT $L8066
$L8067:
	mov	ecx, DWORD PTR _lpParent$8063[ebp]
	mov	edx, DWORD PTR [ecx+30]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$8063[ebp], eax
$L8066:
	cmp	DWORD PTR _lpParent$8063[ebp], 0
	je	SHORT $L8068

; 1731 :                   if ( lpParent == lpStartOldInstance )

	mov	eax, DWORD PTR _lpParent$8063[ebp]
	cmp	eax, DWORD PTR _lpStartOldInstance$[ebp]
	jne	SHORT $L8069
...
; 1741 :             if ( lpWrkInstance->hNextLinked == hOldInstance )
	...
	mov	ecx, DWORD PTR _lpWrkInstance$[ebp]
	mov	edx, DWORD PTR [ecx+42]
	cmp	edx, DWORD PTR _hOldInstance$8054[ebp]
	jne	SHORT $L8071
...
; 1753 :                     lpDupInstance->hNextLinked != hOldInstance )
	...
	mov	edx, DWORD PTR _lpDupInstance$[ebp]
	mov	eax, DWORD PTR [edx+42]
	cmp	eax, DWORD PTR _hNewInstance$8056[ebp]
	je	SHORT $L8076
	mov	ecx, DWORD PTR _lpDupInstance$[ebp]
	mov	edx, DWORD PTR [ecx+42]
	cmp	edx, DWORD PTR _hOldInstance$8054[ebp]
...
; 1768 :             if ( lpDupInstance->hNextLinked != hNewInstance )
	...
	mov	eax, DWORD PTR _lpDupInstance$[ebp]
	mov	ecx, DWORD PTR [eax+42]
	cmp	ecx, DWORD PTR _hNewInstance$8056[ebp]
	je	SHORT $L8079
...
; 1786 :                lpWrkInstance->hNextLinked = hNewInstance;
	...
	mov	eax, DWORD PTR _lpWrkInstance$[ebp]
	mov	ecx, DWORD PTR _hNewInstance$8056[ebp]
...
; 1794 :             lpWrkInstance->hNextLinked = hNewInstance;
	...
	mov	edx, DWORD PTR _lpWrkInstance$[ebp]
	mov	eax, DWORD PTR _hNewInstance$8056[ebp]
	mov	DWORD PTR [edx+42], eax
$L8085:
...
; 1833 :                                     zGETPTR( lpNewInstance->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpNewViewEntity$8099[ebp], eax
...
; 1844 :                lpNextVsn = zGETPTR( lpDupInstance->hNextVsn );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpNextVsn$8098[ebp], eax

; 1845 :                if ( lpNextVsn &&
; 1846 :                     zGETPTR( lpNextVsn->hPersistRecord ) == lpOldRecord )

	cmp	DWORD PTR _lpNextVsn$8098[ebp], 0
	je	SHORT $L8104
	mov	eax, DWORD PTR _lpNextVsn$8098[ebp]
	mov	ecx, DWORD PTR [eax+60]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	cmp	eax, DWORD PTR _lpOldRecord$[ebp]
...
; 1924 :                lpLinked = zGETPTR( lpLinked->hNextLinked ) )
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpLinked$8131[ebp], eax
	jmp	SHORT $L8135
$L8136:
	mov	ecx, DWORD PTR _lpLinked$8131[ebp]
	mov	edx, DWORD PTR [ecx+42]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpLinked$8131[ebp], eax
$L8135:
	mov	eax, DWORD PTR _lpLinked$8131[ebp]
	cmp	eax, DWORD PTR _lpOldInstance$[ebp]
	je	SHORT $L8137
...
; 1927 :             lpPrevLinked = lpLinked;
	...
	mov	edx, DWORD PTR _lpLinked$8131[ebp]
	mov	DWORD PTR _lpPrevLinked$8132[ebp], edx
...
; 1931 :          if ( zGETPTR( lpOldInstance->hNextLinked ) == lpPrevLinked )
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	cmp	eax, DWORD PTR _lpPrevLinked$8132[ebp]
	jne	SHORT $L8139
...
; 1935 :             lpPrevLinked->hNextLinked = 0;
	...
	mov	edx, DWORD PTR _lpPrevLinked$8132[ebp]
...
; 1938 :             lpPrevLinked->hNextLinked = lpOldInstance->hNextLinked;
	...
	mov	eax, DWORD PTR _lpPrevLinked$8132[ebp]
	mov	ecx, DWORD PTR _lpOldInstance$[ebp]
	mov	edx, DWORD PTR [ecx+42]
	mov	DWORD PTR [eax+42], edx
$L8140:
...
; 1950 :       zSHORT nUpdated = 0;
	...
	mov	WORD PTR _nUpdated$8143[ebp], 0

; 1951 :       zSHORT nUpdatedFile = 0;

	mov	WORD PTR _nUpdatedFile$8144[ebp], 0

; 1952 : 
; 1953 :       fnGetResetUpdFlags( lpStartNewInstance, &nUpdated, &nUpdatedFile, 1 );

	push	1
	lea	edx, DWORD PTR _nUpdatedFile$8144[ebp]
	push	edx
	lea	eax, DWORD PTR _nUpdated$8143[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpStartNewInstance$[ebp]
	push	ecx
	call	_fnGetResetUpdFlags
...
; 1955 :       if ( nUpdated )
	...
	movsx	edx, WORD PTR _nUpdated$8143[ebp]
	test	edx, edx
	je	SHORT $L8145
...
; 1958 :       if ( nUpdatedFile )
	...
	movsx	eax, WORD PTR _nUpdatedFile$8144[ebp]
	test	eax, eax
	je	SHORT $L8146
...
; 1974 :       lpLastIncluded_NextHier = zGETPTR( lpLastIncluded->hNextHier );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpLastIncluded_NextHier$8150[ebp], eax
$L8153:

; 1975 :       while ( lpNewInstance != lpLastIncluded_NextHier )

	mov	ecx, DWORD PTR _lpNewInstance$[ebp]
	cmp	ecx, DWORD PTR _lpLastIncluded_NextHier$8150[ebp]
	je	$L8154
...
; 1986 :                LPVIEWCSR lpWorkViewCsr = zGETPTR( vWorkView->hViewCsr );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWorkViewCsr$8159[ebp], eax
...
; 1990 :                lpViewEntity = zGETPTR( lpNewInstance->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntity$8148[ebp], eax

; 1991 :                lpViewEntityCsr = zGETPTR( lpWorkViewCsr->hFirstOD_EntityCsr );

	mov	eax, DWORD PTR _lpWorkViewCsr$8159[ebp]
	mov	ecx, DWORD PTR [eax+14]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewEntityCsr$8149[ebp], eax

; 1992 :                lpViewEntityCsr += ( lpViewEntity->nHierNbr - 1 );

	mov	edx, DWORD PTR _lpViewEntity$8148[ebp]
	movsx	eax, WORD PTR [edx+217]
	sub	eax, 1
	imul	eax, 30					; 0000001eH
	mov	ecx, DWORD PTR _lpViewEntityCsr$8149[ebp]
	add	ecx, eax
	mov	DWORD PTR _lpViewEntityCsr$8149[ebp], ecx
...
; 1994 :                                           lpNewInstance );
	...
	mov	edx, DWORD PTR _lpNewInstance$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpViewEntityCsr$8149[ebp]
	push	eax
	mov	ecx, DWORD PTR _vWorkView$[ebp]
	push	ecx
	call	_fnEstablishViewForInstance
...
; 2010 :                                                 1 );
	...
	mov	eax, DWORD PTR _lpViewEntityCsr$8149[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpViewEntity$8148[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpViewOI$[ebp]
	push	edx
	mov	eax, DWORD PTR _vWorkView$[ebp]
...
_nRC$8229 = -88
_n$8232 = -92
_lpNewViewEntity$8249 = -96
_lpLinked$8253 = -100
_nLevel$8259 = -104
_lpLinkedChild$8260 = -108
_lpNextLinked$8276 = -112
_lpWrkInstance2$8314 = -116
...
; 2184 :          nRC = zCALL_ERROR;
	...
	mov	WORD PTR _nRC$8229[ebp], -16		; fffffff0H
...
; 2201 :                                 zECE_CANCEL, 0 );
	...
	call	_fnInvokeECEOperation
	add	esp, 20					; 00000014H
	mov	WORD PTR _n$8232[ebp], ax

; 2202 :       // If constraint handler doesn't like something, get out.
; 2203 :       if ( n )

	movsx	edx, WORD PTR _n$8232[ebp]
	test	edx, edx
	je	SHORT $L8233
...
; 2241 :          LPVIEWENTITY lpNewViewEntity = zGETPTR( lpNewInstance->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpNewViewEntity$8249[ebp], eax
...
; 2246 :                            lpNewViewEntity->szName );
	...
	mov	ecx, DWORD PTR _lpNewViewEntity$8249[ebp]
	add	ecx, 14					; 0000000eH
	push	ecx
	mov	edx, DWORD PTR _lpViewEntity$[ebp]
	add	edx, 14					; 0000000eH
...
; 2271 :       lpLinked = zGETPTR( lpNewInstance->hNextLinked );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpLinked$8253[ebp], eax
...
; 2275 :       if ( lpLinked )
	...
	cmp	DWORD PTR _lpLinked$8253[ebp], 0
	je	$L8258
$L8257:

; 2277 :          while ( lpLinked != lpNewInstance )

	mov	ecx, DWORD PTR _lpLinked$8253[ebp]
	cmp	ecx, DWORD PTR _lpNewInstance$[ebp]
	je	$L8258
...
; 2282 :             nLevel = lpLinked->nLevel;
	...
	mov	edx, DWORD PTR _lpLinked$8253[ebp]
	mov	ax, WORD PTR [edx+58]
	mov	WORD PTR _nLevel$8259[ebp], ax

; 2283 :             lpLinkedChild = lpLinked;

	mov	ecx, DWORD PTR _lpLinked$8253[ebp]
	mov	DWORD PTR _lpLinkedChild$8260[ebp], ecx
$L8261:

; 2286 :                if ( lpLinkedChild->u.nInd.bHidden == FALSE )

	mov	edx, DWORD PTR _lpLinkedChild$8260[ebp]
	mov	eax, DWORD PTR [edx+6]
	shr	eax, 10					; 0000000aH
	and	eax, 1
	test	eax, eax
...
; 2288 :                   lpLinkedChild->u.nIndicators = 0;
	...
	mov	ecx, DWORD PTR _lpLinkedChild$8260[ebp]
...
; 2294 :                lpLinkedChild = zGETPTR( lpLinkedChild->hNextHier );
	...
	mov	eax, DWORD PTR _lpLinkedChild$8260[ebp]
	mov	ecx, DWORD PTR [eax+14]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpLinkedChild$8260[ebp], eax

; 2295 : 
; 2296 :             }  while ( lpLinkedChild && lpLinkedChild->nLevel > nLevel );

	cmp	DWORD PTR _lpLinkedChild$8260[ebp], 0
	je	SHORT $L8266
	mov	edx, DWORD PTR _lpLinkedChild$8260[ebp]
	movsx	eax, WORD PTR [edx+58]
	movsx	ecx, WORD PTR _nLevel$8259[ebp]
	cmp	eax, ecx
	jg	SHORT $L8261
$L8266:
...
; 2329 :       LPENTITYINSTANCE lpNextLinked = zGETPTR( lpNewInstance->hNextLinked );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpNextLinked$8276[ebp], eax
...
; 2334 :       if ( lpNextLinked )
	...
	cmp	DWORD PTR _lpNextLinked$8276[ebp], 0
	je	SHORT $L8278

; 2336 :          lpDupInstance = lpNextLinked;

	mov	edx, DWORD PTR _lpNextLinked$8276[ebp]
	mov	DWORD PTR _lpDupInstance$[ebp], edx
$L8281:
...
; 2340 :          if ( lpDupInstance == lpNextLinked )
	...
	mov	ecx, DWORD PTR _lpDupInstance$[ebp]
	cmp	ecx, DWORD PTR _lpNextLinked$8276[ebp]
	jne	SHORT $L8284
...
; 2432 :       lpWrkInstance2 = zGETPTR( lpLastNewInstance->hNextHier );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWrkInstance2$8314[ebp], eax
...
; 2433 :       lpWrkInstance2->hPrevHier = zGETHNDL( lpLastOldInstance );
	...
	push	edx
	call	DWORD PTR _g_pfnGetHndl
	mov	ecx, DWORD PTR _lpWrkInstance2$8314[ebp]
	mov	DWORD PTR [ecx+18], eax
...
_lpViewOD$8429 = -520
_szDebug$8443 = -724
_lpTgtAttrib$8459 = -732
_lpSrcAttrib$8460 = -728
_szMsg$8474 = -988
_lpViewOD$8475 = -736
_lpSrcInstance$8492 = -996
_lpTgtParent$8493 = -992
_lpPrevVsn$8506 = -1004
_lpParentCsr$8507 = -1000
_lpTemp$8534 = -1008
_lpWorkView$8540 = -1012
_lpWorkViewEntity$8541 = -1020
_lpWorkViewEntityCsr$8542 = -1016
_n$8543 = -1024
...
; 2745 :                 lpTgtViewOD->szName, lpTgtViewOD->szER_Date );
	...
	lea	eax, DWORD PTR _szMsg$8421[ebp]
	push	eax
...
; 2746 :       TraceLineS( "ERROR: ", szMsg );
	...
	lea	ecx, DWORD PTR _szMsg$8421[ebp]
	push	ecx
	push	OFFSET FLAT:??_C@_07JCPH@ERROR?3?5?$AA@	; `string'
	call	_TraceLineS@8
...
; 2750 :       TraceLineS( "ERROR: ", szMsg );
	...
	lea	edx, DWORD PTR _szMsg$8421[ebp]
	push	edx
	push	OFFSET FLAT:??_C@_07JCPH@ERROR?3?5?$AA@	; `string'
	call	_TraceLineS@8
...
; 2773 :       lpViewOD = zGETPTR( lpTgtView->hViewOD );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOD$8429[ebp], eax
...
; 2774 :       zsprintf( szMsg, "%s.%s", lpViewOD->szName, lpTgtViewEntity->szName );
	...
	add	edx, 14					; 0000000eH
	push	edx
	mov	eax, DWORD PTR _lpViewOD$8429[ebp]
	add	eax, 10					; 0000000aH
	push	eax
	push	OFFSET FLAT:??_C@_05OGKG@?$CFs?4?$CFs?$AA@ ; `string'
	lea	ecx, DWORD PTR _szMsg$8428[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 16					; 00000010H
...
; 2775 :       TraceLineS( "   Target entity = ", szMsg );
	...
	lea	edx, DWORD PTR _szMsg$8428[ebp]
	push	edx
...
; 2815 :          SysReadZeidonIni( -1, "[Debug]", "BombZDr", szDebug );
	...
	lea	edx, DWORD PTR _szDebug$8443[ebp]
	push	edx
...
; 2817 :       if ( k == 0 && szDebug[ 0 ] == 'Y' )
	...
	test	eax, eax
	jne	$L8447
	movsx	ecx, BYTE PTR _szDebug$8443[ebp]
...
; 2875 :             lpTgtAttrib = zGETPTR( lpTgtAttrib->hNextOD_Attrib ) )
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtAttrib$8459[ebp], eax
	jmp	SHORT $L8463
$L8464:
	mov	edx, DWORD PTR _lpTgtAttrib$8459[ebp]
	mov	eax, DWORD PTR [edx+2]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtAttrib$8459[ebp], eax
$L8463:
	cmp	DWORD PTR _lpTgtAttrib$8459[ebp], 0
	je	$L8465

; 2877 :          // We only care about persistent attributes.
; 2878 :          if ( lpTgtAttrib->bPersist == FALSE )

	mov	ecx, DWORD PTR _lpTgtAttrib$8459[ebp]
...
; 2884 :                lpSrcAttrib = zGETPTR( lpSrcAttrib->hNextOD_Attrib ) )
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcAttrib$8460[ebp], eax
	jmp	SHORT $L8469
$L8470:
	mov	edx, DWORD PTR _lpSrcAttrib$8460[ebp]
	mov	eax, DWORD PTR [edx+2]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcAttrib$8460[ebp], eax
$L8469:
	cmp	DWORD PTR _lpSrcAttrib$8460[ebp], 0
	je	SHORT $L8471
	mov	ecx, DWORD PTR _lpSrcAttrib$8460[ebp]
	mov	edx, DWORD PTR _lpTgtAttrib$8459[ebp]
...
; 2899 :                lpViewOD = (LPVIEWOD) zGETPTR( lpSrcView->hViewOD );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOD$8475[ebp], eax
...
; 2905 :                          lpSrcAttrib->ulRecordOffset );
	...
	mov	eax, DWORD PTR _lpSrcAttrib$8460[ebp]
...
; 2906 :                TraceLineS( "(so) IncludeSubobject Src ", szMsg );
	...
	lea	eax, DWORD PTR _szMsg$8474[ebp]
	push	eax
...
; 2916 :                       lpTgtAttrib->ulRecordOffset );
	...
	mov	eax, DWORD PTR _lpTgtAttrib$8459[ebp]
	mov	ecx, DWORD PTR [eax+250]
	push	ecx
	mov	edx, DWORD PTR _lpTgtAttrib$8459[ebp]
	add	edx, 10					; 0000000aH
...
; 2956 :       lpSrcInstance = zGETPTR( lpSrcViewEntityCsr->hEntityInstance );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcInstance$8492[ebp], eax
...
; 2962 :            lpSrcViewOI != lpTgtViewOI )
	...
	mov	edx, DWORD PTR _lpSrcInstance$8492[ebp]
	mov	eax, DWORD PTR [edx+6]
	shr	eax, 11					; 0000000bH
	and	eax, 1
	test	eax, eax
...
; 2972 :       while ( lpSrcInstance->hPrevVsn )
	...
	mov	eax, DWORD PTR _lpSrcInstance$8492[ebp]
	cmp	DWORD PTR [eax+38], 0
	je	SHORT $L8498

; 2973 :          lpSrcInstance = zGETPTR( lpSrcInstance->hPrevVsn );

	mov	ecx, DWORD PTR _lpSrcInstance$8492[ebp]
	mov	edx, DWORD PTR [ecx+38]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcInstance$8492[ebp], eax
...
; 2975 :       while ( lpSrcInstance )
	...
	cmp	DWORD PTR _lpSrcInstance$8492[ebp], 0
	je	SHORT $L8502
...
; 2996 :             lpPrevVsn = zGETPTR( lpSrcInstance->hPrevVsn );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpPrevVsn$8506[ebp], eax

; 2997 :             if ( (lpPrevVsn && lpPrevVsn->u.nInd.bPrevVsnRoot) ||
; 2998 :                  lpSrcInstance->u.nInd.bTemporal )

	cmp	DWORD PTR _lpPrevVsn$8506[ebp], 0
	je	SHORT $L8515
	mov	edx, DWORD PTR _lpPrevVsn$8506[ebp]
	mov	eax, DWORD PTR [edx+6]
	shr	eax, 9
	and	eax, 1
	test	eax, eax
...
; 3006 :          lpParentCsr = zGETPTR( lpTgtViewEntityCsr->hParent );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParentCsr$8507[ebp], eax

; 3007 :          if ( lpParentCsr->hEntityInstance == UNSET_CSR )

	mov	ecx, DWORD PTR _lpParentCsr$8507[ebp]
	cmp	DWORD PTR [ecx+26], 1
	jne	SHORT $L8519

; 3008 :             fnEstablishCursorForView( lpParentCsr );

	mov	edx, DWORD PTR _lpParentCsr$8507[ebp]
	push	edx
...
; 3010 :          lpTgtParent = zGETPTR( lpParentCsr->hEntityInstance );
	...
	mov	eax, DWORD PTR _lpParentCsr$8507[ebp]
	mov	ecx, DWORD PTR [eax+26]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtParent$8493[ebp], eax
$L8522:

; 3011 :          while ( lpTgtParent )

	cmp	DWORD PTR _lpTgtParent$8493[ebp], 0
	je	SHORT $L8523

; 3013 :             lpPrevVsn = zGETPTR( lpTgtParent->hPrevVsn );

	mov	edx, DWORD PTR _lpTgtParent$8493[ebp]
	mov	eax, DWORD PTR [edx+38]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpPrevVsn$8506[ebp], eax
...
; 3015 :                  lpTgtParent->u.nInd.bTemporal )
	...
	cmp	DWORD PTR _lpPrevVsn$8506[ebp], 0
	je	SHORT $L8527
	mov	ecx, DWORD PTR _lpPrevVsn$8506[ebp]
	mov	edx, DWORD PTR [ecx+6]
	shr	edx, 9
	and	edx, 1
	test	edx, edx
	jne	SHORT $L8526
$L8527:
	mov	eax, DWORD PTR _lpTgtParent$8493[ebp]
	mov	ecx, DWORD PTR [eax+6]
	shr	ecx, 11					; 0000000bH
	and	ecx, 1
	test	ecx, ecx
...
; 3023 :          if ( lpTgtParent == 0 || lpTgtParent != lpSrcInstance )
	...
	cmp	DWORD PTR _lpTgtParent$8493[ebp], 0
	je	SHORT $L8530
	mov	ecx, DWORD PTR _lpTgtParent$8493[ebp]
	cmp	ecx, DWORD PTR _lpSrcInstance$8492[ebp]
	je	SHORT $L8529
$L8530:
...
; 3026 :             lpSrcInstance = 0;
	...
	mov	DWORD PTR _lpSrcInstance$8492[ebp], 0
$L8532:
...
; 3031 :          LPVIEWENTITY lpTemp = zGETPTR( lpSrcInstance->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTemp$8534[ebp], eax
...
; 3037 :                            lpSrcViewEntity->szName );
	...
	add	eax, 14					; 0000000eH
	push	eax
	mov	ecx, DWORD PTR _lpTemp$8534[ebp]
	add	ecx, 14					; 0000000eH
	push	ecx
	push	0
	push	116					; 00000074H
...
; 3093 :       CreateViewFromViewForTask( &lpWorkView, lpTgtView, 0 );
	...
	mov	edx, DWORD PTR _lpTgtView$[ebp]
	push	edx
	lea	eax, DWORD PTR _lpWorkView$8540[ebp]
	push	eax
	call	_CreateViewFromViewForTask@12
...
; 3095 :                                             lpWorkView, cpcTgtEntityName, 0 );
	...
	mov	ecx, DWORD PTR _cpcTgtEntityName$[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpWorkView$8540[ebp]
	push	edx
	lea	eax, DWORD PTR _lpWorkViewEntityCsr$8542[ebp]
	push	eax
	call	_fnValidViewEntity@16
	mov	DWORD PTR _lpWorkViewEntity$8541[ebp], eax
...
; 3105 :                                    zECE_INCLUDE, 0 );
	...
	call	_fnInvokeECEOperation
	add	esp, 20					; 00000014H
	mov	WORD PTR _n$8543[ebp], ax

; 3106 :          // If constraint handler doesn't like something, get out.
; 3107 :          if ( n )

	movsx	edx, WORD PTR _n$8543[ebp]
	test	edx, edx
	je	SHORT $L8545
...
; 3114 :             fnSetViewFromView( lpTgtView, lpWorkView );
	...
	mov	eax, DWORD PTR _lpWorkView$8540[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpTgtView$[ebp]
	push	ecx
...
; 3122 :             fnDropView( lpWorkView );
	...
	mov	ecx, DWORD PTR _lpWorkView$8540[ebp]
	push	ecx
	call	_fnDropView@4
...
_lpSrcEI$8574 = -32
_lpTgtEI$8576 = -28
_lpViewAttrib$8578 = -36
_lpTgtViewAttrib$8584 = -40
...
; 3196 :       LPENTITYINSTANCE lpSrcEI = zGETPTR( lpSrcViewEntityCsr->hEntityInstance );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcEI$8574[ebp], eax
...
; 3197 :       LPENTITYINSTANCE lpTgtEI = zGETPTR( lpTgtViewEntityCsr->hEntityInstance );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtEI$8576[ebp], eax
...
; 3203 :             lpViewAttrib = zGETPTR( lpViewAttrib->hNextOD_Attrib ) )
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewAttrib$8578[ebp], eax
	jmp	SHORT $L8581
$L8582:
	mov	eax, DWORD PTR _lpViewAttrib$8578[ebp]
	mov	ecx, DWORD PTR [eax+2]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewAttrib$8578[ebp], eax
$L8581:
	cmp	DWORD PTR _lpViewAttrib$8578[ebp], 0
	je	$EndOfFunction$8572
...
; 3207 :          if ( lpViewAttrib->bPersist )
	...
	mov	edx, DWORD PTR _lpViewAttrib$8578[ebp]
...
; 3213 :                lpTgtViewAttrib = zGETPTR( lpTgtViewAttrib->hNextOD_Attrib ) )
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtViewAttrib$8584[ebp], eax
	jmp	SHORT $L8588
$L8589:
	mov	eax, DWORD PTR _lpTgtViewAttrib$8584[ebp]
	mov	ecx, DWORD PTR [eax+2]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtViewAttrib$8584[ebp], eax
$L8588:
	cmp	DWORD PTR _lpTgtViewAttrib$8584[ebp], 0
	je	SHORT $L8590

; 3215 :             if ( zstrcmp( lpTgtViewAttrib->szName,
; 3216 :                           lpViewAttrib->szName ) == 0 )

	mov	edx, DWORD PTR _lpTgtViewAttrib$8584[ebp]
	movsx	eax, BYTE PTR [edx+10]
	mov	ecx, DWORD PTR _lpViewAttrib$8578[ebp]
	...
	add	eax, 10					; 0000000aH
	push	eax
	mov	ecx, DWORD PTR _lpTgtViewAttrib$8584[ebp]
	add	ecx, 10					; 0000000aH
	push	ecx
	call	_strcmp
	add	esp, 8
...
_nResetCount$ = -24
_nRC$ = -20
_cpcEntityName$8640 = -168
_cpcEntityName$8643 = -268
_lpSrchParentViewEntity$8698 = -276
_lpSrchChildViewEntity$8699 = -272
_lpWkTgtViewEntity$8700 = -280
...
; 3298 :       strcpy( cpcEntityName, "\nEntity: \t" );
	...
	push	OFFSET FLAT:??_C@_0L@FACN@?6Entity?3?5?7?$AA@ ; `string'
	lea	ecx, DWORD PTR _cpcEntityName$8640[ebp]
	push	ecx
	call	_strcpy
	add	esp, 8
...
; 3314 :       strcpy( cpcEntityName, "\nEntity: \t" );
	...
	push	OFFSET FLAT:??_C@_0L@FACN@?6Entity?3?5?7?$AA@ ; `string'
	lea	eax, DWORD PTR _cpcEntityName$8643[ebp]
	push	eax
	call	_strcpy
	add	esp, 8
...
; 3315 :       strcat( cpcEntityName, lpTgtViewEntity->szName );
	...
	add	ecx, 14					; 0000000eH
	push	ecx
	lea	edx, DWORD PTR _cpcEntityName$8643[ebp]
	push	edx
	call	_strcat
	add	esp, 8
...
; 3470 :                            zGETPTR( lpWkTgtViewEntityCsr->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWkTgtViewEntity$8700[ebp], eax

; 3471 : 
; 3472 :                if ( lpWkTgtViewEntity->bRecursive )

	mov	eax, DWORD PTR _lpWkTgtViewEntity$8700[ebp]
	mov	ecx, DWORD PTR [eax+235]
	shr	ecx, 11					; 0000000bH
	and	ecx, 1
	test	ecx, ecx
...
; 3474 :                   SetViewToSubobject( lpTgtView, lpWkTgtViewEntity->szName );
	...
	mov	edx, DWORD PTR _lpWkTgtViewEntity$8700[ebp]
	add	edx, 14					; 0000000eH
	push	edx
	mov	eax, DWORD PTR _lpTgtView$[ebp]
	push	eax
...
; 3483 :                lpSrchParentViewEntity = zGETPTR( lpWkTgtViewEntity->hParent );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrchParentViewEntity$8698[ebp], eax
$L8705:

; 3484 :                while ( lpSrchParentViewEntity )

	cmp	DWORD PTR _lpSrchParentViewEntity$8698[ebp], 0
	je	$L8706

; 3486 :                   lpSrchChildViewEntity = zGETPTR( lpSrchParentViewEntity->hNextHier );

	mov	ecx, DWORD PTR _lpSrchParentViewEntity$8698[ebp]
	mov	edx, DWORD PTR [ecx+2]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrchChildViewEntity$8699[ebp], eax
$L8709:
...
; 3492 :                                        lpSrchParentViewEntity->lEREntTok ) )
	...
	cmp	DWORD PTR _lpSrchChildViewEntity$8699[ebp], 0
	je	SHORT $L8710
	mov	eax, DWORD PTR _lpSrchChildViewEntity$8699[ebp]
	movsx	ecx, WORD PTR [eax+215]
	mov	edx, DWORD PTR _lpSrchParentViewEntity$8698[ebp]
	movsx	eax, WORD PTR [edx+215]
	cmp	ecx, eax
	jle	SHORT $L8710
	mov	ecx, DWORD PTR _lpSrchChildViewEntity$8699[ebp]
	mov	edx, DWORD PTR [ecx+235]
	shr	edx, 11					; 0000000bH
	and	edx, 1
	test	edx, edx
...
; 3498 :                        lpSrchChildViewEntity->nLevel > lpSrchParentViewEntity->nLevel )
	...
	cmp	DWORD PTR _lpSrchChildViewEntity$8699[ebp], 0
	je	SHORT $L8713
	mov	edx, DWORD PTR _lpSrchChildViewEntity$8699[ebp]
	movsx	eax, WORD PTR [edx+215]
	mov	ecx, DWORD PTR _lpSrchParentViewEntity$8698[ebp]
	movsx	edx, WORD PTR [ecx+215]
	cmp	eax, edx
...
; 3503 :                   lpSrchParentViewEntity = zGETPTR( lpSrchParentViewEntity->hParent );
	...
	mov	eax, DWORD PTR _lpSrchParentViewEntity$8698[ebp]
	mov	ecx, DWORD PTR [eax+10]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrchParentViewEntity$8698[ebp], eax
...
_lpViewEntity$ = -12
_lpViewOI$ = -24
_lpFirstRoot$8843 = -28
_lpFirstRoot$8869 = -32
...
; 3828 :                lpFirstRoot = zGETPTR( lpFirstRoot->hPrevTwin ) )
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpFirstRoot$8843[ebp], eax
	jmp	SHORT $L8862
$L8863:
	mov	edx, DWORD PTR _lpFirstRoot$8843[ebp]
	mov	eax, DWORD PTR [edx+26]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpFirstRoot$8843[ebp], eax
$L8862:
	mov	ecx, DWORD PTR _lpFirstRoot$8843[ebp]
	cmp	DWORD PTR [ecx+26], 0
	je	SHORT $L8864
...
; 3850 :             lpFirstRoot = zGETPTR( lpFirstRoot->hPrevTwin ) )
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpFirstRoot$8869[ebp], eax
	jmp	SHORT $L8872
$L8873:
	mov	edx, DWORD PTR _lpFirstRoot$8869[ebp]
	mov	eax, DWORD PTR [edx+26]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpFirstRoot$8869[ebp], eax
$L8872:
	mov	ecx, DWORD PTR _lpFirstRoot$8869[ebp]
	cmp	DWORD PTR [ecx+26], 0
	je	SHORT $L8874
...
_nRC$ = -12
_lpSSrcViewEntity$8905 = -44
_lpSTgtViewEntity$8906 = -40
_lpTempCsr$8923 = -48
...
; 3976 :       lpSSrcViewEntity = lpSrcViewEntity;
	...
	mov	edx, DWORD PTR _lpSrcViewEntity$[ebp]
	mov	DWORD PTR _lpSSrcViewEntity$8905[ebp], edx

; 3977 :       lpSTgtViewEntity = lpTgtViewEntity;

	mov	eax, DWORD PTR _lpTgtViewEntity$[ebp]
	mov	DWORD PTR _lpSTgtViewEntity$8906[ebp], eax

; 3978 :       if ( lpSSrcViewEntity->bRecursive )

	mov	ecx, DWORD PTR _lpSSrcViewEntity$8905[ebp]
	mov	edx, DWORD PTR [ecx+235]
	shr	edx, 11					; 0000000bH
	and	edx, 1
	test	edx, edx
...
; 3980 :          lpSSrcViewEntity = zGETPTR( lpSrcViewEntity->hParent );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSSrcViewEntity$8905[ebp], eax
$L8910:

; 3981 :          while ( lpSSrcViewEntity->lEREntTok != lpSrcViewEntity->lEREntTok )

	mov	edx, DWORD PTR _lpSSrcViewEntity$8905[ebp]
	mov	eax, DWORD PTR _lpSrcViewEntity$[ebp]
...
; 3985 :       if ( lpSTgtViewEntity->bRecursive )
	...
	mov	ecx, DWORD PTR _lpSTgtViewEntity$8906[ebp]
	mov	edx, DWORD PTR [ecx+235]
	shr	edx, 11					; 0000000bH
	and	edx, 1
	test	edx, edx
...
; 3988 :          while ( lpSTgtViewEntity->lEREntTok != lpTgtViewEntity->lEREntTok )
	...
	mov	edx, DWORD PTR _lpSTgtViewEntity$8906[ebp]
	mov	eax, DWORD PTR _lpTgtViewEntity$[ebp]
	mov	ecx, DWORD PTR [edx+195]
	cmp	ecx, DWORD PTR [eax+195]
	je	SHORT $L8918
...
; 3992 :       if ( lpSSrcViewEntity != lpSTgtViewEntity )
	...
	mov	ecx, DWORD PTR _lpSSrcViewEntity$8905[ebp]
	cmp	ecx, DWORD PTR _lpSTgtViewEntity$8906[ebp]
	je	SHORT $L8920
...
; 4010 :       lpTempCsr = zGETPTR( lpTgtViewEntityCsr->hParent );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTempCsr$8923[ebp], eax

; 4011 :       lpWkEntityInstance = zGETPTR( lpTempCsr->hEntityInstance );

	mov	eax, DWORD PTR _lpTempCsr$8923[ebp]
	mov	ecx, DWORD PTR [eax+26]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWkEntityInstance$[ebp], eax
...
_lpLastSource$ = -24
_szMsg$9038 = -600
_lpFirstSourceViewEntity$9087 = -604
_lpWrkViewEntity$9173 = -608
...
; 4276 :                 lpTgtViewOD->szName, lpTgtViewOD->szER_Date );
	...
	push	eax
	push	OFFSET FLAT:??_C@_0CO@BJBK@Out?9of?9sync?5error?4?5Target?5LOD?5?$DN?5@ ; `string'
	lea	ecx, DWORD PTR _szMsg$9038[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 16					; 00000010H
...
; 4277 :       TraceLineS( "ERROR: ", szMsg );
	...
	lea	edx, DWORD PTR _szMsg$9038[ebp]
	push	edx
	push	OFFSET FLAT:??_C@_07JCPH@ERROR?3?5?$AA@	; `string'
	call	_TraceLineS@8
...
; 4281 :       TraceLineS( "ERROR: ", szMsg );
	...
	lea	eax, DWORD PTR _szMsg$9038[ebp]
	push	eax
	push	OFFSET FLAT:??_C@_07JCPH@ERROR?3?5?$AA@	; `string'
	call	_TraceLineS@8
...
; 4477 :          lpFirstSourceViewEntity = zGETPTR( lpFirstSource->hViewEntity );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpFirstSourceViewEntity$9087[ebp], eax
$L9090:

; 4478 :          while ( lpFirstSourceViewEntity != lpSrcViewEntity ||
; 4479 :                  lpFirstSource->u.nInd.bHidden )

	mov	edx, DWORD PTR _lpFirstSourceViewEntity$9087[ebp]
...
; 4487 :                  lpFirstSourceViewEntity->nHierNbr >= nStopSrcHier )
	...
	test	eax, eax
	je	SHORT $L9096
	mov	ecx, DWORD PTR _lpFirstSourceViewEntity$9087[ebp]
	movsx	edx, WORD PTR [ecx+217]
	movsx	eax, WORD PTR _nStopSrcHier$[ebp]
	cmp	edx, eax
	jl	SHORT $L9096
...
; 4722 :                               zGETPTR( lpTgtEntityInstance->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWrkViewEntity$9173[ebp], eax

; 4723 : 
; 4724 :             if ( lpWrkViewEntity->nHierNbr >= nStopTgtHier )

	mov	eax, DWORD PTR _lpWrkViewEntity$9173[ebp]
	movsx	ecx, WORD PTR [eax+217]
...
; 4769 :          LPTASK lpTask = zGETPTR( lpSrcView->hTask );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$9196[ebp], eax
...
; 4773 :                            lpTgtViewEntity->szName, 0 );
	...
	mov	edx, DWORD PTR _lpSrcView$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpTask$9196[ebp]
	push	eax
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
...
; 4843 :                lpParent = zGETPTR( lpSrcViewEntity->hParent );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$9217[ebp], eax
...
; 4845 :                                              lpSrcView, lpParent, bInclude );
	...
	push	edx
	mov	eax, DWORD PTR _lpParent$9217[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpSrcView$[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpWrkTgtViewEntity$[ebp]
...
; 4905 :       LPTASK lpTask = zGETPTR( lpSrcView->hTask );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$9234[ebp], eax
...
; 4910 :                         lpSrcViewEntity->szName );
	...
	mov	ecx, DWORD PTR _lpSrcView$[ebp]
	push	ecx
	mov	edx, DWORD PTR _lpTask$9234[ebp]
	push	edx
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
...
_nSkipType$ = -20
_nRC$ = -16
_lpChildTgtByToken$9338 = -60
_lpWrkEntityInstance$9396 = -64
...
; 5285 :       lpChildTgtByToken = 0;
	...
	mov	DWORD PTR _lpChildTgtByToken$9338[ebp], 0
...
; 5318 :                if ( lpChildTgtByToken == 0 )
	...
	cmp	DWORD PTR _lpChildTgtByToken$9338[ebp], 0
	jne	SHORT $L9385

; 5319 :                   lpChildTgtByToken = lpChildTgtViewEntityCsr;

	mov	edx, DWORD PTR _lpChildTgtViewEntityCsr$[ebp]
	mov	DWORD PTR _lpChildTgtByToken$9338[ebp], edx
$L9385:
...
; 5326 :          lpChildTgtViewEntityCsr = lpChildTgtByToken;
	...
	mov	eax, DWORD PTR _lpChildTgtByToken$9338[ebp]
	mov	DWORD PTR _lpChildTgtViewEntityCsr$[ebp], eax
$L9386:
...
; 5364 :             LPENTITYINSTANCE lpWrkEntityInstance = lpSrcEntityInstance;
	...
	mov	edx, DWORD PTR _lpSrcEntityInstance$[ebp]
	mov	DWORD PTR _lpWrkEntityInstance$9396[ebp], edx
$L9398:

; 5365 : 
; 5366 :             while ( lpWrkEntityInstance->hPrevVsn )

	mov	eax, DWORD PTR _lpWrkEntityInstance$9396[ebp]
	cmp	DWORD PTR [eax+38], 0
	je	SHORT $L9399

; 5367 :                lpWrkEntityInstance = zGETPTR( lpWrkEntityInstance->hPrevVsn );

	mov	ecx, DWORD PTR _lpWrkEntityInstance$9396[ebp]
	mov	edx, DWORD PTR [ecx+38]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWrkEntityInstance$9396[ebp], eax
	jmp	SHORT $L9398
$L9399:
...
; 5369 :             while ( lpWrkEntityInstance )
	...
	cmp	DWORD PTR _lpWrkEntityInstance$9396[ebp], 0
	je	SHORT $L9403
...
_IncludeInfo$ = -68
_nRC$ = -24
_lpEntityInstance$9466 = -80
_lpTask$9472 = -484
_szMsg$9474 = -480
_lpSrcInstance$9487 = -492
_lpTgtParent$9488 = -488
_lpWorkParentCsr$9500 = -496
_lpPrevVsn$9505 = -500
_lpPrevVsn$9517 = -504
_lpTask$9527 = -508
_lpEI$9535 = -512
...
; 5537 :       LPENTITYINSTANCE lpEntityInstance = zGETPTR( lpTgtViewEntityCsr->hEntityInstance );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpEntityInstance$9466[ebp], eax

; 5538 : 
; 5539 :       lpParentEntityInstance = zGETPTR( lpEntityInstance->hParent );

	mov	ecx, DWORD PTR _lpEntityInstance$9466[ebp]
	mov	edx, DWORD PTR [ecx+30]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
...
; 5546 :             LPTASK lpTask = zGETPTR( lpSrcView->hTask );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$9472[ebp], eax
...
; 5553 :                       lpSrcViewEntity->szName, lpTgtViewEntity->szName );
	...
	lea	ecx, DWORD PTR _szMsg$9474[ebp]
	push	ecx
	call	DWORD PTR __imp__sprintf
	add	esp, 16					; 00000010H
...
; 5554 :             fnIssueCoreError( lpTask, lpSrcView, 8, 129, 0, szMsg, 0 );
	...
	push	0
	lea	edx, DWORD PTR _szMsg$9474[ebp]
	push	edx
	push	0
	push	129					; 00000081H
	push	8
	mov	eax, DWORD PTR _lpSrcView$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpTask$9472[ebp]
	push	ecx
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
...
; 5587 :       lpSrcInstance = zGETPTR( lpSrcViewEntityCsr->hEntityInstance );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcInstance$9487[ebp], eax
$L9491:

; 5588 :       while ( lpSrcInstance->hPrevVsn )

	mov	eax, DWORD PTR _lpSrcInstance$9487[ebp]
	cmp	DWORD PTR [eax+38], 0
	je	SHORT $L9492

; 5589 :          lpSrcInstance = zGETPTR( lpSrcInstance->hPrevVsn );

	mov	ecx, DWORD PTR _lpSrcInstance$9487[ebp]
	mov	edx, DWORD PTR [ecx+38]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSrcInstance$9487[ebp], eax
...
; 5591 :       while ( lpSrcInstance )
	...
	cmp	DWORD PTR _lpSrcInstance$9487[ebp], 0
	je	SHORT $L9496
...
; 5611 :             LPENTITYINSTANCE lpPrevVsn = zGETPTR( lpSrcInstance->hPrevVsn );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpPrevVsn$9505[ebp], eax

; 5612 : 
; 5613 :             if ( lpSrcInstance->u.nInd.bTemporal ||
; 5614 :                  (lpPrevVsn && lpPrevVsn->u.nInd.bPrevVsnRoot) )

	mov	edx, DWORD PTR _lpSrcInstance$9487[ebp]
	mov	eax, DWORD PTR [edx+6]
	shr	eax, 11					; 0000000bH
	and	eax, 1
	test	eax, eax
	jne	SHORT $L9508
	cmp	DWORD PTR _lpPrevVsn$9505[ebp], 0
	je	SHORT $L9507
	mov	ecx, DWORD PTR _lpPrevVsn$9505[ebp]
	mov	edx, DWORD PTR [ecx+6]
	shr	edx, 9
	and	edx, 1
	test	edx, edx
...
; 5622 :          lpWorkParentCsr = zGETPTR( lpTgtViewEntityCsr->hParent );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWorkParentCsr$9500[ebp], eax

; 5623 :          if ( lpWorkParentCsr->hEntityInstance == UNSET_CSR )

	mov	ecx, DWORD PTR _lpWorkParentCsr$9500[ebp]
	cmp	DWORD PTR [ecx+26], 1
	jne	SHORT $L9512

; 5624 :             fnEstablishCursorForView( lpWorkParentCsr );

	mov	edx, DWORD PTR _lpWorkParentCsr$9500[ebp]
	push	edx
	call	_fnEstablishCursorForView
	add	esp, 4
$L9512:
...
; 5626 :          lpTgtParent = zGETPTR( lpWorkParentCsr->hEntityInstance );
	...
	mov	eax, DWORD PTR _lpWorkParentCsr$9500[ebp]
	mov	ecx, DWORD PTR [eax+26]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTgtParent$9488[ebp], eax
$L9515:

; 5627 :          while ( lpTgtParent )

	cmp	DWORD PTR _lpTgtParent$9488[ebp], 0
	je	SHORT $L9516

; 5629 :             LPENTITYINSTANCE lpPrevVsn = zGETPTR( lpTgtParent->hPrevVsn );

	mov	edx, DWORD PTR _lpTgtParent$9488[ebp]
	mov	eax, DWORD PTR [edx+38]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpPrevVsn$9517[ebp], eax

; 5630 : 
; 5631 :             if ( lpTgtParent->u.nInd.bTemporal ||
; 5632 :                  (lpPrevVsn && lpPrevVsn->u.nInd.bPrevVsnRoot) )

	mov	ecx, DWORD PTR _lpTgtParent$9488[ebp]
	mov	edx, DWORD PTR [ecx+6]
	shr	edx, 11					; 0000000bH
	and	edx, 1
	test	edx, edx
	jne	SHORT $L9520
	cmp	DWORD PTR _lpPrevVsn$9517[ebp], 0
	je	SHORT $L9519
	mov	eax, DWORD PTR _lpPrevVsn$9517[ebp]
	mov	ecx, DWORD PTR [eax+6]
	shr	ecx, 9
	and	ecx, 1
	test	ecx, ecx
...
; 5640 :          if ( lpTgtParent == 0 || lpTgtParent != lpSrcInstance )
	...
	je	SHORT $L9523
	mov	ecx, DWORD PTR _lpTgtParent$9488[ebp]
	cmp	ecx, DWORD PTR _lpSrcInstance$9487[ebp]
	je	SHORT $L9522
$L9523:
...
; 5643 :             lpSrcInstance = 0;
	...
	mov	DWORD PTR _lpSrcInstance$9487[ebp], 0
$L9525:
...
; 5648 :          LPTASK lpTask = zGETPTR( lpSrcView->hTask );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$9527[ebp], eax
...
; 5659 :                            lpTgtViewEntity->szName );
	...
	mov	edx, DWORD PTR _lpSrcView$[ebp]
	push	edx
	mov	eax, DWORD PTR _lpTask$9527[ebp]
	push	eax
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
...
; 5692 :       LPENTITYINSTANCE lpEI = zGETPTR( lpTgtViewEntityCsr->hEntityInstance );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpEI$9535[ebp], eax
...
; 5693 :       fnSetUpdateIndicator( lpTgtViewOI, lpEI, 0, TRUE, FALSE, FALSE );
	...
	push	1
	push	0
	mov	eax, DWORD PTR _lpEI$9535[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpTgtViewOI$[ebp]
	push	ecx
	call	_fnSetUpdateIndicator
...
; 5817 :                   lpViewOI    = zGETPTR( lpSrchInstance->hViewOI );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOI$9590[ebp], eax

; 5818 :                   lpViewCsr   = zGETPTR( lpViewOI->hFirstViewCsr );

	mov	ecx, DWORD PTR _lpViewOI$9590[ebp]
	mov	edx, DWORD PTR [ecx+10]
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$9591[ebp], eax

; 5819 :                   lpSpawnView = zGETPTR( lpViewCsr->hView );

	mov	eax, DWORD PTR _lpViewCsr$9591[ebp]
	mov	ecx, DWORD PTR [eax+6]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
...
; 5918 :                   lpViewOI    = zGETPTR( lpSrchInstance->hViewOI );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewOI$9638[ebp], eax

; 5919 :                   lpViewCsr   = zGETPTR( lpViewOI->hFirstViewCsr );

	mov	eax, DWORD PTR _lpViewOI$9638[ebp]
	mov	ecx, DWORD PTR [eax+10]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpViewCsr$9639[ebp], eax
...
; 5923 :                   lpSpawnView = zGETPTR( lpViewCsr->hView );
	...
	mov	edx, DWORD PTR _lpViewCsr$9639[ebp]
	mov	eax, DWORD PTR [edx+6]
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpSpawnView$[ebp], eax
...
; 6026 :          LPTASK lpTask = zGETPTR( lpTgtView->hTask );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpTask$9700[ebp], eax
...
; 6030 :                            lpSrcViewEntity->szName );
	...
	mov	eax, DWORD PTR _lpSrcView$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpTask$9700[ebp]
	push	ecx
	call	_fnIssueCoreError
	add	esp, 28					; 0000001cH
...
; 6124 :          lpWk1    = zGETPTR( lpTgtEntityInstance->hViewEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWk1$9746[ebp], eax
...
; 6125 :          lpParent = zGETPTR( lpOrigSrcEntityInstance->hParent );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$9748[ebp], eax

; 6126 :          lpWk2    = zGETPTR( lpParent->hViewEntity );

	mov	eax, DWORD PTR _lpParent$9748[ebp]
	mov	ecx, DWORD PTR [eax+2]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWk2$9747[ebp], eax
...
; 6130 :               lpWk1->bRelLink1 != lpSrcViewEntity->bRelLink1 )
	...
	cmp	eax, ecx
	jne	SHORT $L9752
	mov	edx, DWORD PTR _lpWk1$9746[ebp]
	mov	eax, DWORD PTR _lpWk2$9747[ebp]
	mov	ecx, DWORD PTR [edx+195]
	cmp	ecx, DWORD PTR [eax+195]
	jne	SHORT $L9752
	mov	edx, DWORD PTR _lpWk1$9746[ebp]
...
; 6162 :                               zGETPTR( lpSrcEntityInstance->hViewEntity );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWk1$9768[ebp], eax
...
; 6164 :                               zGETPTR( lpTgtEntityInstance->hViewEntity );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpWk2$9770[ebp], eax

; 6165 : 
; 6166 :                if ( lpWk1->lEREntTok == lpWk2->lEREntTok )

	mov	edx, DWORD PTR _lpWk1$9768[ebp]
	mov	eax, DWORD PTR _lpWk2$9770[ebp]
	mov	ecx, DWORD PTR [edx+195]
	cmp	ecx, DWORD PTR [eax+195]
	jne	SHORT $L9772
...
; 6183 :          LPVIEWENTITY hInvertedSrcEntity = zGETHNDL( lpInvertedSrcEntity );
	...
	push	eax
	call	DWORD PTR _g_pfnGetHndl
	mov	DWORD PTR _hInvertedSrcEntity$9777[ebp], eax
$L9780:
...
; 6191 :                                       lpSrcEntityInstance ) )
	...
	mov	edx, DWORD PTR _lpSrcEntityInstance$[ebp]
	mov	eax, DWORD PTR [edx+2]
	cmp	eax, DWORD PTR _hInvertedSrcEntity$9777[ebp]
	jne	SHORT $L9782
	mov	ecx, DWORD PTR _lpSrcEntityInstance$[ebp]
	mov	edx, DWORD PTR [ecx+6]
	shr	edx, 10					; 0000000aH
...
; 6270 :       LPENTITYINSTANCE lpParent = zGETPTR( lpEntityInstance->hParent );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpParent$9808[ebp], eax
...
; 6272 :            (lpParent->hPrevVsn || lpParent->u.nInd.bTemporal) )
	...
	test	eax, eax
	je	SHORT $L9810
	cmp	DWORD PTR _lpParent$9808[ebp], 0
	je	SHORT $L9810
	mov	ecx, DWORD PTR _lpParent$9808[ebp]
	cmp	DWORD PTR [ecx+38], 0
	jne	SHORT $L9811
	mov	edx, DWORD PTR _lpParent$9808[ebp]
	mov	eax, DWORD PTR [edx+6]
	shr	eax, 11					; 0000000bH
	and	eax, 1
	test	eax, eax
