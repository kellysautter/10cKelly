...
; 101  :       zULONG ulLth = zstrlen( cpcName ) + 1;
	...
	add	esp, 4
	add	eax, 1
	mov	DWORD PTR _ulLth$7527[ebp], eax
...
; 102  :       hDataspace = fnAllocDataspace( lpDataHeader, ulLth, 0, 0, iString );
	...
	push	0
	push	0
	mov	eax, DWORD PTR _ulLth$7527[ebp]
	push	eax
...
_bMutexLocked$ = -44
_nAllocCnt$ = -36
_hNewDataHeader$7692 = -56
_lpNewDataHeader$7693 = -64
_pTmp$7694 = -60
...
; 759  :                                                                 0, ulAllocBytes, 0 );
	...
	mov	cx, WORD PTR [eax]
	push	ecx
	lea	edx, DWORD PTR _pTmp$7694[ebp]
	push	edx
	mov	eax, DWORD PTR _lpCurrentTask$[ebp]
	push	eax
	call	_fnInitializeDataspace
	add	esp, 24					; 00000018H
	mov	DWORD PTR _hNewDataHeader$7692[ebp], eax

; 760  :          if ( hNewDataHeader )

	cmp	DWORD PTR _hNewDataHeader$7692[ebp], 0
	je	SHORT $L7703

; 762  :             lpNewDataHeader = zGETPTR( hNewDataHeader );

	mov	ecx, DWORD PTR _hNewDataHeader$7692[ebp]
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpNewDataHeader$7693[ebp], eax
...
; 767  :             lpNewDataHeader->lNextDataHandle = lpDataHeader->lNextDataHandle;
	...
	mov	edx, DWORD PTR _lpNewDataHeader$7693[ebp]
	mov	eax, DWORD PTR _lpDataHeader$[ebp]
...
; 771  :             lpDataHeader->lNextDataHandle    = (zLONG) hNewDataHeader;
	...
	mov	edx, DWORD PTR _lpDataHeader$[ebp]
	mov	eax, DWORD PTR _hNewDataHeader$7692[ebp]
	mov	DWORD PTR [edx+34], eax

; 772  :             lpDataHeader->hNextDataHeader    = hNewDataHeader;

	mov	ecx, DWORD PTR _lpDataHeader$[ebp]
	mov	edx, DWORD PTR _hNewDataHeader$7692[ebp]
	mov	DWORD PTR [ecx+38], edx

; 773  :             lpDataHeader = lpNewDataHeader;

	mov	eax, DWORD PTR _lpNewDataHeader$7693[ebp]
	mov	DWORD PTR _lpDataHeader$[ebp], eax
...
_lpFreespace$ = -24
_hTmp$ = -12
_lpFreespace1$7727 = -32
_lpnAddress$7738 = -36
_hDataHandle$7744 = -40
_lpPrevDataHeader$7745 = -44
_lpNextDataHeader$7748 = -48
...
; 850  :       LPFREESPACE lpFreespace1 = lpFreespace;
	...
	mov	DWORD PTR _lpFreespace1$7727[ebp], eax

; 851  : 
; 852  :       lpFreespace1++;

	mov	ecx, DWORD PTR _lpFreespace1$7727[ebp]
	add	ecx, 18					; 00000012H
	mov	DWORD PTR _lpFreespace1$7727[ebp], ecx
...
; 874  :                  lpFreespace->nTableID, lpFreespace, lpFreespace1 );
	...
	mov	edx, DWORD PTR _lpFreespace1$7727[ebp]
	push	edx
	mov	eax, DWORD PTR _lpFreespace$[ebp]
	push	eax
	mov	ecx, DWORD PTR _lpFreespace$[ebp]
...
; 1000 :       lpnAddress   = (zPSHORT) Address;
	...
	mov	DWORD PTR _lpnAddress$7738[ebp], ecx

; 1001 :       nPrevTableID = *lpnAddress;

	mov	edx, DWORD PTR _lpnAddress$7738[ebp]
	mov	ax, WORD PTR [edx]
...
; 1041 :       hDataHandle = lpDataHeader->hDataHandle;
	...
	mov	edx, DWORD PTR _lpDataHeader$[ebp]
	mov	eax, DWORD PTR [edx+6]
	mov	DWORD PTR _hDataHandle$7744[ebp], eax
...
; 1045 :       lpPrevDataHeader = zGETPTR( lpDataHeader->hPrevDataHeader );
	...
	push	edx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpPrevDataHeader$7745[ebp], eax

; 1046 :       hDataHandle = lpPrevDataHeader->lNextDataHandle;

	mov	eax, DWORD PTR _lpPrevDataHeader$7745[ebp]
	mov	ecx, DWORD PTR [eax+34]
	mov	DWORD PTR _hDataHandle$7744[ebp], ecx

; 1047 :       lpPrevDataHeader->lNextDataHandle = lpDataHeader->lNextDataHandle;

	mov	edx, DWORD PTR _lpPrevDataHeader$7745[ebp]
	mov	eax, DWORD PTR _lpDataHeader$[ebp]
	mov	ecx, DWORD PTR [eax+34]
	mov	DWORD PTR [edx+34], ecx
...
; 1053 :          lpNextDataHeader = zGETPTR( lpDataHeader->hNextDataHeader );
	...
	push	ecx
	call	DWORD PTR _g_pfnGetPtr
	mov	DWORD PTR _lpNextDataHeader$7748[ebp], eax

; 1054 :          lpNextDataHeader->hPrevDataHeader = lpDataHeader->hPrevDataHeader;

	mov	edx, DWORD PTR _lpNextDataHeader$7748[ebp]
	mov	eax, DWORD PTR _lpDataHeader$[ebp]
	mov	ecx, DWORD PTR [eax+42]
	mov	DWORD PTR [edx+42], ecx
$L7747:
...
; 1057 :       fnFreeSharedMemory( lpCurrentTask, hDataHandle );
	...
	mov	edx, DWORD PTR _hDataHandle$7744[ebp]
	push	edx
	mov	eax, DWORD PTR _lpCurrentTask$[ebp]
	push	eax
