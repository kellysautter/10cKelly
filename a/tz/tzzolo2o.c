                          ...
                          zPCHAR    szAddER_EntityFlag )
{
   ...
   { 
      ...
      { 
         ...
         { 
            //:SET CURSOR FIRST NewERD.ER_Entity WHERE NewERD.ER_Entity.Name = OldRecursiveLOD.ER_EntityRec.Name
            GetStringFromAttribute( szTempString_12, OldRecursiveLOD, "ER_EntityRec", "Name" );
         ...
         { 
            ...
            { 
               ...
               { 
                  ...
                  GetStringFromAttribute( szTempString_16, OldRecursiveLOD, "ER_AttributeRec", "Name" );
                  ...
                  GetStringFromAttribute( szTempString_16, OldRecursiveLOD, "DB_ER_AttributeRec", "Name" );
            ...
            { 
               ...
               GetStringFromAttribute( szTempString_16, OldRecursiveLOD, "LOD_EntityConstraintOperRec", "Name" );
                       ...
                       zVIEW     vSubtask )
{
   ...
   { 
      ...
      { 
         ...
         GetStringFromAttribute( szTempString_7, OldMainLOD, "LOD_ConstraintOper", "Name" );
      ...
      { 
         //:SET CURSOR FIRST NewRecursiveLOD.LOD_EntityParent WHERE NewRecursiveLOD.LOD_EntityParent.Name = OldRecursiveLOD.LOD_EntityParent.Name  
         GetStringFromAttribute( szTempString_7, OldRecursiveLOD, "LOD_EntityParent", "Name" );
