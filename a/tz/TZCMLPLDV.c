...
CREATE_NewLPLR( zVIEW     ViewToWindow )
{
   ...
   GetStringFromAttribute( szTempString_0, TZCMLPLO, "LPLR", "MetaSrcDir" );
   ...
   { 
      ...
      GetStringFromAttribute( szFromFileName, TZCMLPLO, "LPLR", "wOrigMetaSrc" );
      ...
      { 
         ...
         { 
            ...
            GetStringFromAttribute( szTempDir, TZCMLPLO, "LPLR", "wOrigLPLRName" );
      ...
      GetStringFromAttribute( szFromFileName, TZCMLPLO, "LPLR", "wOrigExecSrc" );
      ZeidonStringConcat( szFromFileName, 1, 0, "\\", 1, 0, 514 );
      ...
      { 
         ...
         GetStringFromAttribute( szTempDir, TZCMLPLO, "LPLR", "MetaSrcDir" );
   ...
   GetStringFromAttribute( szTempString_5, TZCMLPLO, "LPLR", "Name" );
   ...
   GetStringFromAttribute( szTempString_6, TZCMLPLO, "LPLR", "MetaSrcDir" );
...
IMPORT_LPLR( zVIEW     ViewToWindow )
{
   ...
   GetStringFromAttribute( szTempString_0, TZCMLPLO, "LPLR", "wOrigMetaSrc" );
   ZeidonStringConcat( szTempString_0, 1, 0, "\\", 1, 0, 255 );
   GetVariableFromAttribute( szTempString_1, 0, 'S', 255, TZCMLPLO, "LPLR", "wExecutableSubDirectory", "", 0 );
                           ...
                           zPCHAR    szCopyFiles )
{
   ...
   GetStringFromAttribute( szFromDirSub, TZCMLPLO, "LPLR", "wOrigExecSrc" );
